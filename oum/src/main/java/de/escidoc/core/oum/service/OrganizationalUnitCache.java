...
/**
 * A service interface to the organizational unit cache.
 * 
 * @spring.bean id="service.OrganizationalUnitCache"
 *
 * @author sche
 */
public class OrganizationalUnitCache extends ResourceCache {
      /**
       * Injects the business cache object.
       *
       * @param cache The business cache bean to inject.
       *
