...
public interface OrganizationalUnitHandlerInterface extends IngestableResource {
     ...
     *             If a parent is not in state 'created' or 'opened'.
    ...
    /**
     * Delete an organizational unit. By now the state of the organizational
     * unit is not checked because there are only organizational units in state
     * 'created', but the organizational unit must not have any children.
     * 
     * @param id
     ...
     *             exist.
     * @throws InvalidStatusException
     *             If the organizational has an invalid status.
     * @throws OrganizationalUnitHasChildrenException
     *             If the organizational unit has children.
     * @throws SystemException
     *             If an internal error occurred.
     */
    void delete(String id) throws OrganizationalUnitNotFoundException,
        InvalidStatusException, OrganizationalUnitHasChildrenException,
        SystemException;
     ...
     *             If an internal error occurred.
     */
    String retrieve(String id) throws OrganizationalUnitNotFoundException,
        SystemException;
     ...
     *             If an internal error occurred.
     */
    String update(final String id, final String xml)
     ...
     *             If the schema validation fails.
     * @throws InvalidStatusException
     *             Thrown if organizational unit has invalid status to add meta
     *             data.
     * @throws MissingElementValueException
     *             Thrown if required element value is missing.
     * @throws OptimisticLockingException
     ...
     *             If an internal error occurred.
     */
    String updateParents(final String id, final String xml)
        throws InvalidStatusException, InvalidXmlException,
        MissingElementValueException, OptimisticLockingException,
        OrganizationalUnitHierarchyViolationException,
        OrganizationalUnitNameNotUniqueException,
     ...
     *             If the md-record does not exist.
     * @throws OrganizationalUnitNotFoundException
     *             If an organizational unit with the provided id does not
     *             exist.
     * @throws SystemException
    ...
    /**
     * Retrieve the organizational units to that this organizational unit is
     * subordinated.
     * 
     * @param id
     *            The id of the organizational unit.
     * @return The XML representation of a list of references to the parent
     ...
     * @param id
     *            The id of the organizational unit.
     * @return The XML representation of a list of references to the child
     *         organizational units.
     * @throws OrganizationalUnitNotFoundException
     *             If an organizational unit with the provided id does not
     *             exist.
     ...
     * @throws InvalidStatusException
     *             If a parent is not in state 'created'.
     * @throws InvalidXmlException
     *             Thrown if TaskParam is invalid.
     * @throws OptimisticLockingException
     *             Thrown if Organizational Unit was altered through third
     *             during update.
     * @throws OrganizationalUnitNotFoundException
     ...
     * @return Organizational Unit in new representation.
     * @throws InvalidStatusException
     *             If a parent is not in state 'closed'.
     * @throws InvalidXmlException
     *             Thrown if TaskParam is invalid.
     * @throws OptimisticLockingException
     *             Thrown if Organizational Unit was altered through third
     ...
     *             Thrown if internal failure occurs.
     */
    String retrieveSuccessors(final String objid)
        throws OrganizationalUnitNotFoundException, SystemException;
