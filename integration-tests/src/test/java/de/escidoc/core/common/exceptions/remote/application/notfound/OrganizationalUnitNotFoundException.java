...
public class OrganizationalUnitNotFoundException
    ...
    public OrganizationalUnitNotFoundException(int httpStatusCode, String httpStatusLine, String httpStatusMsg) {
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof OrganizationalUnitNotFoundException))
            return false;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName(
            "http://notfound.application.exceptions.common.core.escidoc.de", "OrganizationalUnitNotFoundException"));
    }
