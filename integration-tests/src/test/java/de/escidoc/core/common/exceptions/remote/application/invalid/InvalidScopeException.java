...
public class InvalidScopeException
    ...
    public InvalidScopeException(int httpStatusCode, String httpStatusLine, String httpStatusMsg) {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(InvalidScopeException.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName(
            "http://invalid.application.exceptions.common.core.escidoc.de", "InvalidScopeException"));
    }
