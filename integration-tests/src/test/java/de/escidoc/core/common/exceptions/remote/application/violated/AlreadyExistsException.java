...
public class AlreadyExistsException
    ...
    private static final long serialVersionUID = -2384987116037148009L;

    public AlreadyExistsException() {
    }

    public AlreadyExistsException(int httpStatusCode, String httpStatusLine, String httpStatusMsg) {
