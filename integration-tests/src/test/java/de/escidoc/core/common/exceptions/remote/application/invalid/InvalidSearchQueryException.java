...
public class InvalidSearchQueryException
    ...
    private static final long serialVersionUID = 5251003246558068239L;

    public InvalidSearchQueryException() {
    }

    public InvalidSearchQueryException(int httpStatusCode, String httpStatusLine, String httpStatusMsg) {
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof InvalidSearchQueryException))
            return false;
        if (obj == null)
            return false;
        if (this == obj)
