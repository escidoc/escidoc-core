...
public class ContextNotEmptyException
    ...
    public ContextNotEmptyException(int httpStatusCode, String httpStatusLine, String httpStatusMsg) {
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof ContextNotEmptyException))
            return false;
        ContextNotEmptyException other = (ContextNotEmptyException) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ContextNotEmptyException.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName(
            "http://invalid.application.exceptions.common.core.escidoc.de", "ContextNotEmptyException"));
    }
