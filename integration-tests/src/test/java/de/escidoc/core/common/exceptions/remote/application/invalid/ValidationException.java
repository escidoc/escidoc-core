...
public class ValidationException extends de.escidoc.core.common.exceptions.remote.application.ApplicationException
    implements java.io.Serializable {
    public ValidationException() {
    }

    public ValidationException(int httpStatusCode, String httpStatusLine, String httpStatusMsg) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName(
            "http://invalid.application.exceptions.common.core.escidoc.de", "ValidationException"));
    }
