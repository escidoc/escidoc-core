...
public class FileNotFoundException
    ...
    public FileNotFoundException(int httpStatusCode, String httpStatusLine, String httpStatusMsg) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName(
            "http://notfound.application.exceptions.common.core.escidoc.de", "FileNotFoundException"));
    }
