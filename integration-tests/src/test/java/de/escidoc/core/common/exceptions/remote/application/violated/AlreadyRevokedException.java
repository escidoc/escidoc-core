...
public class AlreadyRevokedException
    ...
    public AlreadyRevokedException(int httpStatusCode, String httpStatusLine, String httpStatusMsg) {
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof AlreadyRevokedException))
            return false;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName(
            "http://violated.application.exceptions.common.core.escidoc.de", "AlreadyRevokedException"));
    }
