...
public class TmeException extends de.escidoc.core.common.exceptions.remote.application.ApplicationException
    implements java.io.Serializable {
    public TmeException() {
    }

    public TmeException(int httpStatusCode, String httpStatusLine, String httpStatusMsg) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName(
            "http://invalid.application.exceptions.common.core.escidoc.de", "TmeException"));
    }
