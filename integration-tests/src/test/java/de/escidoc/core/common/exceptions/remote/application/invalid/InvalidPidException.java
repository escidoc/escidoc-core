...
public class InvalidPidException
    extends de.escidoc.core.common.exceptions.remote.application.invalid.ValidationException
    implements java.io.Serializable {
    public InvalidPidException() {
    }

    public InvalidPidException(int httpStatusCode, String httpStatusLine, String httpStatusMsg) {
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof InvalidPidException))
            return false;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName(
            "http://invalid.application.exceptions.common.core.escidoc.de", "InvalidPidException"));
    }
