...
public class AdminDescriptorNotFoundException
    ...
    private static final long serialVersionUID = 8466580240300978160L;

    public AdminDescriptorNotFoundException() {
    }

    public AdminDescriptorNotFoundException(int httpStatusCode, String httpStatusLine, String httpStatusMsg) {
