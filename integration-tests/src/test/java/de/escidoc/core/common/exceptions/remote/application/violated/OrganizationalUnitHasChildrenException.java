...
public class OrganizationalUnitHasChildrenException
    ...
    private static final long serialVersionUID = 4708623253275476367L;

    public OrganizationalUnitHasChildrenException() {
    }

    public OrganizationalUnitHasChildrenException(int httpStatusCode, String httpStatusLine, String httpStatusMsg) {
