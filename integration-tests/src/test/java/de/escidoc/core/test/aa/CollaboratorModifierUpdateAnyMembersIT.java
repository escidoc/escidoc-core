...
public class CollaboratorModifierUpdateAnyMembersIT extends GrantTestBase {
     ...
     */
    public CollaboratorModifierUpdateAnyMembersIT(final int handlerCode, final String userOrGroupId) throws Exception {
        super(handlerCode);
