...
public class CollaboratorModifierUpdateAnyMembersTest extends GrantTestBase {
     ...
     */
    public CollaboratorModifierUpdateAnyMembersTest(final int handlerCode, final String userOrGroupId) throws Exception {
        super(handlerCode);
