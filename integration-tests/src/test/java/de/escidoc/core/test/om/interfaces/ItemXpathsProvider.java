...
public class ItemXpathsProvider {
    ...
    public static String XPATH_ITEM_COMPONENT_PROPERTIES_XLINK_HREF = XPATH_ITEM_COMPONENT_PROPERTIES + OmTestBase.PART_XLINK_HREF;

    public static String XPATH_ITEM_COMPONENT_PROPERTIES_XLINK_TYPE = XPATH_ITEM_COMPONENT_PROPERTIES + OmTestBase.PART_XLINK_TYPE;

    public static String XPATH_ITEM_COMPONENT_PROPERTIES_XLINK_TITLE = XPATH_ITEM_COMPONENT_PROPERTIES + OmTestBase.PART_XLINK_TITLE;

    public static String XPATH_ITEM_COMPONENT_CREATOR = XPATH_ITEM_COMPONENT_PROPERTIES + "/creator";

    public static String XPATH_ITEM_COMPONENT_CREATOR_XLINK_HREF = XPATH_ITEM_COMPONENT_CREATOR + OmTestBase.PART_XLINK_HREF;

    public static String XPATH_ITEM_COMPONENT_CREATOR_XLINK_TYPE = XPATH_ITEM_COMPONENT_CREATOR + OmTestBase.PART_XLINK_TYPE;

    public static String XPATH_ITEM_COMPONENT_CREATOR_XLINK_TITLE = XPATH_ITEM_COMPONENT_CREATOR + OmTestBase.PART_XLINK_TITLE;
    ...
    public static String XPATH_ITEM_CURRENT_VERSION_XLINK_HREF = XPATH_ITEM_CURRENT_VERSION + OmTestBase.PART_XLINK_HREF;

    public static String XPATH_ITEM_CURRENT_VERSION_XLINK_TYPE = XPATH_ITEM_CURRENT_VERSION + OmTestBase.PART_XLINK_TYPE;

    public static String XPATH_ITEM_CURRENT_VERSION_XLINK_TITLE = XPATH_ITEM_CURRENT_VERSION + OmTestBase.PART_XLINK_TITLE;
    ...
    public static String XPATH_ITEM_LATEST_RELEASE_XLINK_TITLE = XPATH_ITEM_LATEST_RELEASE + OmTestBase.PART_XLINK_TITLE;
    ...
    public static String XPATH_ITEM_LATEST_VERSION_XLINK_TITLE = XPATH_ITEM_LATEST_VERSION + OmTestBase.PART_XLINK_TITLE;
