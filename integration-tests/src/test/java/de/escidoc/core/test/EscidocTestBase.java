...
public abstract class EscidocTestBase {
    ...
    private static final String NAME_SET_DEFINITION_LIST =
        "set-definition-list";
     ...
     */
    protected static final String ORGANIZATIONAL_UNIT_ID =
        "escidoc:persistent11";

    /**
     * Id of a persistent org unit object.
     */
    protected static final String ORGANIZATIONAL_UNIT_ID1 =
        "escidoc:persistent1";

    /**
     * Id of a persistent user-group object containing a list of users.
     */
    protected static final String USER_GROUP_WITH_USER_LIST_ID =
        "escidoc:testgroupwithuser";

    /**
     * Id of a persistent user-group object containing a list of ous.
     */
    protected static final String USER_GROUP_WITH_OU_LIST_ID =
        "escidoc:testgroupwithorgunit";

    /**
     * Id of a persistent user-group object containing a list of groups.
     */
    protected static final String USER_GROUP_WITH_GROUP_LIST_ID =
     ...
     */
    protected static final String TEST_AGGREGATION_DEFINITION_ID =
        "escidoc:aggdef1";
    ...
    private static final Pattern PATTERN_MODIFY_NAMESPACE_PREFIXES_REPLACE_PREFIXES =
        Pattern.compile("(</{0,1}|[\\s])([a-zA-Z-]+?:[^ =/>]+)", Pattern.DOTALL
            | Pattern.MULTILINE);

    /**
     * Pattern used in modfyNamespacePrefixes to fix namespace declarations
     * after changing prefixes.
     */
    private static final Pattern PATTERN_MODIFY_NAMESPACE_PREFIXES_FIX_NAMESPACE_DECLARATIONS =
        Pattern.compile("prefix-xmlns:([a-zA-Z-].+?)", Pattern.DOTALL
            | Pattern.MULTILINE);

    /**
     * Pattern used in modfyNamespacePrefixes to fix xml namespace declaration.
     */
    private static final Pattern PATTERN_MODIFY_NAMESPACE_PREFIXES_FIX_PREFIX_XML =
        Pattern.compile("prefix-xml");
    ...
    public static final String NAME_ORGANIZATIONAL_UNITS =
    ...
    public static final String NAME_PUBLIC_STATUS_COMMENT =
    ...
    public static final String ORGANIZATIONAL_UNIT_PREFIX_TEMPLATES =
        "prefix-organizational-unit";

    public static final String ORGANIZATIONAL_UNIT_PREFIX_ESCIDOC =
        "organizational-unit";
    ...
    public static final String USER_ACCOUNT_PREFIX_TEMPLATES =
        "prefix-user-account";

    public static final String USER_GROUP_PREFIX_TEMPLATES =
        "prefix-user-group";
    ...
    public static final String CONTAINER_NS_URI =
        "http://www.escidoc.de/schemas/container/0.7";
    ...
    public static final String TYPE_FEDORA_OBJECT_URI =
        "info:fedora/fedora-system:def/model#FedoraObject";

    public static final String CONTEXT_NS_URI =
        "http://www.escidoc.de/schemas/context/0.6";

    public static final String CONTENT_TYPE_NS_URI =
        "http://www.escidoc.de/schemas/content-type/0.2";
    ...
    public static final String GRANTS_NS_URI =
        "http://www.escidoc.de/schemas/grants/0.5";

    public static final String INTERNAL_METADATA_NS_URI =
        "http://www.escidoc.de/schemas/internalmetadata/0.2";

    public static final String ITEM_NS_URI =
        "http://www.escidoc.de/schemas/item/0.6";

    public static final String COMPONENTS_NS_URI =
        "http://www.escidoc.de/schemas/components/0.7";

    public static final String ITEM_PREFIX_TEMPLATES = "prefix-escidocItem";

    public static final String MEMBER_LIST_NS_URI =
        "http://www.escidoc.de/schemas/memberlist/0.6";

    public static final String MEMBER_REF_LIST_NS_URI =
        "http://www.escidoc.de/schemas/memberreflist/0.2";

    public static final String METADATARECORDS_NS_URI =
        "http://www.escidoc.de/schemas/metadatarecords/0.2";

    public static final String METADATA_NS_URI =
        "http://www.escidoc.de/schemas/metadata/0.2";

    public static final String ORGANIZATIONAL_UNIT_NS_URI =
        "http://www.escidoc.de/schemas/organizationalunit/0.8";

    public static final String PROPERTIES_NS_URI =
        "http://www.escidoc.de/schemas/properties/0.2";

    public static final String RELATIONS_NS_URI =
        "http://www.escidoc.de/schemas/relations/0.2";

    public static final String REQUESTS_NS_URI =
        "http://www.escidoc.de/schemas/pdp/0.2/requests";

    public static final String RESULTS_NS_URI =
        "http://www.escidoc.de/schemas/pdp/0.2/results";

    public static final String ROLE_NS_URI =
        "http://www.escidoc.de/schemas/role/0.2";

    public static final String SREL_NS_URI =
        "http://escidoc.de/core/01/structural-relations/";

    public static final String STAGING_FILE_NS_URI =
        "http://www.escidoc.de/schemas/stagingfile/0.2";

    public static final String TOC_NS_URI =
        "http://www.escidoc.de/schemas/toc/0.2";

    public static final String SCHEMA_NS_URI =
        "http://www.escidoc.de/schemas/xml-schema/0.2";

    public static final String STRUCT_MAP_NS_URI =
        "http://www.escidoc.de/schemas/structmap/0.4";
    ...
    public static final String USER_GROUP_NS_URI =
        "http://www.escidoc.de/schemas/usergroup/0.6";
    ...
    public static final String XPATH_USER_ACCOUNT_LAST_MOD_DATE =
        XPATH_USER_ACCOUNT + "/@last-modification-date";

    public static final String XPATH_USER_ACCOUNT_XLINK_TYPE =
        XPATH_USER_ACCOUNT + "/@type";

    public static final String XPATH_USER_ACCOUNT_XLINK_HREF =
        XPATH_USER_ACCOUNT + "/@href";

    public static final String XPATH_USER_ACCOUNT_PROPERTIES =
        XPATH_USER_ACCOUNT + "/properties";

    public static final String XPATH_USER_ACCOUNT_CREATED_BY =
        XPATH_USER_ACCOUNT_PROPERTIES + "/" + NAME_CREATED_BY;

    public static final String XPATH_USER_ACCOUNT_MODIFIED_BY =
        XPATH_USER_ACCOUNT_PROPERTIES + "/" + NAME_MODIFIED_BY;
    ...
    public static final String XPATH_USER_ACCOUNT_CREATED_BY_OBJID =
        XPATH_USER_ACCOUNT_CREATED_BY + "/@" + NAME_OBJID;
    ...
    public static final String XPATH_USER_ACCOUNT_CREATION_DATE =
        XPATH_USER_ACCOUNT_PROPERTIES + "/creation-date";

    public static final String XPATH_USER_ACCOUNT_RESOURCES =
        XPATH_USER_ACCOUNT + "/" + NAME_RESOURCES;

    public static final String XPATH_USER_ACCOUNT_RESOURCES_XLINK_HREF =
        XPATH_USER_ACCOUNT_RESOURCES + PART_XLINK_HREF;

    public static final String XPATH_USER_ACCOUNT_RESOURCES_XLINK_TITLE =
        XPATH_USER_ACCOUNT_RESOURCES + PART_XLINK_TITLE;

    public static final String XPATH_USER_ACCOUNT_RESOURCES_XLINK_TYPE =
        XPATH_USER_ACCOUNT_RESOURCES + PART_XLINK_TYPE;
    ...
    public static final String XPATH_USER_ACCOUNT_ACTIVE =
        XPATH_USER_ACCOUNT_PROPERTIES + "/active";

    public static final String XPATH_USER_ACCOUNT_LOGINNAME =
        XPATH_USER_ACCOUNT_PROPERTIES + "/login-name";

    public static final String XPATH_USER_ACCOUNT_NAME =
        XPATH_USER_ACCOUNT_PROPERTIES + "/name";
    ...
    public static final String XPATH_SRW_RESPONSE_ROOT =
    ...
    public static final String XPATH_USER_GROUP_MODIFIED_BY =
        XPATH_USER_GROUP_PROPERTIES + "/" + NAME_MODIFIED_BY;

    public static final String XPATH_USER_GROUP_MODIFIED_BY_OBJID =
        XPATH_USER_GROUP_MODIFIED_BY + "/@" + NAME_OBJID;
    ...
    public static final String XPATH_USER_GROUP_CREATED_BY_OBJID =
        XPATH_USER_GROUP_CREATED_BY + "/@" + NAME_OBJID;

    public static final String XPATH_USER_GROUP_CREATED_BY_XLINK_HREF =
        XPATH_USER_GROUP_CREATED_BY + "/@" + NAME_HREF;

    public static final String XPATH_USER_GROUP_CREATED_BY_XLINK_TITLE =
        XPATH_USER_GROUP_CREATED_BY + "/@" + NAME_TITLE;

    public static final String XPATH_USER_GROUP_CREATED_BY_XLINK_TYPE =
        XPATH_USER_GROUP_CREATED_BY + "/@" + NAME_TYPE;
    ...
    public static final String XPATH_USER_GROUP_RESOURCES_XLINK_TITLE =
        XPATH_USER_GROUP_RESOURCES + PART_XLINK_TITLE;

    public static final String XPATH_USER_GROUP_RESOURCES_XLINK_TYPE =
        XPATH_USER_GROUP_RESOURCES + PART_XLINK_TYPE;

    public static final String XPATH_USER_GROUP_CURRENT_GRANTS =
        XPATH_USER_GROUP_RESOURCES + "/" + NAME_CURRENT_GRANTS;

    public static final String XPATH_USER_GROUP_CURRENT_GRANTS_XLINK_TYPE =
        XPATH_USER_GROUP_CURRENT_GRANTS + PART_XLINK_TYPE;

    public static final String XPATH_USER_GROUP_ACTIVE =
        XPATH_USER_GROUP_PROPERTIES + "/active";

    public static final String XPATH_USER_GROUP_NAME =
        XPATH_USER_GROUP_PROPERTIES + "/name";

    public static final String XPATH_USER_GROUP_LABEL =
        XPATH_USER_GROUP_PROPERTIES + "/label";
    ...
    public static final String XPATH_STATISTIC_DATA_SCOPE =
        "/statistic-record/scope";

    public static final String XPATH_AGGREGATION_DEFINITION_SCOPE =
        "/aggregation-definition/scope";

    public static final String XPATH_REPORT_DEFINITION_SCOPE =
        "/report-definition/scope";

    public static final String XPATH_SCOPE_OBJID = XPATH_SCOPE + PART_OBJID;

    public static final String XPATH_STATISTIC_DATA_SCOPE_OBJID =
        XPATH_STATISTIC_DATA_SCOPE + PART_OBJID;

    public static final String XPATH_AGGREGATION_DEFINITION =
        "/aggregation-definition";

    public static final String XPATH_REPORT_DEFINITION = "//report-definition";

    public static final String XPATH_REPORT_DEFINITION_OBJID =
        XPATH_REPORT_DEFINITION + PART_OBJID;

    public static final String XPATH_REPORT = "/report";

    public static final String XPATH_REPORT_REPORT_DEFINITION =
     ...
     * 
     * @param upperCase
     *            If true than contains the String only capital letters, false
     *            only small letters.
     ...
     * The client to use is determined by getClient() that must be implemented
     * by the concrete test class.
     * 
     * @param resourceXml
    ...
    public static void assertMatches(
        final String message, final String matchString, final String toTest) {
     ...
     */
    public static void assertXmlEquals(
        final String message, final File expected, final String toBeAsserted)
        throws Exception {
    ...
    public static void assertXmlExists(
        final String message, final Node node, final String xPath,
        final Node namespaceNode) throws Exception {
    ...
    /**
     * Assert that the value in the Document selected by the xPath equals the
     * expected value.
     * 
     * @param message
     *            The message printed if assertion fails.
    ...
    public static void assertXmlEquals(
        ...
        assertNotNull(message + " Node selected by xpath not found [" + xPath
            + "]", comp);
     ...
     */
    public static void assertXmlEquals(
        final String message, final Node expected, final Node result,
    ...
    /**
     * Assert that the value in the Document selected by the xPath NOT equals
    ...
    public static void assertXmlNotEquals(
        final String message, final Node unexpected, final Node toBeAsserted,
        final String xPath) throws Exception {

        Node toBeAssertedComp = selectSingleNode(toBeAsserted, xPath);
        Node unexpectedComp = selectSingleNode(unexpected, xPath);
        assertNotEquals(message, unexpectedComp.getTextContent(),
            toBeAssertedComp.getTextContent());
    }

    /**
     * Asserts that the timestamp has been updated.<br>
     * This assertion fails if the timestamp in the previous document is not
     * less than the timestamp in the updated document. The timestamp is
     * identified by the root element's "last-modification-timestamp" attribute.
     * 
     * @param message
     *            The message printed if assertion fails.
     * @param previous
    ...
    public static void assertXmlLastModificationDateUpdate(
        final String message, final Document previous,
        final Document toBeAsserted) throws Exception {

        final String previousLastModificationDateValue =
            getLastModificationDateValue(previous);
        final String toBeAssertedLastModificationDateValue =
            getLastModificationDateValue(toBeAsserted);
        assertDateBeforeAfter(previousLastModificationDateValue,
            toBeAssertedLastModificationDateValue);
    }
    ...
    public static void assertNotEquals(
        final String message, final Object unexpected, final Object toBeAsserted) {

        if (unexpected == null && toBeAsserted == null
            || unexpected.equals(toBeAsserted)) {
     ...
     *             If anything fails.
     */
    public static Node deleteElement(final Node node, final String xPath)
        throws Exception {

        Node delete = selectSingleNode(node, xPath);
        assertNotNull("No node found for provided xpath [" + xPath + "]",
            delete);
        if (delete instanceof AttrImpl) {
            throw new Exception("Removal of Element not successful! "
                + "xPath selects an Attribute!");
        }
        else {
     ...
     *             If anything fails.
     */
    public static Node deleteElements(final Node node, final String xPath)
        throws Exception {
    ...
    public static String getAttributeValue(
        final Node node, final String xPath, final String attributeName)
        throws Exception {
     ...
     *             If anything fails.
     */
    public static Node deleteAttribute(
        final Node node, final String xPath, final String attributeName)
        throws Exception {
        ...
        if (delete.hasAttributes()) {
            for (int i = 0; i < delete.getAttributes().getLength(); ++i) {
                ...
                if (nodeName.endsWith(":" + attributeName)
     ...
     *             If anything fails.
     */
    public static Node deleteAttribute(final Node node, final String xPath)
        throws Exception {
    ...
    public Node substituteId(
        ...
        if (getTransport() == Constants.TRANSPORT_REST) {
            ...
            path =
                replace.getTextContent().substring(0,
                    replace.getTextContent().lastIndexOf("/") + 1);
        }
        else {
     ...
     * This returns Node.getPrefix() if this is not null. Otherwise, ittries to
     * extract the prefix from Node.getNodeName(). If this fails, null is
     * returned.
     * 
     * @param node
     ...
     * attributes and an objid attribute.
     * 
     * @param doc
     ...
     *             Thrown if anything fails.
     */
    public static String getPrefix(final Node node, final String xPath)
        throws Exception {
    ...
    /**
     * Adds the provided new node as the child of the element selected by the
     * xPath in the given node.
     * 
     * @param node
     *            The node.
     * @param xPath
     ...
     *             If anything fails.
     */
    public static Node addAsChild(
        final Node node, final String xPath, final Element newNode)
        throws Exception {
    ...
    /**
     * Adds the provided new node after the element selected by the xPath in the
     * given node.
     * 
     * @param node
     *            The node.
     ...
     *             If anything fails.
     */
    public static Node addAfter(
        final Node node, final String xPath, final Node newNode)
        throws Exception {
    ...
    /**
     * Adds the provided new node before the element selected by the xPath in
     * the given node.
     * 
     * @param node
     *            The node.
    ...
    /**
     * Adds the provided new attribute node to the element selected by the xPath
     * in the given node.
     * 
     * @param node
     *            The node.
     ...
     *             If anything fails.
     */
    public static Node addAttribute(
        final Node node, final String xPath, final Attr attributeNode)
        throws Exception {
    ...
    public static NodeList selectNodeList(
        final Node node, final String xPath, final Node namespaceNode)
        throws TransformerException {
     ...
     *             If an error ocurres.
     */
    public static String getWithdrawTaskParam(
        final String timestamp, final String comment) throws Exception {
        String result = null;
        if (timestamp != null) {
            result =
                toString(
     ...
     *             If anything fails.
     */
    public static Node selectSingleNodeAsserted(
        final Node node, final String xPath) throws Exception {
    ...
    /**
     * Get the filter parameter for retrieving contexts matching the given
     * filter criteria. If a criteria is null the filter is deleted from the
     * parameter.
     * 
     * @param user
     *            The expected user.
    ...
    /**
     * Get the filter parameter for retrieving members of a context matching the
     * given filter criteria. If a criteria is null the filter is deleted from
     * the parameter.
     * 
     * @param members
    ...
    public static String getFilterRetrieveMembersOfContext(
        final List<String> members, final String objectType, final String user,
        final String role, final String status, final String contentType)
        throws Exception {
        ...
        if ((members != null) && (members.size() > 0)) {
            for (int i = 0; i < 5; ++i) {
                ...
                try {
                    value = members.get(i);
                    filter =
                        (Document) replaceInFilter(filter, value,
            ...
            filter =
                (Document) replaceInFilter(filter, null,
                    "param/filter[@name=\"members\"]");
        }

        filter =
            (Document) replaceInFilter(filter, objectType,
                "param/filter[@name=\"http://www.w3.org/1999/02/"
        ...
        filter =
            (Document) replaceInFilter(filter, status,
                "param/filter[@name=\"http://escidoc.de/core/01/"
                    + "properties/public-status\"]");
        filter =
            (Document) replaceInFilter(filter, contentType,
                "param/filter[@name=\"http://escidoc.de/core/01/"
    ...
    /**
     * If value is null the element selected by xPath is removed from the filter
     * otherwise the elements value is set to vlaue.
     * 
     * @param filter
     ...
     *             If anything fails.
     */
    public static Node replaceInFilter(
        final Node filter, final String value, final String xPath)
        throws Exception {
     ...
     *             Thrown if anything fails.
     */
    public String getTheLastModificationDate(final Document resource)
        throws Exception {
    ...
    /**
     * Gets the task param containing the last modification date of the
     * specified object.
     * 
    ...
    public String getTheLastModificationParam(
        final boolean includeComment, final String id) throws Exception {
     ...
     */
    public String getTheLastModificationParam(
        final boolean includeComment, final String id, final String comment)
        throws Exception {

        return getTheLastModificationParam(includeComment, id, comment,
     ...
     */
    public static void assertDateBeforeAfter(
        final String before, final String after) throws Exception {
        ...
        if (!oldModCal.before(newModCal)) {
            fail("Old last modification date is not before new last"
                + " modification date.");
        }
    }

    /**
     * Creates a <code>java.util.Calendar</code> object from an xml dateTime
     * string.
     * 
     * @param dateTime
     ...
     */
    public static Calendar getCalendarFromXmlDateString(String dateTime)
        throws ParseException {
        Calendar cal = null;
    ...
    /**
     * Validates Item XML against the XML Schema, checks if the xml:base exists
    ...
    public void assertXmlValidItem(final String xmlData) throws Exception {
        ...
        URL url =
            new URL("http://" + Constants.HOST_PORT + "/xsd/"
                + getTransport(false) + "/item/0.10/item.xsd");
    ...
    /**
     * Validates ContentRelation XML against the XML Schema, checks if the
     * xml:base exists and if all placeholders are replaced.
     * 
     * @param xmlData
     *            The xml document as string.
     * @throws Exception
     *             If an error occures.
     */
    public void assertXmlValidContentRelation(final String xmlData)
        throws Exception {
    ...
    /**
     * Validates Content Model XML against the XML Schema, if the xml:base
     * exists and if all placeholders are resolved.
     * 
     * @param xmlData
     *            The xml document as string.
     * @throws Exception
    ...
    public void assertXmlValidContentModel(final String xmlData)
        ...
        URL url =
            new URL("http://" + Constants.HOST_PORT + "/xsd/"
                + getTransport(false) + "/content-model/0.1/content-model.xsd");
        assertXmlValid(xmlData, url);
        assertXlinkXmlBaseExists(xmlData);
        assertAllPlaceholderResolved(xmlData);
    }

    public void assertXmlValidSetDefinition(final String xmlData)
        throws Exception {
     ...
     *             If an error occures.
     */
    public void assertXmlValidSetDefinitions(final String xmlData)
        throws Exception {
    ...
    /**
     * Asserts there is no namespace declaration for prefixes starting with
     * 'xml'.
     * 
     * @param xmlData
     *            The xml document as string.
    ...
    public static void assertXmlPrefixNotDeclared(final String xmlData) {
        if (xmlData.contains("xmlns:xml")) {
            fail("Namespace declaration for prefixes starting with 'xml'"
                ...
                + "Namespace because MS Internet Explorer perceive it as "
                + "an error.");
        }
    }
    ...
    /**
     * Asserts that no local href (without protocol and host) appears without
     * xml:base.
     * 
     * @param xmlData
     *            The xml data to be asserted.
    ...
    public void assertXmlValidResult(final String xmlData) throws Exception {
        ...
        URL url =
            new URL("http://" + Constants.HOST_PORT + "/xsd/"
                + getTransport(false) + "/common/0.1/result.xsd");
        assertXmlValid(xmlData, url);
        assertAllPlaceholderResolved(xmlData);
    }
    ...
    public void assertXmlValidToc(final String xmlData) throws Exception {
        ...
        URL url =
            new URL("http://" + Constants.HOST_PORT + "/xsd/"
                + getTransport(false) + "/toc/0.7/toc.xsd");
        assertXmlValid(xmlData, url);
        assertAllPlaceholderResolved(xmlData);
    }
     ...
     *             If an error occures.
     */
    public static void assertXmlValidTaskParam(final String xmlData)
        throws Exception {
        URL url =
            new URL("http://" + Constants.HOST_PORT
                + "/xsd/common/0.2/add-relations.xsd");
        assertXmlValid(xmlData, url);
    }
    ...
    public void assertXmlValidItemList(final String xmlData) throws Exception {
        URL url =
            new URL("http://" + Constants.HOST_PORT + "/xsd/"
                + getTransport(false) + "/item/0.10/item-list.xsd");
        assertXmlValid(xmlData, url);
        assertAllPlaceholderResolved(xmlData);
    }

    public void assertXmlValidItemRefList(final String xmlData)
        throws Exception {
        URL url =
            new URL("http://" + Constants.HOST_PORT + "/xsd/"
                + getTransport(false) + "/item/0.4/item-ref-list.xsd");
        assertXmlValid(xmlData, url);
        assertAllPlaceholderResolved(xmlData);
    }

    public static void assertXmlValidXmlSchema(final String xmlData)
        throws Exception {
        URL url =
            new URL("http://" + Constants.HOST_PORT
                + "/xsd/common/0.2/xml-schema.xsd");
        assertXmlValid(xmlData, url);
    }

    public void assertXmlValidContextMembersList(final String xmlData)
        throws Exception {
        URL url =
            new URL("http://" + Constants.HOST_PORT + "/xsd/"
                + getTransport(false) + "/common/0.10/member-list.xsd");
        assertXmlValid(xmlData, url);
    }

    public static void assertXmlValidContextMemberRefsList(final String xmlData)
        throws Exception {
        URL url =
            new URL("http://" + Constants.HOST_PORT
                + "/xsd/common/0.3/member-ref-list.xsd");
        assertXmlValid(xmlData, url);
    }

    /**
     * Asserts that the provided xml data is valid for the subresource
     * resources.
     * 
     * @param toBeAsserted
     *            The xml data to be asserted.
     ...
     *             If anything fails.
     */
    public static void assertXmlValidResources(final String toBeAsserted)
        throws Exception {

        if (resourcesSchema == null) {
            resourcesSchema =
                getSchema("http://" + Constants.HOST_PORT
                    + "/xsd/common/0.2/resources.xsd");
        }
    ...
    public void assertXmlValidScope(final String xmlData) throws Exception {
        URL url =
            new URL("http://" + Constants.HOST_PORT + "/xsd/"
                + getTransport(false) + "/scope/0.4/scope.xsd");
        assertAllPlaceholderResolved(xmlData);
        assertXmlValid(xmlData, url);
    }
    ...
    public void assertXmlValidScopeList(final String xmlData) throws Exception {
        URL url =
            new URL("http://" + Constants.HOST_PORT + "/xsd/"
                + getTransport(false) + "/scope/0.4/scope-list.xsd");
        assertAllPlaceholderResolved(xmlData);
        assertXmlValid(xmlData, url);
    }
     ...
     *             If anything fails.
     */
    public void assertXmlValidAggregationDefinition(final String xmlData)
        throws Exception {
        URL url =
            new URL("http://" + Constants.HOST_PORT + "/xsd/"
                + getTransport(false)
    ...
    /**
     * Asserts that the provided xml data is a valid
     ...
     *             If anything fails.
     */
    public void assertXmlValidAggregationDefinitionList(final String xmlData)
        throws Exception {
        URL url =
            new URL("http://" + Constants.HOST_PORT + "/xsd/"
                + getTransport(false)
     ...
     *             If anything fails.
     */
    public void assertXmlValidReportDefinition(final String xmlData)
        throws Exception {
        URL url =
            new URL("http://" + Constants.HOST_PORT + "/xsd/"
                + getTransport(false)
     ...
     *             If anything fails.
     */
    public void assertXmlValidReportDefinitionList(final String xmlData)
        throws Exception {
        URL url =
            new URL("http://" + Constants.HOST_PORT + "/xsd/"
                + getTransport(false)
    ...
    public void assertXmlValidReport(final String xmlData) throws Exception {
        URL url =
            new URL("http://" + Constants.HOST_PORT + "/xsd/"
                + getTransport(false) + "/report/0.4/report.xsd");
        assertAllPlaceholderResolved(xmlData);
        assertXmlValid(xmlData, url);
    }
     ...
     *             If anything fails.
     */
    public static void assertXmlValidSearchResult(final String xmlData)
        throws Exception {
        URL url =
            new URL("http://" + Constants.HOST_PORT
                + "/xsd/soap/search-result/0.8/srw-types.xsd");
        assertXmlValid(xmlData, url);
    }
     ...
     *             If anything fails.
     */
    public static void assertXmlValidExplainPlan(final String xmlData)
        throws Exception {
        String replacedData = xmlData;
        if (replacedData.indexOf("explainResponse") > -1) {
            replacedData =
                replacedData.replaceFirst(
                    "(?s).*?(<[^>]*?explain[\\s>].*?<\\/[^>]*?explain.*?>).*",
                    "$1");
        }
        URL url =
            new URL("http://" + Constants.HOST_PORT
                + "/xsd/soap/search-result/0.3/zeerex-2.0.xsd");
     ...
     *             If anything fails.
     */
    public static void assertXmlValid(final String xmlData, final URL schemaURL)
        throws Exception {
     ...
     *             If anything fails.
     */
    public static void assertXmlValid(
        final String xmlData, final InputStream schema) throws Exception {
     ...
     *             If anything fails.
     */
    public static void assertXmlValid(final String xmlData, final Schema schema)
        throws Exception {
    ...
    /**
     * Asserts that the objid and href attributes of the root element exist and
     * are consistent.
     * 
     * @param document
     *            The document.
     ...
     *             Thrown if anything fails.
     */
    public void assertHrefObjidConsistency(final Document document)
        throws Exception {
     ...
     *            The document.
     * @param xPath
     *            The xpath to the element containing the objid and href
     *            attributes. If this parameter is <code>null</code>, the root
     *            element is used.
     * @throws Exception
     *             Thrown if anything fails.
     */
    public void assertHrefObjidConsistency(
        ...
        if (xPath == null) {
            ...
            assertEquals("Href and objid are inconsistent in root element",
                objidFromHref, objid);
        }
        else {
            Node objidNode = selectSingleNode(document, xPath + "/@objid");
            Node hrefNode = selectSingleNode(document, xPath + "/@href");
            assertNotNull("Objid not found for element [" + xPath + "]",
                objidNode);
            assertNotNull("Href not found for element [" + xPath + "]",
                hrefNode);
            objid = objidNode.getTextContent();
            objidFromHref = getObjidFromHref(hrefNode.getTextContent());
            assertEquals("Href and objid are inconsistent [" + xPath + "]",
                objidFromHref, objid);
        }
    ...
    public static void assertXmlCreatedContext(final String xmlData)
        ...
        assertXmlNotNull("/context/properties/creator/@href", document,
            "/context/properties/creator/@href");
        assertXmlNotNull("/context/properties/creator/@title", document,
            "/context/properties/creator/@title");

        assertXmlNotNull("/context/admin-descriptor/@objid", document,
            "/context/admin-descriptor/@objid");
        assertXmlNotNull("/context/admin-descriptor/@href", document,
            "/context/admin-descriptor/@href");

        assertXmlNotNull("/context/admin-descriptor/properties/creator/@href",
            document, "/context/admin-descriptor/properties/creator/@href");
        assertXmlNotNull("/context/admin-descriptor/properties/creator/@title",
            document, "/context/admin-descriptor/properties/creator/@title");
     ...
     *             If anything fails.
     */
    public static void assertXmlNotExists(
        final String message, final String xml, final String xPath)
        throws Exception {
    ...
    /**
     * Assert that the node selected by the xpath exists int the given document
     * and is not empty.
     * 
     * @param elementLabel
     ...
     *             If anything fails.
     */
    public static void assertXmlNotNull(
        final String elementLabel, final Node document, final String xPath)
        throws Exception {
    ...
    /**
     * Extracts the id from the href attribute of the root element of the
     * provided document.
     * 
     * @param document
     ...
     *             If anything fails.
     */
    public static String getIdFromRootElementHref(final Document document)
        throws Exception {
    ...
    public String getIdFromRootElement(final String xml) {
        ...
        if (getTransport() == Constants.TRANSPORT_SOAP) {
            ...
            pATTERNoBJIDaTTRIBUTEjUSTfORtHISmETHOD =
                Pattern.compile("href=\"/ir/[^/]+/([^\"]*)\"");
        }
     ...
     *             If anything fails.
     */
    public static String getRootElementHrefValue(final Document document)
        throws Exception {
     ...
     * It tries to get the objid attribute of the selected node. If this fails,
     * it tries to get the xlink:href attribute. If both fails, an assertion
     * exception is "thrown".
     * 
     * @param node
    ...
    public String getObjidValue(final Node node, final String xPath)
        ...
        assertNotNull("No Element selected to retrieve the object id from",
            selected);
        NamedNodeMap attributes = selected.getAttributes();
        assertNotNull("Selected node has no attributes (not an element?) ",
            attributes);
        ...
        if (objidAttr != null) {
            ...
            assertNotNull("Selected node neither has an objid "
                + "attribute nor an xlink href attribute", objidAttr);
     ...
     * 
     * @param xml
     *            The xml representation of an object to retrieve the value
     *            from.
     ...
     *             If anything fails.
     */
    public final String getLatestVersionObjidValue(final String xml)
        throws Exception {
        ...
        String id =
            getIdFromRootElement(xml) + VERSION_SUFFIX_SEPARATOR
                + latestVersionNode.getTextContent();
        return (id);
    }
    ...
    /**
     * Gets the creation-date element of the first element named "properties"
     * from the document.
     * 
     * @param document
     *            The document to retrieve the value from.
     ...
     *             If anything fails.
     */
    public static String getCreationDateValue(final Document document)
        throws Exception {
    ...
    /**
     * Gets the creation-date element of the specified properties element from
     * the document.
     * 
     * @param document
     *            The document to retrieve the value from.
     * @param xPath
     *            The xpath to the parent element that contains the creation
     *            date element. If this is <code>null</code>, the first element
     *            named "properties" will be selected.
     * @return Returns the creation date value or <code>null</code>.
     * @throws Exception
     *             If anything fails.
     */
    public static String getCreationDateValue(
        final Document document, final String xPath) throws Exception {
        ...
        final Node creationDateElement =
            selectSingleNode(document, creationDateXpath);
     ...
     *             If anything fails.
     */
    public static String assertCreationDateExists(
        final String message, final Document document) throws Exception {

        return assertCreationDateExists(message, document, null);
    }

    /**
     * Asserts that the creation-date element of the specified properties
     * element from the document exists.
     * 
     * @param message
     *            The fail message.
     * @param document
     ...
     */
    public static String assertCreationDateExists(
        final String message, final Document document, final String xPath)
        throws Exception {

        final String creationDate = getCreationDateValue(document, xPath);
        assertNotNull(prepareAssertionFailedMessage(message)
            + "No creation-date", creationDate);
        return creationDate;
    }
    ...
    public static String getRootElementAttributeValueNS(
        ...
        if (root.getNamespaceURI() != null) {
            ...
            assertXmlExists("Attribute not found [" + xPath + "]. ", document,
                xPath);
    ...
    /**
     * Returns a positive integer if ts1 depicts a time after ts2 (ts1 > ts2), 0
     * if ts1 and ts2 depict the same time (ts1 == ts2), and a negative integer
     * if if ts1 depicts a time before ts2 (ts1 < ts2).
     * 
     * @param ts1
     *            The first timestamp.
     * @param ts2
     ...
     *             If anything fails (e.g. one timstamp has incorrect format).
     */
    public static int compareTimestamps(final String ts1, final String ts2)
        throws Exception {

        int result = 0;

        XMLGregorianCalendar date1 =
            DatatypeFactory.newInstance().newXMLGregorianCalendar(ts1);
        XMLGregorianCalendar date2 =
            DatatypeFactory.newInstance().newXMLGregorianCalendar(ts2);
    ...
    /**
     * Get the current time as timestamp. The date format is
     * yyyy-MM-dd'T'HH:mm:ss.SSSZ.
     * 
    ...
    public static String normalizeTimestamp(final String timestamp) {
        ...
        return timestamp.replaceAll("Z", "+0000").replaceAll(
            "([+-][0-9]{2}):([0-9]{2})", "$1$2");
    }

    /**
     * Return a unique name. It is the concatenation of the prefix and the
    ...
    /**
     * Makes the value of the selected node of the provided node unique by
     * adding a timestamp to it.<br>
     ...
     *             If anything fails.
     */
    public String setUniqueValue(final Node node, final String xpath)
        throws Exception {
    ...
    /**
     * Changes the given template. If currentElement (e.g.
     * /context/properties/creation-date) is not a key in the elements Map,
     * currentElement is interpreted as a xpath and the selected node is removed
     * from the template. If the value for key currentElement is different from
     * the empty String, the selected node's value is substituted with this
     * value.
     * 
     * @param template
    ...
    public static Node changeTemplateWithReadOnly(
        final Node template, final Map<String, String> elements,
        final String currentElement) throws Exception {
        ...
        if (elements.get(currentElement) == null) {
            ...
            if (element.indexOf("@" + XLINK_HREF_TEMPLATES) != -1) {
                element =
                    element.replaceAll("@" + XLINK_HREF_TEMPLATES, "@href");
            }
     ...
     * 
     * @param element
     *            The element into that the namespace definitions shall be
     *            inserted.
    ...
    public Element insertNamespaces(final Element element) throws Exception {
        ...
        element.setAttribute("xmlns:prefix-internal-metadata",
            INTERNAL_METADATA_NS_URI);
        element.setAttribute("xmlns:prefix-item", ITEM_NS_URI);
        element.setAttribute("xmlns:prefix-member-list", MEMBER_LIST_NS_URI);
        element.setAttribute("xmlns:prefix-member-ref-list",
            MEMBER_REF_LIST_NS_URI);
        element.setAttribute("xmlns:prefix-metadata", METADATA_NS_URI);
        element.setAttribute("xmlns:prefix-metadatarecords",
            METADATARECORDS_NS_URI);
        element.setAttribute("xmlns:prefix-organizational-unit",
            ORGANIZATIONAL_UNIT_NS_URI);
        ...
        element
            .setAttribute("xmlns:prefix-xacml-context", XACML_CONTEXT_NS_URI);
     ...
     *             If anything fails.
     */
    public Document insertNamespacesInRootElement(final Document doc)
        throws Exception {

        final Element rootElement = getRootElement(doc);
        assertNotNull("No root element found in the provided document",
            rootElement);
     ...
     * @return returns the provided <code>Node</code> object. This
     *         <code>Node</code> object may be changed.
     * @throws Exception
     *             Thrown if anything fails.
     */
    public static Node deleteNodes(final Node node, final String xPath)
        throws Exception {
        ...
        for (int i = 0; i < nodes.getLength(); ++i) {
            ...
            if (delete.getNodeType() == Node.ATTRIBUTE_NODE) {
                ...
                elementXpath +=
                    "[@" + attribute + "=\"" + delete.getTextContent().trim()
                        + "\"]";
                Node parent = selectSingleNode(node, elementXpath);
                if (parent.hasAttributes()) {
                    parent
                        .getAttributes().removeNamedItem(delete.getNodeName());
                }
            }
            else {
                delete.getParentNode().removeChild(delete);
    ...
    /**
     * Asserts that the value of the selected node of the provided node starts
     ...
     * @param expectedBase
     *            The expected value with that the selected node's value shall
     *            start.
     ...
     *             Thrown if anything fails.
     */
    public static String assertHrefBase(
        final Node node, final String xPath, final String expectedBase)
        throws Exception {
    ...
    /**
     * Asserts that the selected xlink:type attribute of the provided node has
     * the value "simple".
     * 
     * @param document
     ...
     *             If an error ocurres.
     */
    public static void assertXlinkType(
        final Document document, final String xPath) throws Exception {

        assertXmlExists("No xlink:type attribute found [" + xPath + "]",
            document, XPATH_USER_ACCOUNT_CURRENT_GRANTS_XLINK_TYPE);
        assertXmlEquals("Unexpected xlink:type [" + xPath + "]", document,
            xPath, "simple");
    }

    public static String getTaskParametrSpo(
        final String query, final String format) {
    ...
    /**
     * Modifies the namespace prefixes of the provided xml data by adding a
     * prefix to the namespac.
     * 
     * 
     * 
     * 
    ...
    public static String modifyNamespacePrefixes(final String xml) {
        ...
        Matcher matcher =
            PATTERN_MODIFY_NAMESPACE_PREFIXES_REPLACE_PREFIXES.matcher(xml);
        String ret = matcher.replaceAll("$1prefix-$2");
        matcher =
            PATTERN_MODIFY_NAMESPACE_PREFIXES_FIX_NAMESPACE_DECLARATIONS
                .matcher(ret);
    ...
    public void assertRdfList(
        final Document xmlDoc, final String objectTypeUri,
        final String orderByPropertyUri, final boolean descending,
        ...
        for (int i = 0; i < descriptions.getLength(); i++) {
            ...
            if (!foundTypeObjectTypeUri) {
                String about =
                    selectSingleNode(descriptions.item(i), "@about")
                        .getNodeValue();
                fail("Could not find type element refering " + objectTypeUri
                    + " in RDF description of " + about + ".");
            }
        }
        ...
        if (orderByPropertyUri != null) {
            ...
            for (int i = 1; i < descriptions.getLength(); i++) {
                ...
                String lower =
                    selectSingleNodeAsserted(descriptions.item(a),
                        orderValueXPath).getNodeValue();
                String higher =
                    selectSingleNodeAsserted(descriptions.item(b),
                        orderValueXPath).getNodeValue();
    ...
    public static void assertOrderNotAfter(final int lower, final int higher)
        throws Exception {
        if (lower > higher) {
    ...
    public void assertContentStreamsOf_escidoc_item_198_for_create_3content_streams(
        final String itemId, final Document itemDoc,
        final boolean isRootContentStreams) throws Exception {
        ...
        if (isRootContentStreams) {
            ...
            if (transport == Constants.TRANSPORT_REST) {
                selectSingleNodeAsserted(itemDoc,
                    "/content-streams[@href = '/ir/item/" + itemId
                        + "/content-streams']");
            }
            selectSingleNodeAsserted(itemDoc,
                "/content-streams[@last-modification-date]");
        ...
        // not more
        assertNull(selectSingleNode(itemDoc,
     ...
     *             Thrown if uploading failed.
     */
    public URL uploadFileToStagingServlet(final File file, final String mimeType)
        throws Exception {

        InputStream fileInputStream = new FileInputStream(file);

        return uploadFileToStagingServlet(fileInputStream, file.getName(),
            mimeType);
    }
    ...
    public URL uploadFileToStagingServlet(
        final String testUploadFile, final String mimeType) throws Exception {

        InputStream fileInputStream =
            StagingFileTestBase.getFileInputStream(testUploadFile);

        return uploadFileToStagingServlet(fileInputStream, testUploadFile,
            mimeType);
    }
     ...
     */
    public URL uploadFileToStagingServlet(
        final InputStream fileInputStream, final String filename,
        ...
        for (int i = 0; i < methods.length; i++) {
            if (methods[i].getAnnotations() != null) {
                for (Annotation annotation : methods[i].getAnnotations()) {
                    if (annotation
                        .annotationType().equals(org.junit.Test.class)) {
                        count++;
                    }
                }
            }
     ...
     * 
     * TODO this test is not complete, because of an outstanding definition.
     * (see issue INFR-865)
     * 
     * @param xmlData
     *            XML of the Item
    ...
    public void assertItemXlinkTitles(final String xmlData) throws Exception {
        ...
        if (getTransport() == Constants.TRANSPORT_REST) {
            ...
            // relations
            Node relations =
                XPathAPI.selectSingleNode(document, "/item/relations/@title",
                    document);
            if (relations != null) {
                assertEquals(
                    "Xlink:title of relations differs from convention",
                    "Relations of Item", relations.getTextContent());
            }
    ...
    public void assertContainerXlinkTitles(final String xmlData)
        ...
        if (getTransport() == Constants.TRANSPORT_REST) {
            ...
            if (relations != null) {
                assertEquals(
                    "Xlink:title of relations differs from convention",
                    "Relations of Container", relations.getTextContent());
            }
