...
public class UserAccountClient extends GrantClient
     ...
     * 
     * @param userXml
     *            The xml representation of an user
    ...
    public Object create(final Object userXml) throws Exception {
        ...
        return callEsciDoc("UserAccount.create", METHOD_CREATE,
            Constants.HTTP_METHOD_PUT, Constants.USER_ACCOUNT_BASE_URI,
            new String[] {}, changeToString(userXml));
    }
    ...
    public Object delete(final String id) throws Exception {
        return callEsciDoc("UserAccount.delete", METHOD_DELETE,
            Constants.HTTP_METHOD_DELETE, Constants.USER_ACCOUNT_BASE_URI,
            new String[] { id });
    }
    ...
    public Object retrieve(final String id) throws Exception {
        return callEsciDoc("UserAccount.retrieve", METHOD_RETRIEVE,
            Constants.HTTP_METHOD_GET, Constants.USER_ACCOUNT_BASE_URI,
            new String[] { id });
    }
    ...
    public Object retrieveCurrentUser() throws Exception {
        return callEsciDoc("UserAccount.retrieveCurrentUser", 
            METHOD_RETRIEVE_CURRENT_USER,
            Constants.HTTP_METHOD_GET, 
            Constants.USER_ACCOUNT_BASE_URI + "/current",
            new String[] { });
    }
    ...
    public Object retrieveResources(final String id) throws Exception {
        return callEsciDoc("UserAccount.retrieveResources",
    ...
    public Object retrieveUserAccounts(final Map<String, String[]> filter)
        throws Exception {
        return callEsciDoc("UserAccount.retrieveUserAccounts",
            METHOD_RETRIEVE_USER_ACCOUNTS, Constants.HTTP_METHOD_GET,
            Constants.USER_ACCOUNTS_BASE_URI,
            new String[] {}, filter);
    }
     ...
     */
    @Override
    public Object update(final String id, final Object userXml)
        throws Exception {

        return callEsciDoc("UserAccount.update", METHOD_UPDATE,
            Constants.HTTP_METHOD_PUT, Constants.USER_ACCOUNT_BASE_URI,
            new String[] { id }, changeToString(userXml));
    }
     ...
     *             If the service call fails.
     */
    public Object updatePassword(final String id, final Object taskParamXml)
        throws Exception {

        return callEsciDoc("UserAccount.updatePassword",
            METHOD_UPDATE_PASSWORD, Constants.HTTP_METHOD_POST,
            Constants.USER_ACCOUNT_BASE_URI, new String[] { id,
                "update-password" }, changeToString(taskParamXml));
    }
    ...
    public Object activate(final String id, final String taskParamXml)
        ...
        return callEsciDoc("UserAccount.activate", METHOD_ACTIVATE,
    ...
    public Object deactivate(final String id, final String taskParamXml)
        ...
        return callEsciDoc("UserAccount.deactivate", METHOD_DEACTIVATE,
            Constants.HTTP_METHOD_POST, Constants.USER_ACCOUNT_BASE_URI,
    ...
    public Object retrieveCurrentGrants(final String id) throws Exception {
        ...
        return callEsciDoc("UserAccount.retrieveCurrentGrants",
    ...
    public Object createGrant(final String id, final String grantXml)
        ...
        return callEsciDoc("UserAccount.createGrant", METHOD_CREATE_GRANT,
            Constants.HTTP_METHOD_PUT, Constants.USER_ACCOUNT_BASE_URI,
    ...
    public Object retrieveGrant(final String id, final String grantId)
        ...
        return callEsciDoc("UserAccount.retrieveGrant", METHOD_RETRIEVE_GRANT,
            Constants.HTTP_METHOD_GET, Constants.USER_ACCOUNT_BASE_URI,
    ...
    public Object revokeGrant(
        ...
        String[] pathElements =
            new String[] { id, "resources/grants/grant", grantId,
                "revoke-grant" };
        return callEsciDoc("UserAccount.revokeGrant", METHOD_REVOKE_GRANT,
            Constants.HTTP_METHOD_POST, Constants.USER_ACCOUNT_BASE_URI,
     ...
     */
    @Override
    public Object revokeGrants(final String id, final String filterXml)
        throws Exception {
     ...
     * 
     * @param filter
     *            The filter-criteria in a CQL query.
     * @return The HttpMethod after the service call (REST) or the result object
     *         (SOAP).
     * @throws Exception
     *             If the service call fails.
     ...
     *            The password.
     * @param check
     *            Indicates if the login was successful (handle != null,
     *            response-status == 200)
    ...
    public String login(
        ...
        if (check) {
            ...
            assertTrue("No authorization handle returned as parameter of"
                ...
                Constants.PARAM_UM_AUTHORIZATION) != -1));
    ...
    public UserAccountHandler getSoapClient() throws ServiceException {
        ...
        if (soapClient == null) {
            ...
            serviceLocator
                .setUserAccountHandlerServiceEndpointAddress(checkSoapAddress(serviceLocator
    ...
    public Object retrievePreferences(final String id) throws Exception {
        ...
        return callEsciDoc("UserAccount.retrievePreferences",
            METHOD_RETRIEVE_PREFERENCES, Constants.HTTP_METHOD_GET,
            Constants.USER_ACCOUNT_BASE_URI, new String[] { id,
     ...
     *             If the service call fails.
     */
    public Object retrievePreference(final String id, final String name)
        throws Exception {

        return callEsciDoc("UserAccount.retrievePreference",
            METHOD_RETRIEVE_PREFERENCE, Constants.HTTP_METHOD_GET,
            Constants.USER_ACCOUNT_BASE_URI, new String[] { id,
     ...
     *             If the service call fails.
     */
    public Object createPreference(final String id, final String xml)
        throws Exception {

        return callEsciDoc("UserAccount.createPreference",
            METHOD_CREATE_PREFERENCE, Constants.HTTP_METHOD_PUT,
            Constants.USER_ACCOUNT_BASE_URI, new String[] { id,
     ...
     *             If the service call fails.
     */
    public Object deletePreference(final String id, final String name)
        throws Exception {

        return callEsciDoc("UserAccount.createPreference",
            METHOD_DELETE_PREFERENCE, Constants.HTTP_METHOD_DELETE,
            Constants.USER_ACCOUNT_BASE_URI, new String[] { id,
                "resources/preferences/preference", name });
    }
     ...
     *             If the service call fails.
     */
    public Object updatePreferences(final String id, final String xml)
        throws Exception {

        return callEsciDoc("UserAccount.updatePreferences",
            METHOD_UPDATE_PREFERENCES, Constants.HTTP_METHOD_PUT,
            Constants.USER_ACCOUNT_BASE_URI, new String[] { id,
     ...
     *             If the service call fails.
     */
    public Object updatePreference(
        final String id, final String name, final String xml) throws Exception {

        return callEsciDoc("UserAccount.updatePreference",
            METHOD_UPDATE_PREFERENCE, Constants.HTTP_METHOD_PUT,
            Constants.USER_ACCOUNT_BASE_URI, new String[] { id,
     ...
     *             If the service call fails.
     */
    public Object createAttribute(final String userId, final String xml)
        throws Exception {

        return callEsciDoc("UserAccount.createAttribute",
            METHOD_CREATE_ATTRIBUTE, Constants.HTTP_METHOD_PUT,
            Constants.USER_ACCOUNT_BASE_URI, new String[] { userId,
    ...
    public Object retrieveAttributes(final String userId) throws Exception {
        ...
        return callEsciDoc("UserAccount.retrieveAttributes",
            METHOD_RETRIEVE_ATTRIBUTES, Constants.HTTP_METHOD_GET,
            Constants.USER_ACCOUNT_BASE_URI, new String[] { userId,
     ...
     *             If the service call fails.
     */
    public Object retrieveNamedAttributes(
            final String userId, final String name) throws Exception {

        return callEsciDoc("UserAccount.retrieveNamedAttributes",
            METHOD_RETRIEVE_NAMED_ATTRIBUTES, Constants.HTTP_METHOD_GET,
            Constants.USER_ACCOUNT_BASE_URI, new String[] { userId,
     ...
     *             If the service call fails.
     */
    public Object retrieveAttribute(
            final String userId, final String attributeId) throws Exception {

        return callEsciDoc("UserAccount.retrieveAttribute",
            METHOD_RETRIEVE_ATTRIBUTE, Constants.HTTP_METHOD_GET,
            Constants.USER_ACCOUNT_BASE_URI, new String[] { userId,
    ...
    public Object updateAttribute(
        ...
        return callEsciDoc("UserAccount.updateAttribute",
            METHOD_UPDATE_ATTRIBUTE, Constants.HTTP_METHOD_PUT,
            Constants.USER_ACCOUNT_BASE_URI, new String[] { userId,
                "resources/attributes/attribute", attributeId }, 
                changeToString(xml));
    }
     ...
     *             If the service call fails.
     */
    public Object deleteAttribute(
        final String userId, final String attributeId)
        throws Exception {

        return callEsciDoc("UserAccount.deleteAttribute",
            METHOD_DELETE_ATTRIBUTE, Constants.HTTP_METHOD_DELETE,
            Constants.USER_ACCOUNT_BASE_URI, new String[] { userId,
                "resources/attributes/attribute", attributeId });
    }
