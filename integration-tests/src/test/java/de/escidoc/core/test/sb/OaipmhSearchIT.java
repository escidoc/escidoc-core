 ...
 */
public class OaipmhSearchIT extends SearchTestBase {

    private static final Logger LOGGER = LoggerFactory.getLogger(OaipmhSearchIT.class);
    ...
    public void testSBOAIPMHSR1() throws Exception {
        ...
        HashMap<String, String> parameters = new HashMap<String, String>();
        parameters.put(FILTER_PARAMETER_QUERY, "escidoc.md-record-identifier=" + "\"escidoc@"
