...
public class ResourceBase {
    ...
    public static final Pattern PATTERN_OBJID_HREF_ATTRIBUTE =
    ...
    public String getObjidValue(final Node node, final String xPath)
        ...
        if (selected == null) {
            throw new Exception(
                "No Element selected to retrieve the object id from");
        }
        NamedNodeMap attributes = selected.getAttributes();
        if (attributes == null) {
            throw new Exception(
                "Selected node has no attributes (not an element?) ");
        }
        ...
        if (objidAttr != null) {
            ...
            if (objidAttr == null) {
                throw new Exception(
                    "Selected node neither has an objid attribute nor an xlink href attribute");
            }
     ...
     *             If anything fails.
     */
    public static void assertXmlExists(final Node node, final String xPath)
        throws Exception {
    ...
    public String getTheLastModificationParam(
        final String comment, final String lastModificationDate)
        throws Exception {
