...
import de.escidoc.core.test.aa.OrgUnitAdminTest;
...
public class OrgUnitAdminRestTest extends OrgUnitAdminTest {
     ...
     *             If anything fails.
     */
    public OrgUnitAdminRestTest(final int handlerCode,
