...
public class UserAccountInspectorTest extends GrantTestBase {
     ...
     */
    public UserAccountInspectorTest(final int handlerCode, final String userOrGroupId) throws Exception {
        super(handlerCode);
