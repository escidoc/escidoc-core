...
public class OrganizationalUnitClient extends ClientBase {
     ...
     * 
     * @param ouXml
     *            The xml representation of an organizational unit
    ...
    public Object create(final Object ouXml) throws Exception {
        ...
        return callEsciDoc("OrganizationalUnit.create", METHOD_CREATE,
            Constants.HTTP_METHOD_PUT, Constants.ORGANIZATIONAL_UNIT_BASE_URI,
            new String[] {}, changeToString(ouXml));
    }
    ...
    public Object delete(final String id) throws Exception {
        ...
        return callEsciDoc("OrganizationalUnit.delete", METHOD_DELETE,
    ...
    public Object update(final String id, final Object ouXml) throws Exception {
        ...
        return callEsciDoc("OrganizationalUnit.update", METHOD_UPDATE,
            Constants.HTTP_METHOD_PUT, Constants.ORGANIZATIONAL_UNIT_BASE_URI,
            new String[] { id }, changeToString(ouXml));
    }
     ...
     *            the organizational unit id.
     * @param ouXml
     *            The xml representation of the sub resource
     *            organization-details of the organizational unit
     * @return The HttpMethod after the service call (REST) or the result object
     *         (SOAP).
     * @throws Exception
     *             If the service call fails.
     */
    public Object updateMdRecords(final String id, final Object ouXml)
        throws Exception {

        return callEsciDoc("OrganizationalUnit.updateMdRecords",
     ...
     *            the organizational unit id.
     * @param ouXml
     *            The xml representation of the sub resource parent-ous of the
     *            organizational unit
     * @return The HttpMethod after the service call (REST) or the result object
     *         (SOAP).
     * @throws Exception
     *             If the service call fails.
     */
    public Object updateParents(final String id, final Object ouXml)
        throws Exception {

        return callEsciDoc("OrganizationalUnit.updateParents",
            METHOD_UPDATE_PARENTS, Constants.HTTP_METHOD_PUT,
            Constants.ORGANIZATIONAL_UNIT_BASE_URI, new String[] { id,
    ...
    public Object retrieve(final String id) throws Exception {
        ...
        return callEsciDoc("OrganizationalUnit.retrieve", METHOD_RETRIEVE,
            Constants.HTTP_METHOD_GET, Constants.ORGANIZATIONAL_UNIT_BASE_URI,
            new String[] { id });
    }
    ...
    public Object retrieveResources(final String id) throws Exception {
        ...
        return callEsciDoc("OrganizationalUnit.retrieveResources",
    ...
    public Object retrieveProperties(final String id) throws Exception {
        ...
        return callEsciDoc("OrganizationalUnit.retrieveProperties",
    ...
    public Object retrieveMdRecords(final String id) throws Exception {
        ...
        return callEsciDoc("OrganizationalUnit.retrieveMdRecords",
    ...
    public Object retrieveParents(final String id) throws Exception {
        ...
        return callEsciDoc("OrganizationalUnit.retrieveParentOus",
    ...
    public Object retrieveChildObjects(final String id) throws Exception {
        ...
        return callEsciDoc("OrganizationalUnit.retrieveChildObjects",
            METHOD_RETRIEVE_CHILD_OBJECTS, Constants.HTTP_METHOD_GET,
            Constants.ORGANIZATIONAL_UNIT_BASE_URI, new String[] { id,
    ...
    public Object retrieveParentObjects(final String id) throws Exception {
        ...
        return callEsciDoc("OrganizationalUnit.retrieveParentObjectss",
            METHOD_RETRIEVE_PARENT_OBJECTS, Constants.HTTP_METHOD_GET,
            Constants.ORGANIZATIONAL_UNIT_BASE_URI, new String[] { id,
     ...
     * 
     * @param id
     *            The id of the organizational unit to close.
     * @param taskParam
     *            The task parameter containing the last modification date of
     *            the organizational unit and an comment.
     * @return The HttpMethod after the service call (REST) or the result object
     *         (SOAP).
     * @throws Exception
     *             If the service call fails.
     */
    public Object close(final String id, final String taskParam)
        throws Exception {

        return callEsciDoc("OrganizationalUnit.cloae", METHOD_CLOSE,
            Constants.HTTP_METHOD_POST, Constants.ORGANIZATIONAL_UNIT_BASE_URI,
     ...
     * 
     * @param id
     *            The id of the organizational unit to open.
     * @param taskParam
     *            The task parameter containing the last modification date of
     *            the organizational unit and an comment.
     * @return The HttpMethod after the service call (REST) or the result object
     ...
     *             If the service call fails.
     */
    public Object open(final String id, final String taskParam)
        throws Exception {

        return callEsciDoc("OrganizationalUnit.open", METHOD_OPEN,
            Constants.HTTP_METHOD_POST, Constants.ORGANIZATIONAL_UNIT_BASE_URI,
            new String[] { id, Constants.SUB_OPEN }, taskParam);
    }

    /**
     * Retrieve a pathlist of references from a specified organizational units
     * to the toplevel ous.
     * 
     * @param id
     *            The Organizational Unit id.
    ...
    public Object retrievePathList(final String id) throws Exception {
        ...
        return callEsciDoc("OrganizationalUnit.retrievePathList",
            METHOD_RETRIEVE_ORGANIZATIONAL_UNIT_PATH_LIST,
            Constants.HTTP_METHOD_GET, Constants.ORGANIZATIONAL_UNIT_BASE_URI,
    ...
    public Object retrieveSuccessors(final String objid) throws Exception {
        ...
        return callEsciDoc("OrganizationalUnit.retrieveSuccessors",
            METHOD_RETRIEVE_ORGANIZATIONAL_UNIT_SUCCESSORS,
            Constants.HTTP_METHOD_GET, Constants.ORGANIZATIONAL_UNIT_BASE_URI,
