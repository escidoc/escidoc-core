...
public class ItemComponentUpdateIT extends ItemTestBase {
    ...
    public void testUpdateComponentContentWithoutMimeType() throws Exception {
        ...
        Document xmlData =
            EscidocAbstractTest.getTemplateAsDocument(TEMPLATE_ITEM_PATH + "/rest", "escidoc_item_create_content_with_mimetype.xml");
        ...
        componentXml = updateComponent(itemId, componentId, toString(newComponent, false));
        assertXmlEquals("mime-type not as expected", componentXml, componentContentMimeTypeXPath, "application/octet-stream");
    ...
    public void testUpdateComponentContentWithMimeType() throws Exception {
        ...
        Document newComponent = (Document) substitute(componentDoc, componentContentMimeTypeXPath, "application/pdf");
        componentXml = updateComponent(itemId, componentId, toString(newComponent, false));
        assertXmlEquals("mime-type not as expected", componentXml, componentContentMimeTypeXPath, "application/pdf");
        retrieveContentHeader(itemId, componentId, "");
    }
    ...
    public void testUpdateItemComponentContentWithoutMimeType() throws Exception {
        ...
        itemXml = update(itemId, toString(newItem, false));
        assertXmlEquals("mime-type not as expected", itemXml, itemContentMimeTypeXPath, "application/octet-stream");
        retrieveContentHeader(itemId, componentId, "");
    }
    ...
    public void testUpdateItemComponentContentWithMimeType() throws Exception {
        ...
        Document newItem = (Document) substitute(itemDoc, itemContentMimeTypeXPath, "application/pdf");
        itemXml = update(itemId, toString(newItem, false));
        assertXmlEquals("mime-type not as expected", itemXml, itemContentMimeTypeXPath, "application/pdf");
        retrieveContentHeader(itemId, componentId, "");
    }
