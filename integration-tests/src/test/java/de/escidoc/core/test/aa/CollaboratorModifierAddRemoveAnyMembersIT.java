...
public class CollaboratorModifierAddRemoveAnyMembersIT extends GrantTestBase {
     ...
     */
    public CollaboratorModifierAddRemoveAnyMembersIT(final int handlerCode, final String userOrGroupId)
        throws Exception {
        super(handlerCode);
