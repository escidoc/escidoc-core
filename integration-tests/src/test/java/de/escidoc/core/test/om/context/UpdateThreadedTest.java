...
public class UpdateThreadedTest extends ContextTestBase {
     ...
     */
    public UpdateThreadedTest(final int transport) {
        super(transport);
    }
    ...
    public void setUp() throws Exception {
        ...
        if (contextId == null || contextId1 == null) {
            ...
            Document context1 = EscidocRestSoapTestBase.getTemplateAsDocument(this.path, "context_create.xml");
            ...
            Document created1 = EscidocRestSoapTestBase.getDocument(contextXml1);
    ...
    public void testContextUpdateThreaded() throws Exception {
        ...
        ContextThreadRunnable runnable = new ContextThreadRunnable(getTransport(), parameters);
        ts[0] = new Thread(runnable);
        ts[0].start();

        ContextThreadRunnable runnable1 = new ContextThreadRunnable(getTransport(), parameters1);
