...
public class ContextClient extends ClientBase
    ...
    public Object retrieveMembers(
        ...
        return callEsciDoc(
            "Context.retrieveMembers",
            METHOD_RETRIEVE_MEMBERS,
    ...
    /**
     * Retrieve the xml representation of all virtual resources of the context
    ...
    public Object retrieveResources(final String id) throws Exception {
        ...
        return callEsciDoc("Context.retrieveResources",
    ...
    public Object retrieveAdminDescriptors(final String id) throws Exception {
        ...
        return callEsciDoc("Context.retrieveAdminDescriptors",
            METHOD_RETRIEVE_ADMIN_DESCRIPTORS, Constants.HTTP_METHOD_GET,
            Constants.CONTEXT_BASE_URI, new String[] { id,
     ...
     *             If the service call fails.
     */
    public Object retrieveAdminDescriptor(
        final String id, final String admDescriptorId) throws Exception {

        return callEsciDoc("Context.retrieveAdminDescriptor",
            METHOD_RETRIEVE_ADMINDESCRIPTOR, Constants.HTTP_METHOD_GET,
            Constants.CONTEXT_BASE_URI, new String[] { id,
    ...
    public Object open(final String id, final String taskParam)
        ...
        return callEsciDoc("Context.retrieveMembers", METHOD_OPEN,
            Constants.HTTP_METHOD_POST, Constants.CONTEXT_BASE_URI,
            new String[] { id, Constants.SUB_CONTEXT_OPEN }, taskParam);
    }
    ...
    public Object close(final String id, final String taskParam)
        ...
        return callEsciDoc("Context.retrieveMembers", METHOD_CLOSE,
            Constants.HTTP_METHOD_POST, Constants.CONTEXT_BASE_URI,
    ...
    public Object retrieve(final String id) throws Exception {
        ...
        return callEsciDoc("Context.retrieve", METHOD_RETRIEVE,
            Constants.HTTP_METHOD_GET, Constants.CONTEXT_BASE_URI,
            new String[] { id });
    }
    ...
    public Object retrieveProperties(final String id) throws Exception {
        ...
        return callEsciDoc("Context.retrieveProperties",
    ...
    public Object create(final Object contextXml) throws Exception {
        ...
        return callEsciDoc("Context.create", METHOD_CREATE,
            Constants.HTTP_METHOD_PUT, Constants.CONTEXT_BASE_URI,
     ...
     */
    @Override
    public Object update(final String id, final Object contextXml)
        throws Exception {

        return callEsciDoc("Context.update", METHOD_UPDATE,
            Constants.HTTP_METHOD_PUT, Constants.CONTEXT_BASE_URI,
    ...
    public Object delete(final String id) throws Exception {
        ...
        return callEsciDoc("Context.delete", METHOD_DELETE,
            Constants.HTTP_METHOD_DELETE, Constants.CONTEXT_BASE_URI,
            new String[] { id });
    }
