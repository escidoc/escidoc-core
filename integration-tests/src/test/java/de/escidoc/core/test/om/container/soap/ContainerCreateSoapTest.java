...
public class ContainerCreateSoapTest extends ContainerTestBase {
    ...
    public void testOM_CCO_1_1() throws Exception {
        ...
        Node creatorId =
            selectSingleNode(document,
                "/container/properties/created-by/@objid");
    ...
    public void testOM_CCO_2_3() throws Exception {
        ...
        // String containerWithoutAdminDescriptorXml =
        // toString(containerWithoutAdminDescriptor, false);
        Node containerWithMissingContextObjid =
            deleteAttribute(container, "/container/properties/context", "objid");
        String containerWithMissingContextObjidXml =
            toString(containerWithMissingContextObjid, false);
    ...
    /**
     * Test declining creating container (input parameter container xml is
     * missing).
     * 
     * @test.status Implemented
     * 
    ...
    public void testCreateContainerWith2Mdrecords() throws Exception {
        ...
        // toString(containerWithoutAdminDescriptor, false);
        String container =
            getContainerTemplate("create_container_2_Md_Records_WithoutMembers_v1.1.xml");
        assertXmlValidContainer(container);
