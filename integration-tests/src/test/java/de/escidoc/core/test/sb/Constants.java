...
public final class Constants {
    ...
    public static final int ITEM_CONTAINER_ADMIN_INDEX_FIELD_COUNT = 181;

    public static final int ITEM_CONTAINER_ADMIN_SORT_FIELD_COUNT = 177;

    public static final int CONTENT_MODEL_ADMIN_INDEX_FIELD_COUNT = 24;

    public static final int CONTENT_MODEL_ADMIN_SORT_FIELD_COUNT = 23;

    public static final int CONTENT_RELATION_ADMIN_INDEX_FIELD_COUNT = 17;

    public static final int CONTENT_RELATION_ADMIN_SORT_FIELD_COUNT = 15;

    public static final int CONTEXT_ADMIN_INDEX_FIELD_COUNT = 21;

    public static final int CONTEXT_ADMIN_SORT_FIELD_COUNT = 20;

    public static final int OU_ADMIN_INDEX_FIELD_COUNT = 95;

    public static final int OU_ADMIN_SORT_FIELD_COUNT = 93;
    ...
    public static final HashMap<String, HashMap<String, String>> ITEM_INDEX_USERDEFINED_SEARCHES =
        new HashMap<String, HashMap<String, String>>() {
...

            {
                ...
                put("most-recent-date", new HashMap<String, String>() {
                    ...
                    {
                        put("searchString", "escidoc.most-recent-date=1980-01-27*");
                        put("expectedHits", "3");
                    }
                });
                put("most-recent-date.status", new HashMap<String, String>() {
                    ...
                    {
                        put("searchString", "escidoc.most-recent-date.status=escidoc.created");
                        put("expectedHits", "2");
                    }
                });
                put("most-recent-date.status1", new HashMap<String, String>() {
                    ...
                    {
                        put("searchString", "escidoc.most-recent-date.status=escidoc.modified");
                        put("expectedHits", "2");
                    }
                });
                put("most-recent-date.status2", new HashMap<String, String>() {
                    ...
                    {
                        put("searchString", "escidoc.most-recent-date.status=" + "escidoc.dateSubmitted");
                        put("expectedHits", "2");
                    }
                });
                put("most-recent-date.status3", new HashMap<String, String>() {
                    ...
                    {
                        put("searchString", "escidoc.most-recent-date.status=" + "escidoc.dateAccepted");
                        put("expectedHits", "2");
                    }
                });
                put("most-recent-date.status4", new HashMap<String, String>() {
                    ...
                    {
                        put("searchString", "escidoc.most-recent-date.status=escidoc.issued");
                        put("expectedHits", "1");
                    }
                });
                put("most-recent-date.status5", new HashMap<String, String>() {
                    ...
                    {
                        put("searchString", "escidoc.most-recent-date.status=" + "escidoc.published-online");
                        put("expectedHits", "1");
                    }
                });
                put("context.name", new HashMap<String, String>() {
                    ...
                    {
                        put("searchString", "escidoc.context.name=\"Test Collection\"");
                        put("expectedHits", "10");
                    }
                });
                put("content-model.name", new HashMap<String, String>() {
                    ...
                    {
                        put("searchString", "escidoc.content-model.name=\"Persistent Content Model\"");
                        put("expectedHits", "10");
                    }
                });
                put("created-by.name", new HashMap<String, String>() {
                    ...
                    {
                        put("searchString", "escidoc.created-by.name=" + "\"Test System Administrator User\"");
                        put("expectedHits", "10");
                    }
                });
                put("component.created-by.name", new HashMap<String, String>() {
                    ...
                    {
                        put("searchString", "escidoc.component.created-by.name=" + "\"Test System Administrator User\"");
                        put("expectedHits", "10");
                    }
                });
                ...
                put("any-organization-pids", new HashMap<String, String>() {
                    ...
                    {
                        put("searchString", "escidoc.any-organization-pids=escidoc:persistent25");
                        put("expectedHits", "10");
                    }
                });
                put("any-organization-pids1", new HashMap<String, String>() {
                    ...
                    {
                        put("searchString", "escidoc.any-organization-pids=escidoc:persistent29");
                        put("expectedHits", "10");
                    }
                });
                ...
                put("any-identifier1", new HashMap<String, String>() {
                    ...
                    {
                        put("searchString", "escidoc.any-identifier=" + "\"hdl:somehandle/test/${ITEM_ID}\"");
                        put("expectedHits", "1");
                    }
                });
                ...
                put("nichtindexiert7", new HashMap<String, String>() {
                    ...
                    {
                        put("searchString", "escidoc.any-organizations=nichtindexiert");
                        put("expectedHits", "0");
                    }
                });
    ...
    public static final HashMap<String, HashMap<String, String>> CONTAINER_INDEX_USERDEFINED_SEARCHES =
        new HashMap<String, HashMap<String, String>>() {
            private static final long serialVersionUID = 1L;

            {
                ...
                put("any-organization-pids", new HashMap<String, String>() {
                    ...
                    {
                        put("searchString", "escidoc.any-organization-pids=escidoc:persistent13");
                        put("expectedHits", "1");
                    }
                });
                put("any-dates", new HashMap<String, String>() {
    ...
    public static final HashMap<String, HashMap<String, String>> ORG_UNIT_INDEX_USERDEFINED_SEARCHES =
        new HashMap<String, HashMap<String, String>>() {
            private static final long serialVersionUID = 1L;

            {
                ...
                put("ancestor-organization-pid", new HashMap<String, String>() {
                    ...
                    {
                        put("searchString", "escidoc.ancestor-organization-pid=${ORGUNIT1}");
                        put("expectedHits", "4");
                    }
                });
                put("ancestor-organization-pid1", new HashMap<String, String>() {
                    ...
                    {
                        put("searchString", "escidoc.ancestor-organization-pid=${ORGUNIT0}");
                        put("expectedHits", "7");
                    }
                });
    ...
    public static final HashMap<String, HashMap<String, String>> OAIPMH_ITEM_INDEX_USERDEFINED_SEARCHES =
        new HashMap<String, HashMap<String, String>>() {
            private static final long serialVersionUID = 1L;

            {
                ...
                put("family-name", new HashMap<String, String>() {
                    ...
                    {
                        put("searchString", "escidoc.publication.creator.person" + ".family-name=Gollmer");
                        put("expectedHits", "1");
                    }
                });
                put("family-name1", new HashMap<String, String>() {
                    ...
                    {
                        put("searchString", "escidoc.publication.creator.person" + ".family-name=Gollmer1");
                        put("expectedHits", "0");
                    }
                });
            }
    ...
    public static final HashMap<String, HashMap<String, String>> OAIPMH_CONTAINER_INDEX_USERDEFINED_SEARCHES =
        new HashMap<String, HashMap<String, String>>() {
            private static final long serialVersionUID = 1L;

            {
                ...
                put("family-name", new HashMap<String, String>() {
                    ...
                    {
                        put("searchString", "escidoc.collection.creator.person.family-name=Hoppe");
                        put("expectedHits", "1");
                    }
                });
                put("family-name1", new HashMap<String, String>() {
                    ...
                    {
                        put("searchString", "escidoc.collection.creator.person" + ".family-name=Hoppe1");
                        put("expectedHits", "0");
                    }
                });
            }
    ...
    public static final HashMap<String, HashMap<String, String>> ITEM_INDEX_PROPERTIES_SEARCHES =
        new HashMap<String, HashMap<String, String>>() {
            private static final long serialVersionUID = 1L;

            {
                ...
                put("public-status-comment", new HashMap<String, String>() {
                    ...
                    {
                        put("searchString", "escidoc.public-status-comment=released");
                        put("expectedHits", "10");
                    }
                });
                put("content-model-specific.element1", new HashMap<String, String>() {
                    private static final long serialVersionUID = 1L;

                    {
                        put("searchString", "escidoc.content-model-specific.element1=" + "cms-test1");
                        put("expectedHits", "10");
                    }
                });
            }
    ...
    public static final HashMap<String, HashMap<String, String>> CONTAINER_INDEX_PROPERTIES_SEARCHES =
        new HashMap<String, HashMap<String, String>>() {
            private static final long serialVersionUID = 1L;

            {
                ...
                put("public-status-comment", new HashMap<String, String>() {
                    ...
                    {
                        put("searchString", "escidoc.public-status-comment=containerhandler*");
                        put("expectedHits", "1");
                    }
                });
                put("content-model-specific.element1", new HashMap<String, String>() {
    ...
    public static final HashMap<String, HashMap<String, String>> ORG_UNIT_INDEX_PROPERTIES_SEARCHES =
        new HashMap<String, HashMap<String, String>>() {
            private static final long serialVersionUID = 1L;
    ...
    public static final HashMap<String, HashMap<String, String>> OAIPMH_ITEM_INDEX_PROPERTIES_SEARCHES =
        new HashMap<String, HashMap<String, String>>() {
            private static final long serialVersionUID = 1L;
    ...
    public static final HashMap<String, HashMap<String, String>> OAIPMH_CONTAINER_INDEX_PROPERTIES_SEARCHES =
        new HashMap<String, HashMap<String, String>>() {
            private static final long serialVersionUID = 1L;
    ...
    public static final HashMap<String, HashMap<String, String>> OAIPMH_ITEM_INDEX_METADATA_SEARCHES =
        new HashMap<String, HashMap<String, String>>() {
            private static final long serialVersionUID = 1L;

            {
                put("creator.role", new HashMap<String, String>() {
                    ...
                    {
                        put("searchString", "escidoc.publication.creator.role=author");
                        put("expectedHits", "2");
                    }
                });
            }
    ...
    public static final HashMap<String, HashMap<String, String>> OAIPMH_CONTAINER_INDEX_METADATA_SEARCHES =
        new HashMap<String, HashMap<String, String>>() {
            private static final long serialVersionUID = 1L;

            {
                put("creator.role", new HashMap<String, String>() {
                    ...
                    {
                        put("searchString", "escidoc.collection.creator.role=author");
                        put("expectedHits", "1");
                    }
                });
            }
    ...
    public static final HashMap<String, HashMap<String, String>> ITEM_INDEX_COMPONENTS_SEARCHES =
        new HashMap<String, HashMap<String, String>>() {
            private static final long serialVersionUID = 1L;

            {
                ...
                put("nichtindexiert2", new HashMap<String, String>() {
                    ...
                    {
                        put("searchString", "escidoc.component.metadata=nichtindexiert");
                        put("expectedHits", "0");
                    }
                });
            }
    ...
    public static final HashMap<String, HashMap<String, String>> ITEM_INDEX_SPECIAL_CHAR_SEARCHES =
        new HashMap<String, HashMap<String, String>>() {
            private static final long serialVersionUID = 1L;

            {
                ...
                put("title36", new HashMap<String, String>() {
                    ...
                    {
                        put("searchString", "escidoc.alternative=\"alternativeappendix+\"");
                        put("expectedHits", "1");
                    }
                });
                ...
                put("title60", new HashMap<String, String>() {
                    ...
                    {
                        put("searchString", "escidoc.alternative=\"alternativeappendi\\x\"");
                        put("expectedHits", "7");
                    }
                });
