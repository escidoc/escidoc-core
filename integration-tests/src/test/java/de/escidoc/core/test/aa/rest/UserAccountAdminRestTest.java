...
import de.escidoc.core.test.aa.UserAccountAdminTest;
...
public class UserAccountAdminRestTest extends UserAccountAdminTest {
     ...
     *             If anything fails.
     */
    public UserAccountAdminRestTest(final int handlerCode,
