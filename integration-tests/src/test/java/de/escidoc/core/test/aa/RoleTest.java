...
public class RoleTest extends AaTestBase {
     ...
     */
    public RoleTest() throws Exception {
    ...
    public Document assertXmlValidRetrievedRole(
        ...
        // name
        assertXmlExists(msg + "Missing name", toBeAssertedDocument, RoleTest.XPATH_ROLE_NAME);
        ...
        final boolean toBeAssertedUnlimitedValue =
            Boolean.parseBoolean(getAttributeValue(toBeAssertedDocument, RoleTest.XPATH_ROLE_SCOPE,
                RoleTest.NAME_UNLIMITED));
