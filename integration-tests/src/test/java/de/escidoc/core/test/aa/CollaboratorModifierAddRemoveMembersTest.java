 ...
 * 
 */
public class CollaboratorModifierAddRemoveMembersTest extends GrantTestBase {
     ...
     *             If anything fails.
     */
    public CollaboratorModifierAddRemoveMembersTest(
            final int transport, 
    ...
    /**
     * Test CollaboratorModifierAddRemoveMembers 
     ...
     */
    @Test
    public void testAddContainerToContainerWithParentContainerScopeDecline() 
                                                        throws Exception {
        doTestAddMemberWithRole(
            grantCreationUserOrGroupId, 
            ROLE_HREF_COLLABORATOR_MODIFIER_ADD_REMOVE_MEMBERS, 
