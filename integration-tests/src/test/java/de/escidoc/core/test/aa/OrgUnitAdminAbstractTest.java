...
/**
 * Test suite for the role ou-administrator.
 * ou-administrator may
 * -create, retrieve, delete, update, open, close 
 *  organizational-units, if parent is in scope.
 *   
 * -grant Organizational Unit Administrator privileges 
 *  for organizational-units in scope.
 * 
...
public class OrgUnitAdminAbstractTest extends GrantTestBase {
    ...
    public void prepare() throws Exception {
        ...
        String ouXml = prepareOrgUnit(
                PWCallback.DEFAULT_HANDLE, STATUS_OPEN, null);
        topLevelOrgUnit = getObjidValue(ouXml);
        
        //create top-level org unit 2
        ouXml = prepareOrgUnit(
                PWCallback.DEFAULT_HANDLE, STATUS_NEW, null);
        topLevelOrgUnit2 = getObjidValue(ouXml);
        
        //create middle level org units
        middleLevelOrgUnits = new String[2];
        ouXml = prepareOrgUnit(
                PWCallback.DEFAULT_HANDLE, STATUS_NEW, 
                        new String[] { topLevelOrgUnit });
        middleLevelOrgUnits[0] = getObjidValue(ouXml);
        ouXml = prepareOrgUnit(
                PWCallback.DEFAULT_HANDLE, STATUS_OPEN, 
                        new String[] { topLevelOrgUnit });
    ...
    public void testCreateOrgUnit() throws Exception {
        String ouXml = orgUnitHelper.doTestCreate(
                HANDLE, new String[] { lowLevelOrgUnit }, null);
    ...
    public void testCreateOrgUnit1() throws Exception {
        String ouXml = orgUnitHelper.doTestCreate(
                HANDLE, new String[] { middleLevelOrgUnits[0] }, null);
    ...
    public void testCreateOrgUnit2() throws Exception {
        String ouXml = orgUnitHelper.doTestCreate(
                HANDLE, middleLevelOrgUnits, null);
        orgUnitHelper.doTestDelete(HANDLE, getObjidValue(ouXml), null);
    }
    ...
    public void testCreateOrgUnit3() throws Exception {
        String ouXml = orgUnitHelper.doTestCreate(
                HANDLE, new String[] { superLowLevelOrgUnit }, null);
        orgUnitHelper.doTestDelete(HANDLE, getObjidValue(ouXml), null);
    }
    ...
    public void testDecliningCreateOrgUnit() throws Exception {
        orgUnitHelper.doTestCreate(
                HANDLE, new String[] { middleLevelOrgUnits[1] }, 
    ...
    public void testDecliningCreateOrgUnit1() throws Exception {
        orgUnitHelper.doTestCreate(
                HANDLE, new String[] { topLevelOrgUnit },  
                AuthorizationException.class);
    }
    ...
    public void testRetrieveOrgUnit() throws Exception {
        orgUnitHelper.doTestRetrieve(
                HANDLE, lowLevelOrgUnit,  
                null);
    }
    ...
    public void testDeclineRetrieveOrgUnit() throws Exception {
        String ouXml = prepareOrgUnit(
                PWCallback.DEFAULT_HANDLE, STATUS_NEW, 
                        new String[] { topLevelOrgUnit });
        orgUnitHelper.doTestRetrieve(
                HANDLE, getObjidValue(ouXml),  
                AuthorizationException.class);
        orgUnitHelper.doTestDelete(
                PWCallback.DEFAULT_HANDLE, getObjidValue(ouXml), null);
    }
    ...
    public void testDeclineRetrieveOrgUnit1() throws Exception {
        String ouXml = prepareOrgUnit(
                PWCallback.DEFAULT_HANDLE, STATUS_NEW, 
                        new String[] { middleLevelOrgUnits[1] });
        orgUnitHelper.doTestRetrieve(
                HANDLE, getObjidValue(ouXml),  
                AuthorizationException.class);
        orgUnitHelper.doTestDelete(
    ...
    public void testUpdateOrgUnitParents() throws Exception {
        String ouXml = prepareOrgUnit(
                PWCallback.DEFAULT_HANDLE, STATUS_NEW, 
                new String[] { middleLevelOrgUnits[0] });
        orgUnitHelper.doTestUpdateWithChangedParents(
                HANDLE, getObjidValue(ouXml), 
                new String[] { superLowLevelOrgUnit },
                null);
        orgUnitHelper.doTestDelete(HANDLE, getObjidValue(ouXml), null);
    }
    ...
    public void testUpdateOrgUnitParents4() throws Exception {
        ...
        orgUnitHelper.doTestUpdateWithChangedParents(
                HANDLE, getObjidValue(ouXml), 
                new String[] { middleLevelOrgUnits[0], topLevelOrgUnit2 },
                null);
        orgUnitHelper.doTestDelete(HANDLE, getObjidValue(ouXml), null);
    }
    ...
    public void testUpdateOrgUnitParents5() throws Exception {
        ...
        orgUnitHelper.doTestUpdateWithChangedParents(
                HANDLE, getObjidValue(ouXml), 
                new String[] { superLowLevelOrgUnit, middleLevelOrgUnits[1] },
                null);
        orgUnitHelper.doTestDelete(HANDLE, getObjidValue(ouXml), null);
    }
    ...
    public void testDeclineUpdateOrgUnitParents3() throws Exception {
        ...
        orgUnitHelper.doTestUpdateWithChangedParents(
                HANDLE, getObjidValue(ouXml), 
                new String[] { topLevelOrgUnit, topLevelOrgUnit2 },
                AuthorizationException.class);
        orgUnitHelper.doTestDelete(
                PWCallback.DEFAULT_HANDLE, getObjidValue(ouXml), null);
    }
    ...
    public void testCreateUserAccountGrant() throws Exception {
        setClient((GrantClient) getClient(USER_ACCOUNT_HANDLER_CODE));
        String grantXml = doTestCreateGrant(HANDLE, TEST_USER_ACCOUNT_ID1, 
                Constants.ORGANIZATIONAL_UNIT_BASE_URI + "/" 
                + middleLevelOrgUnits[0], ROLE_HREF_OU_ADMINISTRATOR, null);
        doTestRevokeGrant(
                HANDLE, 
                TEST_USER_ACCOUNT_ID1, 
                getObjidValue(grantXml), null);
    }
    ...
    public void testRevokeUserAccountGrant() throws Exception {
        setClient((GrantClient) getClient(USER_ACCOUNT_HANDLER_CODE));
        String grantXml = doTestCreateGrant(PWCallback.DEFAULT_HANDLE, 
                TEST_USER_ACCOUNT_ID1, 
                Constants.ORGANIZATIONAL_UNIT_BASE_URI + "/" 
                + middleLevelOrgUnits[0], ROLE_HREF_OU_ADMINISTRATOR, null);
        doTestRevokeGrant(
    ...
    public void testDeclineCreateUserAccountGrant() throws Exception {
        ...
        doTestCreateGrant(HANDLE, TEST_USER_ACCOUNT_ID1, 
                Constants.ORGANIZATIONAL_UNIT_BASE_URI + "/" 
                + topLevelOrgUnit, ROLE_HREF_OU_ADMINISTRATOR, 
                AuthorizationException.class);
    }
    ...
    public void testDeclineCreateUserAccountGrant1() throws Exception {
        ...
        doTestCreateGrant(HANDLE, TEST_USER_ACCOUNT_ID1, 
                Constants.ORGANIZATIONAL_UNIT_BASE_URI + "/" 
                + middleLevelOrgUnits[1], ROLE_HREF_OU_ADMINISTRATOR, 
                AuthorizationException.class);
    }
    ...
    public void testDeclineCreateUserAccountGrant2() throws Exception {
        ...
        doTestCreateGrant(HANDLE, TEST_USER_ACCOUNT_ID1, 
                Constants.ORGANIZATIONAL_UNIT_BASE_URI + "/" 
                + topLevelOrgUnit2, ROLE_HREF_OU_ADMINISTRATOR, 
                AuthorizationException.class);
    }
    ...
    public void testDeclineRevokeUserAccountGrant() throws Exception {
        setClient((GrantClient) getClient(USER_ACCOUNT_HANDLER_CODE));
        String grantXml = 
            doTestCreateGrant(PWCallback.DEFAULT_HANDLE, TEST_USER_ACCOUNT_ID1, 
                Constants.ORGANIZATIONAL_UNIT_BASE_URI + "/" 
                + topLevelOrgUnit, ROLE_HREF_OU_ADMINISTRATOR, 
                null);
        doTestRevokeGrant(
                HANDLE, 
                TEST_USER_ACCOUNT_ID1, 
                getObjidValue(grantXml), AuthorizationException.class);
    }
    ...
    public void testCreateUserGroupGrant() throws Exception {
        setClient((GrantClient) getClient(USER_GROUP_HANDLER_CODE));
        String grantXml = doTestCreateGrant(HANDLE, TEST_USER_GROUP_ID, 
                Constants.ORGANIZATIONAL_UNIT_BASE_URI + "/" 
                + middleLevelOrgUnits[0], ROLE_HREF_OU_ADMINISTRATOR, null);
        doTestRevokeGrant(
                HANDLE, 
    ...
    public void testDeclineRevokeUserGroupGrant() throws Exception {
        setClient((GrantClient) getClient(USER_GROUP_HANDLER_CODE));
        String grantXml = 
            doTestCreateGrant(PWCallback.DEFAULT_HANDLE, TEST_USER_GROUP_ID, 
                Constants.ORGANIZATIONAL_UNIT_BASE_URI + "/" 
                + topLevelOrgUnit, ROLE_HREF_OU_ADMINISTRATOR, 
                null);
        doTestRevokeGrant(
