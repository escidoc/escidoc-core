...
public class ContentRelationModifierTest extends GrantTestBase {
     ...
     */
    public ContentRelationModifierTest(final int handlerCode, final String userOrGroupId) throws Exception {
        super(handlerCode);
