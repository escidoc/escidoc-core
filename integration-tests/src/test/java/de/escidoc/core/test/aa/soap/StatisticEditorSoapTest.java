...
import de.escidoc.core.test.aa.StatisticEditorTest;
...
public class StatisticEditorSoapTest extends StatisticEditorTest {
     ...
     *             If anything fails.
     */
    public StatisticEditorSoapTest(final int handlerCode,
