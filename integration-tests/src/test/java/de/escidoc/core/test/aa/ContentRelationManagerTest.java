...
public class ContentRelationManagerTest extends GrantTestBase {
     ...
     */
    public ContentRelationManagerTest(final int handlerCode, final String userOrGroupId) throws Exception {
        super(handlerCode);
