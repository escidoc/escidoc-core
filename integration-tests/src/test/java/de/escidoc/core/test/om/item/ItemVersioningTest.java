...
public class ItemVersioningTest extends ItemTestBase {
    ...
    public void testLifecycleCommentSpecialChars() throws Exception {
        ...
        assertEquals(comment, selectSingleNodeAsserted(getDocument(xml),
            "/*/properties/version/comment/text()").getNodeValue());
        assertEquals(comment, selectSingleNodeAsserted(
            getDocument(versionHistory),
            "/version-history/version[1]/comment/text()").getNodeValue());

        assignObjectPid(theItemId, getPidParam(theItemId,
            "http://localhost:8080/ir/item/" + theItemId));
        ...
        release(theItemId,
            getTheLastModificationParam(true, theItemId, comment));
        xml = retrieve(theItemId);
        versionHistory = retrieveVersionHistory(theItemId);
    ...
    public void testRetrieveVersionHistory() throws Exception {
        ...
        Node versionHistoryDoc =
            EscidocRestSoapTestsBase.getDocument(versionHistory);
        ...
        selectSingleNodeAsserted(versionHistoryDoc,
            "/version-history/version/events/event");

        // assert values of selected nodes --------------------------

        // check href of version element
        assertHrefBase(versionHistoryDoc, "/version-history/version/@href",
            Constants.ITEM_BASE_URI + "/" + theItemId + ":1");
        // check objid of version element
        assertHrefObjidConsistency((Document) versionHistoryDoc,
        ...
        assertEquals("eventIdentifierVaule " + " of Item [" + theItemId
            + "] differs from defined format", XPathAPI
            .selectSingleNode(
                (Document) versionHistoryDoc,
                "/version-history/version[version-number='1']"
                    + "/events/event[1]/eventIdentifier/eventIdentifierValue")
            .getTextContent(), "/ir/item/"
            + theItemId
            + "/resources/version-history#"
            + XPathAPI.selectSingleNode(
                (Document) versionHistoryDoc,
                "/version-history/version[version-number='1']"
                    + "/events/event[1]/@xmlID").getTextContent());
    ...
    public void testLifecycleVersions() throws Exception {
        ...
        assertXmlExists("New version number", itemDoc,
            "/item/properties/version/number[text() = '1']");
        assertXmlExists("Properties status pending", itemDoc,
            "/item/properties/public-status[text() = 'pending']");
        assertXmlExists("version status pending", itemDoc,
        ...
        // check timestamps
        assertXmlExists("Wrong timestamp in version-history root "
            + "element of Item '" + theItemId + "'", versionHistory,
            "/version-history[@last-modification-date = '" + lmdv1e1 + "']");

        assertEquals("last-modification-date in root attribute of Item ["
            + theItemId
            + "] differs from /version-history/version/events/event[1]/"
            + "eventDateTime", XPathAPI.selectSingleNode(itemDoc,
            "/item/@last-modification-date").getTextContent(), XPathAPI
            .selectSingleNode(versionHistoryDoc,
                "/version-history/version/events/event[1]/eventDateTime")
            .getTextContent());

        assertXmlExists(
            "Wrong timestamp in version element of version-history of Item '"
                + theItemId + "'", versionHistoryDoc,
            "/version-history/version[@timestamp='" + lmdv1e1
        ...
        // check href of version-history/version element
        assertHrefBase(versionHistoryDoc, "/version-history/version/@href",
            Constants.ITEM_BASE_URI + "/" + theItemId + ":2");
        // check objid of version-history/version element
        assertHrefObjidConsistency((Document) versionHistoryDoc,
            "/version-history/version");
        // check timestamps
        assertXmlExists("Wrong timestamp in version-history root element",
            versionHistory, "/version-history[@last-modification-date = '"
                + lmdv2e1 + "']");
        assertEquals(
            "last-modification-date in root attribute of Item ["
                + theItemId
                + "] differs from /version-history/version[version-number='2']/events/event[1]/"
                + "eventDateTime",
            XPathAPI.selectSingleNode(itemDocV2,
                "/item/@last-modification-date").getTextContent(),
            XPathAPI
                .selectSingleNode(versionHistoryDoc,
                    "/version-history/version[version-number='2']/events/event[1]/eventDateTime")
                .getTextContent());

        assertXmlExists(
            "Wrong timestamp in version element of version-history",
            versionHistoryDoc,
            "/version-history/version[version-number='2']/events/event[last()]/"
                + "eventDateTime[text() = '" + lmdv2e1 + "']");
        assertXmlExists(
            "Wrong timestamp in version 2 element of version-history",
            versionHistoryDoc, "/version-history/version[@timestamp='"
                + lmdv2e1 + "']/version-number[text() = '2']");

        // check version 1 again
        xml = retrieve(theItemId + ":1");
        itemDoc = EscidocRestSoapTestsBase.getDocument(xml);
        assertXmlExists("New version number", itemDoc,
            "/item/properties/version/number[text() = '1']");
        assertXmlExists("Properties status pending", itemDoc,
            "/item/properties/public-status[text() = 'pending']");
        ...
        assertXmlExists("New version number", xml,
            "/item/properties/version/number[text() = '2']");
        assertXmlExists("Properties status submitted", xml,
            "/item/properties/public-status[text() = 'submitted']");
        assertXmlExists("version status submitted", xml,
            "/item/properties/version/status[text() = 'submitted']");
        assertXmlValidItem(xml);
        ...
        // check href of version-history/version element
        assertHrefBase(versionHistoryDoc, "/version-history/version/@href",
            Constants.ITEM_BASE_URI + "/" + theItemId + ":3");
        // check objid of version-history/version element
        assertHrefObjidConsistency((Document) versionHistoryDoc,
            "/version-history/version");
        ...
        tsv.itemTripleStoreValues(getDocument(xml));
        assertXmlExists("New version number", xml,
            "/item/properties/version/number[text() = '4']");
        assertXmlExists("Properties status released", xml,
            "/item/properties/public-status[text() = 'released']");
        assertXmlExists("version status pending", xml,
            "/item/properties/version/status[text() = 'pending']");
        ...
        // check href of version-history/version element
        assertHrefBase(versionHistoryDoc, "/version-history/version/@href",
            Constants.ITEM_BASE_URI + "/" + theItemId + ":4");
        // check objid of version-history/version element
        assertHrefObjidConsistency((Document) versionHistoryDoc,
            "/version-history/version");
        ...
        xml = update(theItemId, xml);
        assertXmlExists("New version number", xml,
            "/item/properties/version/number[text() = '5']");
        assertXmlExists("Properties status released", xml,
            "/item/properties/public-status[text() = 'released']");
        assertXmlExists("version status submitted", xml,
            "/item/properties/version/status[text() = 'submitted']");
        ...
        // check href of version-history/version element
        assertHrefBase(versionHistoryDoc, "/version-history/version/@href",
            Constants.ITEM_BASE_URI + "/" + theItemId + ":5");
        // check objid of version-history/version element
        assertHrefObjidConsistency((Document) versionHistoryDoc,
            "/version-history/version");
        ...
        xml = retrieve(theItemId);
        tsv.itemTripleStoreValues(getDocument(xml));
        assertXmlExists("Properties status withdrawn", xml,
            "/item/properties/public-status[text() = 'withdrawn']");
        ...
        versionHistory = retrieveVersionHistory(theItemId);
        assertFalse("Timestamps not right replaced in version-history",
            versionHistory.contains("###"));
    }

    /**
     * TODO move this method to a better place in the class. Compare an Item
     * with a list of values which has to be there and which are forbidden.
     * 
     * @param xml
     *            The XML of an Item
     * @param expectedValues
     *            Expected values with &lt;XPath, Value&gt; structure. If value
     *            is null than is the existence of the element itself checked.
     *            An Exception is thrown if the element not exist. If value is
     *            not null the content of the element is compared. An Exception
     *            is thrown if the values not compare.
     * @param forbiddenValues
     *            Expected values with &lt;XPath, Value&gt; structure. If value
     *            is null than is the existence of the element itself checked.
     *            An Exception is thrown if the element exists. If value is not
     *            null the content of the element is compared. An Exception is
     *            thrown if the values compare.
     * @throws Exception
     *             Is thrown if a expected value not exists (with the right
     *             value) or a forbidden element (with the wrong value) exist.
     */
    private void validateResource(
        final String xml, final HashMap<String, String> expectedValues,
        final Vector<String> forbiddenValues) throws Exception {
        ...
        while (it.hasNext()) {
            ...
            if (n == null) {
                throw new Exception("Node '" + xPath
                    + "' not exists but it should. (Item "
                    + Select.getObjidValue(resource, getTransport()) + ")");
            }
            if (value != null) {
                String nodeValue = n.getTextContent();
                if (!value.equals(nodeValue)) {
                    throw new Exception("Value of node '" + xPath + "' is '"
                        + nodeValue + "' and differs from expected value '"
                        + value + "' (Item "
                        + Select.getObjidValue(resource, getTransport()) + ")");
                }
            }
    ...
    /**
     * This test extends more or less the lifecycle test by acting with
     * different roles.
     * 
     * @throws Exception
     *             Thrown if at least one value is wrong.
    ...
    public void testLifecycleVersions02() throws Exception {
        ...
        HashMap<String, Vector<String>> componentIds =
        ...
        if (getTransport() == Constants.TRANSPORT_REST) {
            String href =
                XPathAPI.selectSingleNode(getDocument(xml),
                    "/item/components/component[1]/@href").getTextContent();
            components.add(getObjidFromHref(href));
        }
        else {
            components.add(XPathAPI.selectSingleNode(getDocument(xml),
                "/item/components/component[1]/@objid").getTextContent());
        }
        ...
        final String COMPONENT_2_CONTENT_CATEGORY =
            String.valueOf(System.nanoTime());
        substitute(component, "/component/properties/content-category",
            COMPONENT_2_CONTENT_CATEGORY);
        ...
        if (getTransport() == Constants.TRANSPORT_REST) {
            ...
            href =
                XPathAPI.selectSingleNode(getDocument(xml),
                    "/item/components/component[2]/@href").getTextContent();
            components.add(getObjidFromHref(href));
        }
        else {
            components.add(XPathAPI.selectSingleNode(getDocument(xml),
                "/item/components/component[1]/@objid").getTextContent());
            components.add(XPathAPI.selectSingleNode(getDocument(xml),
                "/item/components/component[2]/@objid").getTextContent());
        }
        componentIds.put("3", components);

        HashMap<String, String> requiredValues = new HashMap<String, String>();
        requiredValues.put(
            "/item/components/component/properties/content-category[text()='"
        ...
        PWCallback.setHandle(handle);
        xml = retrieve(objid + ":1");
        validateItemVersion1ReleasedWhileVersion2ReleasedVersion3pending(objid,
            xml);
    ...
    /**
     * Test properties if version 1 is released and version 2 of Item is
     * pending. See http://www.escidoc.org/jira/browse/INFR-625.
     * 
     * @throws Exception
     *             Thrown if at least one value is wrong.
     */
    ...
    public void notestLatestReleasePid() throws Exception {
        ...
        releaseWithPid(objid);
        tsv.compareValueWithTripleStore(objid, "hdl:someHandle/test/" + objid,
            "/RDF/Description/pid",
            "<http://escidoc.de/core/01/properties/pid>");
        tsv.compareValueWithTripleStore(objid, "hdl:someHandle/test/" + objid
            + ":1", "/RDF/Description/pid",
            "<http://escidoc.de/core/01/properties/version/pid>");
        tsv.compareValueWithTripleStore(objid, "hdl:someHandle/test/" + objid
            + ":1", "/RDF/Description/pid",
            "<http://escidoc.de/core/01/properties/release/pid>");
    ...
    public void testUpdateWithVersionNumber() throws Exception {
        ...
        int currentVersion =
            Integer.parseInt(selectSingleNode(xmlDoc,
        ...
        assertXmlExists("New version number", theItemXml,
            "/item/properties/version/number[text() = '" + (currentVersion + 1)
                + "']");
        assertXmlValidItem(theItemXml);
    }
    ...
    public void testIncrementVersionNumber(int rounds, String xPath)
        ...
        for (int i = 1; i < rounds; i++) {
            assertXmlExists("Old version number", theItemXml,
                "/item/properties/version/number[text() = '" + i + "']");
            assertXmlValidItem(theItemXml);
            String newItemXml = addElement(theItemXml, xPath + "/*[1]");
            theItemXml = update(theItemId, newItemXml);
            assertXmlExists("New version number", theItemXml,
                "/item/properties/version/number[text() = '" + (i + 1) + "']");

            // check return value of update
            Document itemDoc = EscidocRestSoapTestsBase.getDocument(theItemXml);
            assertXmlExists("Version " + i + " of Item " + theItemId
                + " content not as expected (negativ).", itemDoc,
                addedElementXPath + i + "]");
            assertXmlNotExists("Version " + i + " of Item " + theItemId
                + " content not as expected (negativ).", itemDoc,
                addedElementXPath + (i + 1) + "]");
        ...
        assertXmlExists("New version number", theItemXml,
            "/item/properties/version/number[text() = '" + rounds + "']");
        assertXmlValidItem(theItemXml);
        ...
        for (int i = rounds; i > 0; i--) {
            ...
            if (i > 1) {
                assertXmlExists("Version " + i
                    + " content not as expected (positiv).", xml,
                    addedElementXPath + (i - 1) + "]");
            }

            assertXmlNotExists("Version " + i + " of Item " + theItemId
                + " content not as expected (negativ).",
                EscidocRestSoapTestsBase.getDocument(xml), addedElementXPath
                    + i + "]");
            if (i < rounds) {
                if (getTransport() == Constants.TRANSPORT_REST) {
                    // hrefs
                    String baseHref = "/ir/item/" + theItemId + ":" + i;
                    assertXmlExists("Item href not as expected.", xml,
                        "/item[@href = '" + baseHref + "']");
                    // baseHref += ":" + i;
                    assertXmlExists("Item properties href not as expected.",
                        xml, "/item/properties[@href = '" + baseHref
                            + "/properties']");
                    NodeList nl =
                        selectNodeList(EscidocRestSoapTestsBase
                            .getDocument(xml), "/item/components/component");
                    for (int j = nl.getLength() - 1; j >= 0; j--) {
                        selectSingleNodeAsserted(nl.item(j),
                            "self::node()/@href");
                        String compId =
                            getIdFromHrefValue(selectSingleNode(nl.item(j),
                                "./@href").getTextContent());
                        selectSingleNodeAsserted(nl.item(j),
                            "self::node()[@href = '" + baseHref
                                + "/components/component/" + compId + "']");
                        selectSingleNodeAsserted(nl.item(j),
                            "./properties[@href = '" + baseHref
                                + "/components/component/" + compId
                                + "/properties']");
                        selectSingleNodeAsserted(nl.item(j),
                            "./properties[substring(@href, 1, "
                                + baseHref.length() + ") = '" + baseHref + "']");
                    }
                }
                else {
                    ...
                    for (int j = nl.getLength() - 1; j >= 0; j--) {
                        selectSingleNodeAsserted(nl.item(j),
                            "self::node()/@objid");
                        String compId =
                            selectSingleNode(nl.item(j), "./@objid")
                                .getTextContent();
                    }
                }
            }
            assertXmlExists("Version number ", xml,
                "/item/properties/version/number[text() = '" + i + "']");
            assertXmlValidItem(xml);
        }
        ...
        selectSingleNodeAsserted(versionHistoryDoc, "/version-history");
        NodeList versions =
            selectNodeList(versionHistoryDoc, "/version-history/version");
    ...
    private void fullLifecycle(final String id) throws Exception {
        ...
        assertXmlValidVersionHistory(getTransport(), versionHistory);
        assertXmlExists("Missing status submitted within event",
            versionHistory, "/version-history/version[1]/events/event[1]/"
                + "eventType[text() = 'submitted']");

        assignObjectPid(id, getPidParam(id, "http://localhost:8080/ir/item/"
            + id));
        ...
        assertXmlExists("Event submitted ", versionHistory,
            "/version-history/version[1]/events/event[1]/"
        ...
        versionHistory = retrieveVersionHistory(id);
        assertXmlValidVersionHistory(getTransport(), versionHistory);
        assertXmlExists("Missing withdraw comment within event",
            versionHistory, "/version-history/version[1]/events/event[1]/"
                + "eventType[text() = 'withdrawn']");
        /*
         * Issue #INFR-696 (http://www.escidoc.org/jira/browse/INFR-696).
         */
        assertXmlExists("Wrong version-status in version-history",
            versionHistory, "/version-history/version[1]/version-status"
                + "[text() = 'released']");
    }
    ...
    public void testStatusLifecycleVersions() throws Exception {
        ...
        assertXmlExists(PUBLIC_STATUS_COMMENT, xml, "/item/properties/"
            + PUBLIC_STATUS_COMMENT);
        assertXmlExists(VERSION_COMMMENT, xml, "/item/properties/"
            + VERSION_COMMMENT);
        assertXmlExists("Properties status pending", xml,
            "/item/properties/public-status[text() = 'pending']");
        assertXmlExists("version status pending", xml,
            "/item/properties/version/status[text() = 'pending']");
        ...
        publicStatusComments.add(currentVersion, selectSingleNode(xmlDoc,
            ...
            .getNodeValue());
        versionComments.add(currentVersion, selectSingleNode(xmlDoc,
            "item/properties/" + VERSION_COMMMENT + "/text()").getNodeValue());
        assertXmlValidItem(xml);
        ...
        assertEquals(versionComments.get(currentVersion), selectSingleNode(
            versionHistoryDoc,
            "/version-history/version[@href = '" + Constants.ITEM_BASE_URI
                + "/" + theItemId + ":" + currentVersion + "']/comment/text()")
            .getNodeValue());
        assertEquals(publicStatusComments.get(currentVersion),
            selectSingleNode(
                versionHistoryDoc,
                "/version-history/version[@href = '" + Constants.ITEM_BASE_URI
                    + "/" + theItemId + ":" + currentVersion
        ...
        assertEquals(versionComments.get(currentVersion), selectSingleNode(
            ...
            "/version-history/version[@href = '" + Constants.ITEM_BASE_URI
                + "/" + theItemId + ":" + currentVersion + "']/comment/text()")
            .getNodeValue());
        assertNotEquals("Update, " + PUBLIC_STATUS_COMMENT
            + " must not be equal to " + VERSION_COMMMENT, publicStatusComments
        ...
        assertNotEquals(VERSION_COMMMENT + " must be changed", versionComments
            .get(currentVersion), selectSingleNode(xmlDoc,
            "item/properties/" + VERSION_COMMMENT + "/text()").getNodeValue());
        versionComments.set(currentVersion, selectSingleNode(xmlDoc,
            "item/properties/" + VERSION_COMMMENT + "/text()").getNodeValue());
        ...
        assertNotEquals(PUBLIC_STATUS_COMMENT + " must be changed",
            publicStatusComments.get(currentVersion), publicStatusComments
                .get(currentVersion - 1));
        versionHistoryDoc = getDocument(retrieveVersionHistory(theItemId));
        // check comment in version-history
        assertEquals(versionComments.get(currentVersion), selectSingleNode(
            versionHistoryDoc,
        ...
        versionComments.set(currentVersion, selectSingleNode(xmlDoc,
            "item/properties/" + VERSION_COMMMENT + "/text()").getNodeValue());
        assertEquals(PUBLIC_STATUS_COMMENT + " must NOT be changed",
            publicStatusComments.get(currentVersion), selectSingleNode(xmlDoc,
                "item/properties/" + PUBLIC_STATUS_COMMENT + "/text()")
                .getNodeValue());
        ...
        assertEquals(versionComments.get(currentVersion), selectSingleNode(
            ...
            "/version-history/version[@href = '" + Constants.ITEM_BASE_URI
                + "/" + theItemId + ":" + currentVersion + "']/comment/text()")
            .getNodeValue());
        assertNotEquals(PUBLIC_STATUS_COMMENT + " must not be changed",
        ...
        // public status comment changed
        assertEquals(VERSION_COMMMENT + " must NOT be changed", versionComments
            .get(currentVersion), selectSingleNode(xmlDoc,
            "item/properties/" + VERSION_COMMMENT + "/text()").getNodeValue());
        assertNotEquals(PUBLIC_STATUS_COMMENT + " must be changed",
            publicStatusComments.get(currentVersion), selectSingleNode(xmlDoc,
        ...
        assertEquals(versionComments.get(currentVersion), selectSingleNode(
            ...
            "/version-history/version[@href = '" + Constants.ITEM_BASE_URI
                + "/" + theItemId + ":" + currentVersion + "']/comment/text()")
            .getNodeValue());
        assertNotEquals(PUBLIC_STATUS_COMMENT
            + " should not be in version history. :-)", publicStatusComments
            .get(currentVersion), selectSingleNode(
            versionHistoryDoc,
            "/version-history/version[@href = '" + Constants.ITEM_BASE_URI
                + "/" + theItemId + ":" + currentVersion + "']/comment/text()")
    ...
    /**
     * Test the last-modification-date of the return values in the whole item
     * lifecycle.
     * 
     * The timestamp of the task oriented methods is compared with the timestamp
     * of the resource before and after the method call (retrieve timestamp &lt;
     * task oriented method timestamp == retrieve timestamp).
     * 
     * @throws Exception
    ...
    /**
     * Test update Item title. The new version has to have the new, updated
     * title and description, but the old versions have to have the old title
    ...
    public void testUpdateItemTitle01() throws Exception {
        ...
        Document itemDoc =
            getDocument(getExampleTemplate("item-minimal-for-create-05.xml"));
        substitute(itemDoc,
        ...
        for (int i = 1; i <= maxVersions; i++) {
            ...
            assertXmlExists("Wrong dc:title in version " + i, itemXml,
                "/item/md-records/md-record[@name='escidoc']/metadata/title"
                    + "[text() = 'Title Version " + i + "']");
            if (getTransport() == Constants.TRANSPORT_REST) {
                assertXmlExists("Wrong xlink:title in version " + i, itemXml,
                    "/item[@title='Title Version " + i + "']");
            }
            assertXmlExists("Wrong dc:title in version " + i, itemXml,
                "/item/md-records/md-record[@name='escidoc']/metadata/description"
                    + "[text() = 'Description Version " + i + "']");
        }
    ...
    public void testItemTimestamps01() throws Exception {
        ...
        assertEquals("Timestamp in root attribute of Item [" + objid
            + "] differs from creation-date"
            + " (create was the one and only event)", XPathAPI
            .selectSingleNode(itemDocV1E1, "/item/@last-modification-date")
            .getTextContent(), XPathAPI.selectSingleNode(itemDocV1E1,
        ...
        assertEquals("Timestamp in root attribute differs from version-date"
            + " (this Item has only one version)", XPathAPI.selectSingleNode(
            itemDocV1E1, "/item/@last-modification-date").getTextContent(),
            XPathAPI.selectSingleNode(itemDocV1E1,
        ...
        assertEquals("Timestamp in root attribute differs from creation-date",
            XPathAPI.selectSingleNode(itemDocV1E1,
                ...
                .selectSingleNode(
                    wovDocV1E1,
                    "/version-history/version[version-number='1']"
                        + "/events/event[last()]/eventDateTime")
                .getTextContent());

        // change status of version 1 ------------------------------------
        submit(objid, getTheLastModificationParam(false, objid, "submit",
            getLastModificationDateValue(itemDocV1E1)));
        assignObjectPid(objid, getPidParam(objid,
            "http://localhost:8080/ir/item/" + objid));
        ...
        String creationDateV1E1R =
            selectSingleNode(itemDocV1E5,
                "/item/properties/creation-date/text()").getNodeValue();
        String versionDateV1E1R =
            selectSingleNode(itemDocV1E5,
                "/item/properties/version/date/text()").getNodeValue();
        String latestVersionDateV1E1R =
            selectSingleNode(itemDocV1E5,
                "/item/properties/latest-version/date/text()").getNodeValue();
        String latestReleaseDateV1E1R =
            selectSingleNode(itemDocV1E5,
                "/item/properties/latest-release/date/text()").getNodeValue();

        assertTrue("last-modification-date is behind version date",
            compareTimestamps(lmdRootV1E1R, creationDateV1E1R) >= 0);
        assertTrue("last-modification-date fits not to //latest-release/date",
            compareTimestamps(lmdRootV1E1R, latestReleaseDateV1E1R) >= 0);
        assertTrue("creation-date fits not to //version/date",
            compareTimestamps(versionDateV1E1R, creationDateV1E1R) > 0);
        assertTrue("cration-date fits not to //latest-version/date",
            compareTimestamps(latestVersionDateV1E1R, creationDateV1E1R) > 0);
    }
     ...
     * Issue INFR-820
     * 
     * Item changed in following way:
     * <ul>
     * <li>create</li>
     * <li>submit</li>
     * <li>assign object pid</li>
     * <li>assign version pid</li>
     * <li>release</li>
     * </ul>
     * 
     * @throws Exception
    ...
    public void testItemTimestamps02() throws Exception {
        ...
        // /item/@last-modification-date == /item/properties/version/date
        assertEquals("last-modification-date in root attribute of Item ["
            + objid + "] differs from //version/date", XPathAPI
            .selectSingleNode(itemDocV1E5, "/item/@last-modification-date")
            .getTextContent(), XPathAPI.selectSingleNode(itemDocV1E5,
            "/item/properties/version/date").getTextContent());

        // /item/@last-modification-date == /item/properties/latest-version/date
        assertEquals("last-modification-date in root attribute of Item ["
            + objid + "] differs from //latest-version/date", XPathAPI
            .selectSingleNode(itemDocV1E5, "/item/@last-modification-date")
            .getTextContent(), XPathAPI.selectSingleNode(itemDocV1E5,
            "/item/properties/latest-version/date").getTextContent());
        ...
        assertEquals("eventDateTime of the latest event of version 1 differs "
            + "from timestamp attribute of version 1 [" + objid + "]", XPathAPI
            .selectSingleNode(
                wovDocV1E5,
                "/version-history/version[version-number='1']"
                    + "/events/event[5]/eventDateTime").getTextContent(),
            XPathAPI
        ...
        // /version-history/@last-modification-date
        assertEquals("last-modification-date in root attribute of Item ["
            + objid + "] differs from last-modification-date "
        ...
        assertEquals("last-modification-date in root attribute of Item ["
            + objid + "] differs from creation date of version", XPathAPI
            .selectSingleNode(wovDocV1E5,
                "/version-history/version[version-number='1']/@timestamp")
            .getTextContent(), XPathAPI.selectSingleNode(itemDocV1E5,
            "/item/properties/creation-date").getTextContent());
        ...
        // /item/@last-modification-date
        assertEquals("last-modification-date in root attribute of Item ["
            + objid + "] differs from timestamp of version 1 "
        ...
        // ==
        // release
        assertEquals("eventType for release is not as expected", "released",
            XPathAPI.selectSingleNode(
                wovDocV1E5,
                "/version-history/version[version-number='1']"
                    + "/events/event[1]/eventType").getTextContent());

        // /version-history/version[version-number='1']/events/event[1]/eventDateTime
        // ==
        // /item/@last-modification-date
        assertEquals("eventDateTime of the latest event of version 1 differs "
            + "from last-modification-date root attribute of Item [" + objid
            + "]", XPathAPI.selectSingleNode(
            wovDocV1E5,
            "/version-history/version[version-number='1']"
                + "/events/event[1]/eventDateTime").getTextContent(), XPathAPI
            .selectSingleNode(itemDocV1E5, "/item/@last-modification-date")
            .getTextContent());
        ...
        // == 'create'
        assertEquals("eventType for create is not as expected for Item ["
            + objid + "]", "create", XPathAPI.selectSingleNode(
            wovDocV1E5,
            "/version-history/version[version-number='1']"
                + "/events/event[5]/eventType").getTextContent());
        ...
        // == '/ir/item/<objid>/resources/version-history#' +
        // /version-history/version[version-number='1']/events/event[1]/@xmlID
        assertEquals("eventIdentifierVaule " + " of Item [" + objid
            + "] differs from defined format", XPathAPI
            .selectSingleNode(
                wovDocV1E5,
                "/version-history/version[version-number='1']"
        ...
        assertEquals("eventIdentifierVaule " + " of Item [" + objid
            ...
            .selectSingleNode(
                wovDocV1E5,
                "/version-history/version[version-number='1']"
                    + "/events/event[2]/eventIdentifier/eventIdentifierValue")
            .getTextContent(), "/ir/item/"
            + objid
            + "/resources/version-history#"
            + XPathAPI.selectSingleNode(
                wovDocV1E5,
                "/version-history/version[version-number='1']"
                    + "/events/event[2]/@xmlID").getTextContent());
        ...
        assertEquals("eventIdentifierVaule " + " of Item [" + objid
            ...
            .selectSingleNode(
                wovDocV1E5,
                "/version-history/version[version-number='1']"
                    + "/events/event[3]/eventIdentifier/eventIdentifierValue")
            .getTextContent(), "/ir/item/"
            + objid
            + "/resources/version-history#"
            + XPathAPI.selectSingleNode(
                wovDocV1E5,
                "/version-history/version[version-number='1']"
                    + "/events/event[3]/@xmlID").getTextContent());
        ...
        assertEquals("eventIdentifierVaule " + " of Item [" + objid
            ...
            .selectSingleNode(
                wovDocV1E5,
                "/version-history/version[version-number='1']"
                    + "/events/event[4]/eventIdentifier/eventIdentifierValue")
            .getTextContent(), "/ir/item/"
            + objid
            + "/resources/version-history#"
            + XPathAPI.selectSingleNode(
                wovDocV1E5,
                "/version-history/version[version-number='1']"
                    + "/events/event[4]/@xmlID").getTextContent());
        ...
        assertEquals("eventIdentifierVaule " + " of Item [" + objid
            ...
            .selectSingleNode(
                wovDocV1E5,
                "/version-history/version[version-number='1']"
                    + "/events/event[5]/eventIdentifier/eventIdentifierValue")
            .getTextContent(), "/ir/item/"
            + objid
            + "/resources/version-history#"
            + XPathAPI.selectSingleNode(
                wovDocV1E5,
                "/version-history/version[version-number='1']"
                    + "/events/event[5]/@xmlID").getTextContent());
    }
    ...
    public void testItemTimestamps03() throws Exception {
        ...
        Document itemDocV2E1 =
            EscidocRestSoapTestsBase.getDocument(itemXmlV2E1);
        ...
        submit(objid, getTheLastModificationParam(false, objid, "submit",
            getLastModificationDateValue(itemDocV2E1)));
        ...
        assertEquals("timestamp of version 1 of Item [" + objid
            + "] differs from timestamp of latest event of version 1 "
            + "in version-history after submit of version 2", XPathAPI
        ...
        assignVersionPid(versionId2, getPidParam(versionId2,
            "http://localhost:8080/ir/item/" + versionId2));
        ...
        assertEquals("timestamp of version 1 of Item [" + objid
            + "] differs from timestamp of latest event of version 1 "
            + "in version-history  after assign of version PID of version 2",
            XPathAPI
        ...
        assertEquals("timestamp of version 1 of Item [" + objid
            + "] differs from timestamp of latest event of version 1 "
            + "in version-history after release of version 2", XPathAPI
    ...
    /**
     * Depends on testLifecycleVersion02. Each Element, Attribute or Value is
     * (should be) checked against the predefined value tables. At least is
     * checked if the values are in the TripleStore.
     * 
     ...
     * @param componentIds
     *            &lt;version number, Vector&lt;objids of components&gt;&gt;
     * @param xml
     *            The XML of the Item in version 1.
     * @throws Exception
     *             Thrown if a single value differs from the required.
     */
    private void validateItemVersion1(
        final String objid, final HashMap<String, Vector<String>> componentIds,
        ...
        expectedValues.put("/item/properties/public-status-comment",
            "Object created.");
        ...
        expectedValues.put("/item/properties/version/comment",
            "Object created.");
        ...
        expectedValues.put("/item/md-records/md-record[@name = 'escidoc']",
            null);

        if (getTransport() == Constants.TRANSPORT_REST) {
            expectedValues.put("/item/@href", null);
            expectedValues.put("/item/properties/@title", "Properties");
            expectedValues.put("/item/properties/context/@href",
                "/ir/context/escidoc:ex1");
            expectedValues.put("/item/properties/context/@title",
                "Context Example 1");
            expectedValues.put("/item/properties/content-model/@href",
                "/cmm/content-model/escidoc:ex4");
            expectedValues.put("/item/properties/content-model/@title",
            ...
            expectedValues.put("/item/properties/version/modified-by/@title",
                "Test System Administrator User");

            expectedValues.put("/item/properties/latest-version/@href",
                "/ir/item/" + objid + ":1");
            expectedValues.put("/item/properties/latest-version/@title",
                "Latest Version");
        }
        else {
            expectedValues.put("/item/@objid", null);
            expectedValues
                .put("/item/properties/context/@objid", "escidoc:ex1");
            expectedValues.put("/item/properties/content-model/@objid",
                "escidoc:ex4");
            expectedValues.put("/item/properties/version/modified-by/@objid",
        ...
        assertEquals("Wrong number of triples for objid='" + objid + "'",
            ITEM_TRIPLE_COUNT_MINUS6, tsv.countTriples(objid));
    }

    /**
     * Depends on testLifecycleVersion02. Each Element, Attribute or Value is
     * (should be) checked against the predefined value tables.
     * 
     ...
     *            The XML of the Item in version 1.
     * @throws Exception
     *             Thrown if a single value differes from the requied.
     */
    private void validateItemVersion1Submitted(
        final String objid, final String xml) throws Exception {
        ...
        expectedValues.put("/item/properties/public-status-comment",
            "Status changed to submitted for Item " + objid + ".");
        expectedValues.put("/item/properties/lock-status", "unlocked");
     ...
     *             Thrown if a single value differs from the required.
     */
    private void validateItemVersion1Released(
        final String objid, final String xml) throws Exception {
        ...
        expectedValues.put("/item/properties/public-status-comment",
            "Status changed to released for Item " + objid + ".");
        expectedValues.put("/item/properties/lock-status", "unlocked");
        ...
        if (getTransport() == Constants.TRANSPORT_REST) {
            ...
            expectedValues.put("/item/properties/latest-release/@href",
                "/ir/item/" + objid + ":1");
            expectedValues.put("/item/properties/latest-release/@title",
        ...
        tsv.compareValueWithTripleStore(objid, "Context Example 1",
            "/RDF/Description/context-title",
            "<http://escidoc.de/core/01/properties/context-title>");
        tsv.compareValueWithTripleStore(objid, "released",
            "/RDF/Description/public-status",
            "<http://escidoc.de/core/01/properties/public-status>");
        tsv.compareValueWithTripleStore(objid,
            "Status changed to released for Item " + objid + ".",
        ...
        assertEquals("Wrong number of triples for objid='" + objid + "'",
            ITEM_TRIPLE_COUNT_MINUS1, tsv.countTriples(objid));
    }
     ...
     *            &lt;version number, Vector&lt;objids of components&gt;&gt;
     * @param xml
     *            The XML of the Item in version 2.
     * @throws Exception
     *             Thrown if a single value differs from the required.
     */
    private void validateItemVersion2(
        ...
        expectedValues.put(
            "/item/components/component[1]/md-records/md-record", null);
        ...
        if (getTransport() == Constants.TRANSPORT_REST) {
            ...
            expectedValues.put("/item/components/component[@href='/ir/item/"
                ...
                + componentIds.get("2").get(0)
                + "']/properties/created-by/@href",
                "/aa/user-account/escidoc:testsystemadministrator");
            ...
            expectedValues.put("/item/components/component[@href='/ir/item/"
                + objid + "/components/component/"
                + componentIds.get("2").get(0) + "']/properties/valid-status",
                "valid");

            expectedValues.put("/item/components/component[@href='/ir/item/"
                + objid + "/components/component/"
                + componentIds.get("2").get(0) + "']/properties/visibility",
                "public");
            ...
            expectedValues.put("/item/components/component[@href='/ir/item/"
                + objid + "/components/component/"
                + componentIds.get("2").get(0) + "']/content/@title",
                "Component " + componentIds.get("2").get(0));

            expectedValues.put("/item/components/component[@href='/ir/item/"
                + objid + "/components/component/"
                + componentIds.get("2").get(0) + "']/content/@href",
                "/ir/item/" + objid + "/components/component/"
     ...
     *            Map of required values &lt;Xpath, value&gt;
     * @throws Exception
     *             Thrown if a single value differs from the required.
     */
    private void validateItemVersion3(
        final String objid, final HashMap<String, Vector<String>> componentIds,
        final String xml, final HashMap<String, String> requiredValues)
        throws Exception {
        ...
        // Component
        expectedValues.put("/item/components/component", null);
        expectedValues.put("/item/components/component/properties/"
            + "content-category[text() ='pre-print']", null);
        ...
        if (getTransport() == Constants.TRANSPORT_REST) {
            ...
            expectedValues.put("/item/components/component[@href='/ir/item/"
                + objid + "/components/component/"
                + componentIds.get("3").get(0) + "']/properties/valid-status",
                "valid");

            expectedValues.put("/item/components/component[@href='/ir/item/"
                + objid + "/components/component/"
                + componentIds.get("3").get(0) + "']/properties/visibility",
                "public");

            expectedValues.put("/item/components/component[@href='/ir/item/"
                + objid + "/components/component/"
                + componentIds.get("3").get(0) + "']/content/@title",
                "Component " + componentIds.get("3").get(0));

            expectedValues.put("/item/components/component[@href='/ir/item/"
                + objid + "/components/component/"
                + componentIds.get("3").get(0) + "']/content/@href",
                "/ir/item/" + objid + "/components/component/"
     ...
     * (should be) checked against the predefined value tables.
     * 
     * Item in version 3 means it has public-status=released,
     * version-status=pending, 2 Components, Version 1 and 2 are released, etc.
     * 
     * @param objid
     *            The objid of the Item.
     * @param componentIds
    ...
    private void validateItemVersion3AsAnonymous(
        ...
        if (getTransport() == Constants.TRANSPORT_REST) {
            ...
            expectedValues.put("/item/components/component[@href='/ir/item/"
                + objid + ":2" + "/components/component/"
                + componentIds.get("2").get(0) + "']/content/@href",
                "/ir/item/" + objid + ":2" + "/components/component/"
                    + componentIds.get("2").get(0) + "/content");
     ...
     * 
     * Item <br/>
     * version 1: released, no Components version 2: released, one Component
     * version 3: pending
     * 
     * @param objid
     *            The objid of the Item.
     ...
     *             Thrown if a single value differs from the required.
     */
    private void validateItemVersion1ReleasedWhileVersion2Released(
        final String objid, final String xml) throws Exception {
        ...
        // number of Triples for this object (to prevent a missing test)
        assertEquals("Wrong number of triples for objid='" + objid + "'",
            ITEM_TRIPLE_COUNT, tsv.countTriples(objid));
    }
     ...
     *             Thrown if a single value differs from the required.
     */
    private void validateItemVersion1ReleasedWhileVersion2ReleasedVersion3pending(
        final String objid, final String xml) throws Exception {
        ...
        tsv.compareValueWithTripleStore(objid, "info:fedora/escidoc:ex1",
            "/RDF/Description/context/@resource",
            "<http://escidoc.de/core/01/structural-relations/context>");
        tsv.compareValueWithTripleStore(objid, "ItemHandler.update()",
            "/RDF/Description/comment",
            "<http://escidoc.de/core/01/properties/version/comment>");
        tsv.compareValueWithTripleStore(objid, "pending",
            "/RDF/Description/status",
    ...
    /**
     * Validates an Item where version 1 is in status released and version 2 is
     * updated by adding a Component and in status pending. No further versions
     * exists.
     * 
     * @param objid
     *            The objid of the Item.
     * @param componentIds
     *            The map with component IDs &lt;version number,
     *            Vector&lt;componentIds&gt;&gt;.
     * @param xml
     *            XML of Item.
     * @throws Exception
     *             Thrown if XML or TripleStore not compares to the required
     *             values.
     */
    ...
    /**
     * Validates an Item in version 1. Where version 1 is in status released and
     * version 2 is updated by adding a Component and in status pending. Version
     * 3 is in status released.
     * 
     * @param objid
     *            The objid of hte Item.
     * @param componentIds
    ...
    private void validateItemVersion1V5T04(
        ...
        tsv.compareValueWithTripleStore(objid, null, "/RDF/Description/pid",
            "<http://escidoc.de/core/01/properties/version/pid>");
        tsv.compareValueWithTripleStore(objid, "hdl:someHandle/test/" + objid
            + ":3", "/RDF/Description/pid",
            "<http://escidoc.de/core/01/properties/release/pid>");

        // number of triples for this object (to prevent missing tests)
        assertEquals("Wrong number of triples for objid='" + objid + "'",
            ITEM_TRIPLE_COUNT_PLUS2, tsv.countTriples(objid));
    }

    /**
     * Validates an Item in version 3. Where version 1 is in status released and
     * version 2 is updated by adding a Component and in status pending. Version
     * 3 is in status released.
     * 
     * @param objid
    ...
    /**
     * Validates an Item where version 1 is in status released and version 2 is
     * updated by adding a Component and in status released. Version 4 and 5 are
     * pending. No further versions exists.
     * 
     * @param objid
     *            The objid of hte Item.
     * @param componentIds
    ...
    private void validateItemVersion02Test04(
         ...
         */
        TripleStoreValue tsv = new TripleStoreValue(getTransport());
        tsv.compareValueWithTripleStore(objid, "Test Collection",
            "/RDF/Description/context-title",
            "<http://escidoc.de/core/01/properties/context-title>");
        tsv.compareValueWithTripleStore(objid, "pending",
            "/RDF/Description/public-status",
        ...
        tsv.compareValueWithTripleStore(objid, "Object created.",
            "/RDF/Description/public-status-comment",
            "<http://escidoc.de/core/01/properties/public-status-comment>");
        tsv.compareValueWithTripleStore(objid, "Persistent Content Model",
            "/RDF/Description/content-model-title",
            "<http://escidoc.de/core/01/properties/content-model-title>");
        tsv.compareValueWithTripleStore(objid,
            "Test System Administrator User",
        ...
        tsv.compareValueWithTripleStore(objid,
            ...
            "<http://escidoc.de/core/01/properties/created-by-title>");
        tsv.compareValueWithTripleStore(objid,
            "info:fedora/escidoc:persistent4",
            "/RDF/Description/content-model/@resource",
            "<http://escidoc.de/core/01/structural-relations/content-model>");
        tsv.compareValueWithTripleStore(objid,
            "info:fedora/escidoc:testsystemadministrator",
        ...
        tsv.compareValueWithTripleStore(objid,
            ...
            "<http://escidoc.de/core/01/structural-relations/modified-by>");
        tsv.compareValueWithTripleStore(objid,
            "info:fedora/escidoc:persistent3",
            "/RDF/Description/context/@resource",
            "<http://escidoc.de/core/01/structural-relations/context>");
        tsv.compareValueWithTripleStore(objid, "ItemHandler.update()",
            "/RDF/Description/comment",
        ...
        // number of triples for this object (to prevent missing tests)
        assertEquals("Wrong number of triples for objid='" + objid + "'",
            ITEM_TRIPLE_COUNT_MINUS5, tsv.countTriples(objid));
