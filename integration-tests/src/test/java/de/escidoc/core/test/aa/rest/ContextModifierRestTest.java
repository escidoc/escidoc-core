...
import de.escidoc.core.test.aa.ContextModifierTest;
...
public class ContextModifierRestTest extends ContextModifierTest {
     ...
     *             If anything fails.
     */
    public ContextModifierRestTest(final int handlerCode,
