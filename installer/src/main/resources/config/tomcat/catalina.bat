...
set CATALINA_OPTS="-Xms512m -Xmx1024m -XX:MaxPermSize=300m -DESCIDOC_HOME=%ESCIOC_HOME% -Dsun.rmi.dgc.client.gcInterval=3600000 -Dsun.rmi.dgc.server.gcInterval=3600000"
