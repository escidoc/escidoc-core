...
public interface FedoraServiceClient {
    ...
    DigitalObjectTO export(
        @NotNull @NotEmpty final String pid, final String format, final String context, final String encoding);

    Future<DigitalObjectTO> exportAsync(
        @NotNull @NotEmpty final String pid, final String format, final String context, final String encoding);

    Stream exportAsStream(
        @NotNull @NotEmpty final String pid, final String format, final String context, final String encoding);

    Future<Stream> exportAsStreamAsync(
        @NotNull @NotEmpty final String pid, final String format, final String context, final String encoding);
