    ...
    public ItemPropertiesTypeTO Do2To(ItemPropertiesDO itemPropertiesDo) throws SystemException {
        ...
        try {
            ...
            if (itemPropertiesDo.getContentModel() != null) {
                ...
                contentModelLink.setHref(new URI(XmlUtility.getContentModelHref(itemPropertiesDo.getContentModel().getValue())));
            ...
            if (itemPropertiesDo.getCreatedBy() != null) {
                ...
                createdByLink.setHref(new URI(XmlUtility.getUserAccountHref(itemPropertiesDo.getCreatedBy().getValue())));
            ...
            if (itemPropertiesDo.getLockInfo() != null) {
                ...
                if (itemPropertiesDo.getLockInfo().getOwner() != null) {
                    ...
                    lockOwnerLink.setHref(new URI(XmlUtility.getUserAccountHref(itemPropertiesDo.getLockInfo().getOwner().getValue())));
                    //TODO: get title of user-account
            ...
            if (itemPropertiesDo.getStatusInfo() != null && itemPropertiesDo.getStatusInfo().getObjectStatus() != null) {
                itemPropertiesTo.setPublicStatus(StatusTypeTO.valueOf(itemPropertiesDo.getStatusInfo().getObjectStatus().toString()));
            ...
            if (itemPropertiesDo.getModifiedBy() != null) {
                ...
                modifierLink.setHref(new URI(XmlUtility.getUserAccountHref(itemPropertiesDo.getModifiedBy().getValue())));
                //TODO: get title of user-account
