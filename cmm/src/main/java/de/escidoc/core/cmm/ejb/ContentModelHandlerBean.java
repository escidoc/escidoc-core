...
public class ContentModelHandlerBean implements SessionBean {
    ...
    public EscidocBinaryContent retrieveContentStreamContent(final String id,
                                                                                                    final String name,
                                                                                                    final SecurityContext securityContext)
            throws ContentModelNotFoundException,
            SystemException,
    ...
    public String retrieveContentModels(final Map parameterMap,
                                                  final SecurityContext securityContext)
    ...
    public String retrieveContentModels(final Map parameterMap, final String authHandle,
                                                  final Boolean restAccess)
            throws InvalidSearchQueryException,
            SystemException {
        try {
