...
public interface SmAggregationDefinitionsDaoInterface {
    ...
    /**
     * deletes AggregationDefinition with given id in the database. returns
     * aggregation-definition as xml.
     * 
     * @param aggregationDefinition
    ...
    /**
     * retrieves AggregationDefinition with given id in the database. returns
     * aggregation-definition as xml.
     * 
     * @param id
    ...
    /**
     * retrieves all AggregationDefinitions from the database. returns
     * Collection of aggregation-definition-xmls.
     * 
    ...
    /**
     * retrieves AggregationDefinitions from the database. returns Collection of
     ...
     */
    Collection<AggregationDefinition> retrieveAggregationDefinitions(
        Collection<String> scopeIds, final String criteria, final int offset,
        final int maxResults) throws InvalidSearchQueryException,
        SqlDatabaseSystemException;

    /**
     * retrieves all AggregationDefinitions from the database with scopeId in
     * given list. returns Collection of aggregation-definition-xmls.
     * 
     * @param scopeIds
     *            Collection of scopeIds
     * @return Collection of AggregationDefinitions as Hibernate Objects
