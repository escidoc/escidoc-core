...
public interface ActionDaoInterface {
     ...
     * 
     * @param contextId
     *            The id of the Context object for that the list of unsecured
     *            actions shall be retrieved.
     ...
     * 
     * @param unsecuredActionList
     *            The {@link UnsecuredActionList} to delete.
     * @throws SqlDatabaseSystemException
     *             Thrown in case of an internal database error.
     */
    void delete(UnsecuredActionList unsecuredActionList)
        throws SqlDatabaseSystemException;
}
