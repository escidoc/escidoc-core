...
public class AbstractRenderer {
     ...
     * @aa
     */
    protected final void addXlinkNamespaceValues(final Map<String, Object> values) {
     ...
     * @aa
     */
    protected final void addRdfValues(final Map<String, Object> values) {
     ...
     */
    protected final void addEscidocBaseUrlValue(final Map<String, Object> values)
        throws WebserverSystemException {
