...
public class UserAccountHandlerBean implements SessionBean {
    ...
    public void delete(final String userId, final SecurityContext securityContext)
    ...
    public String update(final String userId, final String user, final String authHandle,
    ...
    public void updatePassword(final String userId, final String taskParam, final String authHandle,
                               final Boolean restAccess)
            throws UserAccountNotFoundException,
            InvalidStatusException,
            XmlCorruptedException,
    ...
    public String retrieveCurrentUser(final SecurityContext securityContext)
            throws UserAccountNotFoundException,
            AuthenticationException,
            AuthorizationException,
            SystemException {
    ...
    public String retrieveResources(final String userId, final String authHandle,
                                              final Boolean restAccess)
            throws UserAccountNotFoundException,
            MissingMethodParameterException,
            AuthenticationException,
    ...
    public String retrieveCurrentGrants(final String userId, final String authHandle,
                                                  final Boolean restAccess)
            throws UserAccountNotFoundException,
            MissingMethodParameterException,
            AuthenticationException,
    ...
    public String retrieveGrants(final Map filter,
                                           final SecurityContext securityContext)
    ...
    public String retrieveGrants(final Map filter, final String authHandle,
                                           final Boolean restAccess)
            throws MissingMethodParameterException,
            InvalidSearchQueryException,
            AuthenticationException,
    ...
    public void activate(final String userId, final String taskParam, final String authHandle,
                         final Boolean restAccess)
            throws AlreadyActiveException,
            UserAccountNotFoundException,
            XmlCorruptedException,
    ...
    public void deactivate(final String userId, final String taskParam, final String authHandle,
                           final Boolean restAccess)
            throws AlreadyDeactiveException,
            UserAccountNotFoundException,
            XmlCorruptedException,
    ...
    public String createGrant(final String userId, final String grantXML, final String authHandle,
                                        final Boolean restAccess)
            throws AlreadyExistsException,
            UserAccountNotFoundException,
            InvalidScopeException,
    ...
    public void revokeGrants(final String userId, final String taskParam, final String authHandle,
                             final Boolean restAccess)
            throws UserAccountNotFoundException,
            GrantNotFoundException,
            AlreadyRevokedException,
    ...
    public String retrieveUserAccounts(final Map filter,
                                                 final SecurityContext securityContext)
            throws MissingMethodParameterException,
            AuthenticationException,
            AuthorizationException,
    ...
    public String retrieveUserAccounts(final Map filter, final String authHandle,
                                                 final Boolean restAccess)
            throws MissingMethodParameterException,
            AuthenticationException,
            AuthorizationException,
    ...
    public String retrievePreferences(final String userId, final String authHandle,
                                                final Boolean restAccess)
            throws UserAccountNotFoundException,
            MissingMethodParameterException,
            AuthenticationException,
    ...
    public String updatePreference(final String userId, final String preferenceName,
                                             final String preferenceXML,
                                             final SecurityContext securityContext)
            throws AlreadyExistsException,
            UserAccountNotFoundException,
            XmlCorruptedException,
    ...
    public String updatePreference(final String userId, final String preferenceName,
                                             final String preferenceXML, final String authHandle,
                                             final Boolean restAccess)
            throws AlreadyExistsException,
            UserAccountNotFoundException,
            XmlCorruptedException,
    ...
    public void deletePreference(final String userId, final String preferenceName, final String authHandle,
                                 final Boolean restAccess)
            throws UserAccountNotFoundException,
            PreferenceNotFoundException,
            MissingMethodParameterException,
    ...
    public String retrieveAttributes(final String userId, final String authHandle,
                                               final Boolean restAccess)
            throws UserAccountNotFoundException,
            MissingMethodParameterException,
            AuthenticationException,
    ...
    public String updateAttribute(final String userId, final String attributeId,
                                            final String attributeXml,
                                            final SecurityContext securityContext)
            throws UserAccountNotFoundException,
            OptimisticLockingException,
            UserAttributeNotFoundException,
    ...
    public String updateAttribute(final String userId, final String attributeId,
                                            final String attributeXml, final String authHandle,
                                            final Boolean restAccess)
            throws UserAccountNotFoundException,
            OptimisticLockingException,
            UserAttributeNotFoundException,
    ...
    public void deleteAttribute(final String userId, final String attributeId, final String authHandle,
                                final Boolean restAccess)
            throws UserAccountNotFoundException,
            UserAttributeNotFoundException,
            ReadonlyElementViolationException,
    ...
    public String retrievePermissionFilterQuery(final Map parameters,
                                                          final SecurityContext securityContext)
    ...
    public String retrievePermissionFilterQuery(final Map parameters, final String authHandle,
                                                          final Boolean restAccess)
            throws SystemException,
            InvalidSearchQueryException,
            AuthenticationException,
