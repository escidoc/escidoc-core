...
public interface UserAccountDaoInterface {
    ...
    /**
     * Checks if a user account with the provided id exists.<br>
     * The user is identified by either the handle, the id, or the login name.
     * 
     * @param identityInfo
     *            The handle, id, or login name of the user.
     * @return Returns <code>true</code> if a user account with the provided
     *         identifier exists, else <code>false</code>.
     * @throws SqlDatabaseSystemException
     *             Thrown in case of an internal database access error.
     */
    boolean userAccountExists(final String identityInfo)
        throws SqlDatabaseSystemException;
     ...
     * @param grantId
     *            the id of the grant
     * @return Returns <code>true</code> if a grant with the provided
     *         identifier exists, else <code>false</code>.
     * @throws SqlDatabaseSystemException
     *             Thrown in case of an internal database access error.
     */
    ...
    /**
     * Gets a data object for a user.<br>
     * The user is identified by either the handle, the id, or the login name.
     * 
     * @param identityInfo
     *            The handle, id, or login name of the user.
     ...
     * 
     * @param handle
     *            A handle identifying the user account.
     * @return The user data.
     * @throws SqlDatabaseSystemException
     *             Thrown in case of an internal database access error.
     * 
    ...
    /**
     * Retrieves the grants referencing a specified role.<br>
     * The grants will be sorted by related object and related user account.
     * 
     * @param role
     *            The id of the role for that the referencing grants shall be
     *            retrieved.
    ...
    /**
     * Retrieves the grants of an user.<br>
     * The grants will be sorted by related role and related object.
     * 
     * @param userId
     *            The id of the user whose grants shall be retrieved.
     * @return Returns sorted List of <code>Grant</code> objects.
     * @throws SqlDatabaseSystemException
     *             Thrown in case of an internal database access error.
     * @aa
    ...
    /**
     * Retrieves currently valid grant of the provided user for the specified
     * role and (optional) id.
     * 
     * @param userAccount
     *            The user account owning the grants that shall be retrieved.
     * @param role
     *            The role that is granted to the user.
     * @param objId
     *            The id of the object for that the role is granted to the user.
     * 
     ...
     * 
     * @param userId
     *            The id of the user owning the grant that shall be retrieved.
     * @param grantId
     *            The id of the grant that shall be retrieved.
     * 
     * @return Returns the found <code>Grant</code> object or
     *         <code>null</code>.
     * @throws SqlDatabaseSystemException
     ...
     */
    List<RoleGrant> retrieveGrants(String criteria, int offset, int maxResults,
        UserGroupHandlerInterface userGroupHandler)
     ...
     * 
     * @param grant
     *            The <code>Grant</code> object to save.
     * @throws SqlDatabaseSystemException
     *             Thrown in case of an internal database access error.
     * 
     * @aa
     ...
     * 
     * @param userId
     *            The id of the user owning the attribute that shall be retrieved.
     * @param attributeId
     *            The id of the attribute that shall be retrieved.
     * 
     * @return Returns the found <code>UserAttribute</code> object or
     *         <code>null</code>.
     * @throws SqlDatabaseSystemException
     *             Thrown in case of an internal database access error.
     * 
     ...
     * 
     * @param userAccount
     *            The user owning the attributes that shall be retrieved.
     * 
     * @return Returns the found list of <code>UserAttribute</code> objects or
     *         an empty list.
     * @throws SqlDatabaseSystemException
     *             Thrown in case of an internal database access error.
     */
    List<UserAttribute> retrieveAttributes(final UserAccount userAccount)
        throws SqlDatabaseSystemException;
     ...
     *             Thrown in case of an internal database access error.
     */
    List<UserAttribute> retrieveAttributes(
     ...
     * 
     * @param attribute
     *            The <code>UserAttribute</code> object to save.
     * @throws SqlDatabaseSystemException
     *             Thrown in case of an internal database access error.
     * 
     * @aa
    ...
    /**
     * Retrieve the user details of a user account that are used for
     * authentication.
     * 
     * @param handle
     *            The handle identifying the user account.
     * @throws SqlDatabaseSystemException
     *             Thrown in case of an internal database access error.
    ...
    /**
     * Retrieve the user login data whose expiry timestamp is less then the
     * specified value.
     * 
     * @param timestamp
     *            The timestamp (in milli seconds) to compare the login data
     *            timestamp with.
     * @return Returns all login data that have an expiry timestamp that is less
     *         than the specified value. This list may be empty, if no such
     *         login data exists.
     * @throws SqlDatabaseSystemException
     *             Thrown in case of an internal database access error.
     * @aa
     ...
     * 
     * @param userId
     *            The id of the user whose preferences shall be retrieved.
