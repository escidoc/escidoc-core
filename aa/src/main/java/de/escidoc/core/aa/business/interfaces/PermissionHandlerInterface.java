...
public interface PermissionHandlerInterface extends ResourceHandlerInterface {
    ...
    String MSG_USER_NOT_FOUND_BY_IDENTITY_INFO =
        "User with provided user identity does not exist.";

    String MSG_GROUP_NOT_FOUND_BY_ID =
     ...
     * @param taskParam
     *            XML representation of task parameters including the last
     *            modification date
     * 
     * @throws AlreadyActiveException
     *             Thrown if the addressed resource is already activated.
     ...
     */
    void activate(String resourceId, String taskParam)
     ...
     *             Thrown if the addressed resource is already deactivated.
     * @throws ResourceNotFoundException
     *             Thrown if no resource with the provided id exists.
     * @throws XmlCorruptedException
     *             Thrown if the provided XML data is invalid.
     ...
     *             Thrown in case of an internal system error.
     */
    void deactivate(String resourceId, String taskParam)
     ...
     * 
     * @param resourceId
     *            Resource ID (User Account or UserGroup)
     * @param grantXML
     *            XML representation of the Grant to be created corresponding to
     *            XML-schema "grant.xsd"
     * 
     * @return XML representation of the created grant corresponding to
     *         XML-schema "grant.xsd"
     * @throws AlreadyExistsException
     *             Thrown if the defined grant already exists for the resource.
     ...
     *             Thrown in case of an internal system error.
     */
    String createGrant(String resourceId, String grantXML)
        throws AlreadyExistsException, AuthenticationException,
        AuthorizationException, ResourceNotFoundException, XmlCorruptedException,
        InvalidScopeException, SystemException;

    /**
     * Retrieves the currently valid Grants for the resource (User Account or
     * UserGroup) specified by resourceId in a <code>Map</code>.
     * 
     * @param resourceId
     *            Resource ID (User Account or UserGroup)
     * 
    ...
    Map<String, Map<String, List<RoleGrant>>> retrieveCurrentGrantsAsMap(
        String resourceId) throws ResourceNotFoundException, SystemException;
    ...
    /**
     * Retrieve the Grants of the Resource (User Account or UserGroup) that are
     * currently valid, i.e. that currently have not been revoked.<br/>
     * 
     * Retrieve the information about the Roles that currently have been granted
     * to the resource including the information for which objects the limited
     * roles are granted.
     * 
     ...
     * <b>Tasks:</b><br/>
     * <ul>
     * <li>The resource is accessed using the provided reference.</li>
     * <li>The grants corresponding to the Resource are accessed.</li>
     ...
     * 
     * @param resourceId
     *            The Resource ID (User Account or User Group).
     * @return The XML representation of the currently valid Grants of that
     *         Resource corresponding to XML-schema "grants.xsd".
     * @throws ResourceNotFoundException
     *             Thrown if no resource with the provided id exists.
     ...
     *             Thrown in case of an internal system error.
     */
    String retrieveCurrentGrants(String resourceId)
     ...
     * 
     * @param groupId
     *            User Group ID for that the Grant shall be revoked
     * @param grantId
     *            Grant ID that shall be revoked
     * @param taskParam
     *            remark for the revocation of the Grant in an XML structure
     * 
     * @throws MissingMethodParameterException
     ...
     *             Thrown if the addressed grant is already revoked.
     * @throws XmlCorruptedException
     *             Thrown if the provided XML data is invalid.
     * @throws MissingAttributeValueException
     *             Thrown if a mandatory attribute is not provided within the
    ...
    void revokeGrant(String groupId, String grantId, String taskParam)
        throws ResourceNotFoundException, AlreadyRevokedException,
        XmlCorruptedException, MissingAttributeValueException,
     ...
     *            User Group ID.
     * @param grantId
     *            Grant IDt that shall be retrieved.
     ...
     * 
     * @param resourceId
     *            id of the resource (User Account or User Group) for that
     *            Grants shall be revoked
     * @param filterXML
     ...
     *             Thrown if no resource with the provided id exists.
     * @throws AlreadyRevokedException
     *             Thrown if the addressed grants are already revoked.
     * @throws XmlCorruptedException
     *             Thrown if the provided XML data is invalid.
     * @throws MissingAttributeValueException
     *             Thrown if a mandatory attribute is not provided within the
     ...
     *             Thrown in case of an internal system error.
     * @throws AuthorizationException
     *             Thrown in case of an AuthorizationException.
     */
    void revokeGrants(String resourceId, String filterXML)
        throws ResourceNotFoundException, AlreadyRevokedException,
        XmlCorruptedException, MissingAttributeValueException, SystemException,
