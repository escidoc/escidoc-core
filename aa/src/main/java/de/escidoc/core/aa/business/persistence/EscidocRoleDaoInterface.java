...
public interface EscidocRoleDaoInterface {
     ...
     * 
     * @param identifier
     *            An unique identifier of the {@link EscidocRole} object, either
     *            the id or the name of the role.
     * @return Returns <code>true</code> if a role with the provided id
    ...
    /**
     * Retrieves the {@link EscidocRole} object identified by the provided
     * parameter value.
     * 
     * @param identifier
     *            An unique identifier of the {@link EscidocRole} object, either
     *            the id or the name of the role.
     * @return Returns the identified {@link EscidocRole} object or
     *         <code>null</code>.
     * @throws SqlDatabaseSystemException
     *             Thrown in case of an internal database error.
     * @aa
     ...
     *            changed during method execution.
     * @param offset
     ...
     * @return Returns <code>List</code> of identified {@link EscidocRole}
     *         objects. If no query or an empty query is provided, all roles are
     *         selected.
     * @throws SqlDatabaseSystemException
     *             Thrown in case of an internal database error.
     * @aa
     ...
     *             Thrown in case of an internal database error.
     */
    List<EscidocRole> retrieveRoles(String criteria, int offset, int maxResults)
        throws InvalidSearchQueryException, SqlDatabaseSystemException;

    /**
     * Saves the provided new {@link EscidocRole} object or updated the provided
     * existing {@link EscidocRole} object to the database.
     * 
     * @param role
