...
public interface OrganizationalUnitsRestService {
     ...
     */
    @GET
    JAXBElement<? extends ResponseType> retrieveOrganizationalUnits(@QueryParam("") SruSearchRequestParametersBean parameters, @QueryParam("x-info5-roleId") String roleId,
