...
public interface AggregationDefinitionsRestService {
    ...
    @GET
    AggregationDefinitionListTO retrieveAggregationDefinitions(@QueryParam("") SruSearchRequestParametersBean parameters, @QueryParam("x-info5-roleId") String roleId,
