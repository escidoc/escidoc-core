...
public class ContentRelationHandler implements ContentRelationHandlerInterface {
    ...
    public String retrieveContentRelations(
        ...
        return handler.retrieveContentRelations(new LuceneRequestParameters(
            parameterMap));
    }
    ...
    public String update(final String id, final String xmlData)
        ...
        MissingAttributeValueException, SystemException, InvalidXmlException,
     ...
     * @throws InvalidContentException
     *             Thrown if a XML file with an ntology has invalid content
     * @throws InvalidXmlException
