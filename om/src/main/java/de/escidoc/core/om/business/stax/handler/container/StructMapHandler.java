 ...
 * @om
 */
public class StructMapHandler extends DefaultHandler {
    ...
    private static AppLogger logger =
        new AppLogger(StructMapHandler.class.getName());
     ...
     */
    public StructMapHandler(final String containerId,
        final String structMapPath, final StaxParser parser) {
     ...
     *            The parser this handler is attached to.
     */
    public StructMapHandler(final String containerId, final StaxParser parser) {
        this.containerId = containerId;
    ...
    private String checkRefElement(StartElement element, String objectType)
        ...
        try {
            ...
            if (!objectType.equals(TripleStoreUtility
                .getInstance().getObjectType(entryId))) {
                throw new InvalidContentException(
