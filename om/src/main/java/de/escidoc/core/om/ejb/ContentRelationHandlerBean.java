...
public class ContentRelationHandlerBean implements SessionBean {
    ...
    public String lock(final String id, final String param, final String authHandle,
    ...
    public String unlock(final String id, final String param, final String authHandle,
                                   final Boolean restAccess)
            throws AuthenticationException,
            AuthorizationException,
            ContentRelationNotFoundException,
    ...
    public String submit(final String id, final String param, final String authHandle,
                                   final Boolean restAccess)
            throws AuthenticationException,
            AuthorizationException,
            ContentRelationNotFoundException,
    ...
    public String release(final String id, final String param, final String authHandle,
                                    final Boolean restAccess)
            throws AuthenticationException,
            AuthorizationException,
            ContentRelationNotFoundException,
    ...
    public String revise(final String id, final String param, final String authHandle,
                                   final Boolean restAccess)
            throws AuthenticationException,
            AuthorizationException,
            ContentRelationNotFoundException,
    ...
    public String retrieveContentRelations(final Map parameterMap,
                                                     final SecurityContext securityContext)
    ...
    public String retrieveContentRelations(final Map parameterMap, final String authHandle,
                                                     final Boolean restAccess)
            throws InvalidSearchQueryException,
            SystemException {
        try {
