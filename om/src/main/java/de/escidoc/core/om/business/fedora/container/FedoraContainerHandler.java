...
public class FedoraContainerHandler extends ContainerHandlerPid implements ContainerHandlerInterface {
    ...
    private String doCreate(final String xmlData, final boolean isCreate) throws SystemException,
        ...
        for (final org.fcrepo.server.types.gen.Datastream aRelsExtInfo : relsExtInfo) {
            ...
            if (lastModifiedDate == null) {
                ...
                try {
                    if (Iso8601Util.parseIso8601(lastModifiedDate).before(Iso8601Util.parseIso8601(createdDate))) {
                        lastModifiedDate = createdDate;
                    }
                }
     ...
     */
    @Override
    public String retrieveContainers(final SRURequestParameters parameters) throws SystemException {
        final StringWriter result = new StringWriter();
    ...
    private void setMetadataRecords(
        ...
        for (final Entry<String, ByteArrayOutputStream> stringByteArrayOutputStreamEntry : mdMap.entrySet()) {
            ...
            final Datastream ds =
                new Datastream(stringByteArrayOutputStreamEntry.getKey(), getContainer().getId(), xmlBytes, "text/xml",
                    mdProperties);
     ...
     * @throws SystemException e
     */
    private void withdrawMembers(final String id, final String withdrawComment) throws SystemException {
    ...
    public String createItem(final String containerId, final String xmlData) throws ContainerNotFoundException,
        ...
        MissingMdRecordException, InvalidStatusException, AuthorizationException {
