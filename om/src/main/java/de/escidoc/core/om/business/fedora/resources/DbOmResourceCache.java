 ...
 */
package de.escidoc.core.om.business.fedora.resources;
...
/**
 * Abstract super class for all OM resource caches (item, container, content
 * relation, context).
 * 
 * @author Andr&eacute; Schenk
 */
public abstract class DbOmResourceCache extends DbResourceCache {
     ...
     */
    public DbOmResourceCache() throws IOException, WebserverSystemException {
    }
