...
INSERT INTO aa.method_mappings (id, class_name, method_name, action_name, exec_before, single_resource)
  VALUES ('escidoc:mm-aggregation-definition-create', 'de.escidoc.core.sm.service.interfaces.AggregationDefinitionHandlerInterface', 'create', 'info:escidoc/names:aa:1.0:action:create-aggregation-definition', true, true);
...
INSERT INTO aa.method_mappings (id, class_name, method_name, action_name, exec_before, single_resource, resource_not_found_exception)
  VALUES ('escidoc:mm-aggregation-definition-delete', 'de.escidoc.core.sm.service.interfaces.AggregationDefinitionHandlerInterface', 'delete', 'info:escidoc/names:aa:1.0:action:delete-aggregation-definition', true, true, 'de.escidoc.core.common.exceptions.application.notfound.AggregationDefinitionNotFoundException');
...
INSERT INTO aa.invocation_mappings (id, attribute_id, path, position, attribute_type, mapping_type, multi_value, value, method_mapping)
  VALUES ('escidoc-im-aggregation-definition-delete-2', 'info:escidoc/names:aa:1.0:resource:object-type', '', 0, 
         ...
         */
INSERT INTO aa.method_mappings (id, class_name, method_name, action_name, exec_before, single_resource, resource_not_found_exception)
  VALUES ('escidoc:mm-aggregation-definition-retrieve', 'de.escidoc.core.sm.service.interfaces.AggregationDefinitionHandlerInterface', 'retrieve', 'info:escidoc/names:aa:1.0:action:retrieve-aggregation-definition', true, true, 'de.escidoc.core.common.exceptions.application.notfound.AggregationDefinitionNotFoundException');
...
INSERT INTO aa.method_mappings (id, class_name, method_name, action_name, exec_before, single_resource)
  VALUES ('escidoc:mm-aggregation-definition-retrieve-list', 'de.escidoc.core.sm.service.interfaces.AggregationDefinitionHandlerInterface', 'retrieveAggregationDefinitions', 'info:escidoc/names:aa:1.0:action:retrieve-objects-filtered', false, true);

        /**
         * ReportDefinitionHandler mm - create
         */
INSERT INTO aa.method_mappings (id, class_name, method_name, action_name, exec_before, single_resource)
  VALUES ('escidoc:mm-report-definition-create', 'de.escidoc.core.sm.service.interfaces.ReportDefinitionHandlerInterface', 'create', 'info:escidoc/names:aa:1.0:action:create-report-definition', true, true);
...
INSERT INTO aa.invocation_mappings (id, attribute_id, path, position, attribute_type, mapping_type, multi_value, value, method_mapping)
  VALUES ('escidoc-im-report-definition-create-3', 'info:escidoc/names:aa:1.0:resource:object-type', '', 0, 
         ...
         */
INSERT INTO aa.method_mappings (id, class_name, method_name, action_name, exec_before, single_resource, resource_not_found_exception)
  VALUES ('escidoc:mm-report-definition-delete', 'de.escidoc.core.sm.service.interfaces.ReportDefinitionHandlerInterface', 'delete', 'info:escidoc/names:aa:1.0:action:delete-report-definition', true, true, 'de.escidoc.core.common.exceptions.application.notfound.ReportDefinitionNotFoundException');
...
INSERT INTO aa.invocation_mappings (id, attribute_id, path, position, attribute_type, mapping_type, multi_value, value, method_mapping)
  VALUES ('escidoc-im-report-definition-delete-2', 'info:escidoc/names:aa:1.0:resource:object-type', '', 0, 
         ...
         */
INSERT INTO aa.method_mappings (id, class_name, method_name, action_name, exec_before, single_resource, resource_not_found_exception)
  VALUES ('escidoc:mm-report-definition-retrieve', 'de.escidoc.core.sm.service.interfaces.ReportDefinitionHandlerInterface', 'retrieve', 'info:escidoc/names:aa:1.0:action:retrieve-report-definition', true, true, 'de.escidoc.core.common.exceptions.application.notfound.ReportDefinitionNotFoundException');
...
INSERT INTO aa.method_mappings (id, class_name, method_name, action_name, exec_before, single_resource)
  VALUES ('escidoc:mm-report-definition-retrieve-list', 'de.escidoc.core.sm.service.interfaces.ReportDefinitionHandlerInterface', 'retrieveReportDefinitions', 'info:escidoc/names:aa:1.0:action:retrieve-objects-filtered', false, true);

        /**
         * ReportDefinitionHandler mm - update
         */
INSERT INTO aa.method_mappings (id, class_name, method_name, action_name, exec_before, single_resource, resource_not_found_exception)
  VALUES ('escidoc:mm-report-definition-update', 'de.escidoc.core.sm.service.interfaces.ReportDefinitionHandlerInterface', 'update', 'info:escidoc/names:aa:1.0:action:update-report-definition', true, true, 'de.escidoc.core.common.exceptions.application.notfound.ReportDefinitionNotFoundException');
...
INSERT INTO aa.invocation_mappings (id, attribute_id, path, position, attribute_type, mapping_type, multi_value, value, method_mapping)
  VALUES ('escidoc-im-report-definition-update-3', 'info:escidoc/names:aa:1.0:resource:object-type', '', 0, 
         ...
         */
INSERT INTO aa.method_mappings (id, class_name, method_name, action_name, exec_before, single_resource, resource_not_found_exception)
  VALUES ('escidoc:mm-report-retrieve', 'de.escidoc.core.sm.service.interfaces.ReportHandlerInterface', 'retrieve', 'info:escidoc/names:aa:1.0:action:retrieve-report', true, true, 'de.escidoc.core.common.exceptions.application.notfound.ReportDefinitionNotFoundException');
...
INSERT INTO aa.invocation_mappings (id, attribute_id, path, position, attribute_type, mapping_type, multi_value, value, method_mapping)
  VALUES ('escidoc-im-report-retrieve-2', 'info:escidoc/names:aa:1.0:resource:object-type', '', 0, 
         ...
         */
INSERT INTO aa.method_mappings (id, class_name, method_name, action_name, exec_before, single_resource)
  VALUES ('escidoc:mm-statistic-data-create', 'de.escidoc.core.sm.service.interfaces.StatisticDataHandlerInterface', 'create', 'info:escidoc/names:aa:1.0:action:create-statistic-data', true, true);
...
INSERT INTO aa.invocation_mappings (id, attribute_id, path, position, attribute_type, mapping_type, multi_value, value, method_mapping)
  VALUES ('escidoc-im-statistic-data-create-3', 'info:escidoc/names:aa:1.0:resource:object-type', '', 0, 
         ...
         */
INSERT INTO aa.method_mappings (id, class_name, method_name, action_name, exec_before, single_resource)
  VALUES ('escidoc:mm-scope-create', 'de.escidoc.core.sm.service.interfaces.ScopeHandlerInterface', 'create', 'info:escidoc/names:aa:1.0:action:create-scope', true, true);
...
INSERT INTO aa.invocation_mappings (id, attribute_id, path, position, attribute_type, mapping_type, multi_value, value, method_mapping)
  VALUES ('escidoc-im-scope-create-2', 'info:escidoc/names:aa:1.0:resource:object-type', '', 0, 
         ...
         */
INSERT INTO aa.method_mappings (id, class_name, method_name, action_name, exec_before, single_resource, resource_not_found_exception)
  VALUES ('escidoc:mm-scope-delete', 'de.escidoc.core.sm.service.interfaces.ScopeHandlerInterface', 'delete', 'info:escidoc/names:aa:1.0:action:delete-scope', true, true, 'de.escidoc.core.common.exceptions.application.notfound.ScopeNotFoundException');
...
INSERT INTO aa.invocation_mappings (id, attribute_id, path, position, attribute_type, mapping_type, multi_value, value, method_mapping)
  VALUES ('escidoc-im-scope-delete-2', 'info:escidoc/names:aa:1.0:resource:object-type', '', 0, 
         ...
         */
INSERT INTO aa.method_mappings (id, class_name, method_name, action_name, exec_before, single_resource, resource_not_found_exception)
  VALUES ('escidoc:mm-scope-retrieve', 'de.escidoc.core.sm.service.interfaces.ScopeHandlerInterface', 'retrieve', 'info:escidoc/names:aa:1.0:action:retrieve-scope', true, true, 'de.escidoc.core.common.exceptions.application.notfound.ReportDefinitionNotFoundException');
...
INSERT INTO aa.method_mappings (id, class_name, method_name, action_name, exec_before, single_resource)
  VALUES ('escidoc:mm-scope-retrieve-list', 'de.escidoc.core.sm.service.interfaces.ScopeHandlerInterface', 'retrieveScopes', 'info:escidoc/names:aa:1.0:action:retrieve-objects-filtered', false, true);

        /**
         * ScopeHandler mm - update
         */
INSERT INTO aa.method_mappings (id, class_name, method_name, action_name, exec_before, single_resource, resource_not_found_exception)
  VALUES ('escidoc:mm-scope-update', 'de.escidoc.core.sm.service.interfaces.ScopeHandlerInterface', 'update', 'info:escidoc/names:aa:1.0:action:update-scope', true, true, 'de.escidoc.core.common.exceptions.application.notfound.ReportDefinitionNotFoundException');
...
INSERT INTO aa.invocation_mappings (id, attribute_id, path, position, attribute_type, mapping_type, multi_value, value, method_mapping)
  VALUES ('escidoc-im-scope-update-2', 'info:escidoc/names:aa:1.0:resource:object-type', '', 0, 
         ...
         */
INSERT INTO aa.method_mappings (id, class_name, method_name, action_name, exec_before, single_resource)
  VALUES ('escidoc:mm-preprocessing-preprocess', 'de.escidoc.core.sm.service.interfaces.PreprocessingHandlerInterface', 'preprocess', 'info:escidoc/names:aa:1.0:action:preprocess-statistics', true, true);
