...
INSERT INTO aa.method_mappings (id, class_name, method_name, action_name, exec_before, single_resource, resource_not_found_exception)
  VALUES ('escidoc:mm-intellectualentity-create-async', 'de.escidoc.core.om.service.interfaces.IntellectualEntityHandlerInterface', 'ingestIntellectualEntity', 
...
INSERT INTO aa.method_mappings (id, class_name, method_name, action_name, exec_before, single_resource, resource_not_found_exception)
  VALUES ('escidoc:mm-intellectualentity-metadata-retrieve', 'de.escidoc.core.om.service.interfaces.IntellectualEntityHandlerInterface', 'getMetadata',
  'info:escidoc/names:aa:1.0:action:retrieve-intellectualentity-metadata', true, true, 'de.escidoc.core.common.exceptions.application.notfound.ResourceNotFoundException');
...
INSERT INTO aa.method_mappings (id, class_name, method_name, action_name, exec_before, single_resource, resource_not_found_exception)
  VALUES ('escidoc:mm-file-search', 'de.escidoc.core.om.service.interfaces.FileHandlerInterface', 'searchFile', 
...
INSERT INTO aa.method_mappings (id, class_name, method_name, action_name, exec_before, single_resource, resource_not_found_exception)
  VALUES ('escidoc:mm-intellectualentity-metadata-update', 'de.escidoc.core.om.service.interfaces.IntellectualEntityHandlerInterface', 'updateIntellectualEntityMetadata', 
...
INSERT INTO aa.invocation_mappings (id, attribute_id, path, position, attribute_type, mapping_type, multi_value, value, method_mapping)
  VALUES ('escidoc:im-intellectualentity-metadata-retrieve', 'urn:oasis:names:tc:xacml:1.0:resource:resource-id', '', 0, 
          'http://www.w3.org/2001/XMLSchema#string', 0, false, '', 'escidoc:mm-intellectualentity-metadata-retrieve');
...
INSERT INTO aa.invocation_mappings (id, attribute_id, path, position, attribute_type, mapping_type, multi_value, value, method_mapping)
  VALUES ('escidoc:im-representation-retrieve', 'urn:oasis:names:tc:xacml:1.0:resource:resource-id', '', 0, 
          'http://www.w3.org/2001/XMLSchema#string', 0, false, '', 'escidoc:mm-representation-retrieve');
