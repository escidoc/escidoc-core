...
INSERT INTO aa.escidoc_role
    (id, role_name, creator_id, creation_date, modified_by_id, last_modification_date)
     VALUES
    ('escidoc:role-moderator', 'Moderator', 'escidoc:exuser1', CURRENT_TIMESTAMP, 'escidoc:exuser1',
    CURRENT_TIMESTAMP);
...
INSERT INTO aa.escidoc_policies (id, role_id, xml) VALUES ('escidoc:moderator-policy-1', 'escidoc:role-moderator', '<Policy PolicyId="Moderator-policy" RuleCombiningAlgId="urn:oasis:names:tc:xacml:1.0:rule-combining-algorithm:ordered-permit-overrides">
    <Target>
        <Subjects>
            <AnySubject/>
        </Subjects>
