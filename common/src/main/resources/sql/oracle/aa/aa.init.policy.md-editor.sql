...
BEGIN
 ...
 SRC_CHUNK := '<Policy PolicyId="MD-Editor-policy" RuleCombiningAlgId="urn:oasis:names:tc:xacml:1.0:rule-combining-algorithm:ordered-permit-overrides">
    <Target>
        <Subjects>
            <AnySubject/>
        </Subjects>
  ...
  ('escidoc:md-editor-policy-container', 'escidoc:role-md-editor', TMP_CLOB);
END;
/
