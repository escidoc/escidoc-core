...
BEGIN
 ...
 SRC_CHUNK := '<Policy PolicyId="Moderator-policy" RuleCombiningAlgId="urn:oasis:names:tc:xacml:1.0:rule-combining-algorithm:ordered-permit-overrides">
    <Target>
        <Subjects>
            <AnySubject/>
        </Subjects>
  ...
  ('escidoc:moderator-policy-1', 'escidoc:role-moderator', TMP_CLOB);
END;
/
