...
BEGIN
 ...
 SRC_CHUNK := '<Policy PolicyId="Privileged-Viewer-policy" RuleCombiningAlgId="urn:oasis:names:tc:xacml:1.0:rule-combining-algorithm:ordered-permit-overrides">
    <Target>
      <Subjects>
        <AnySubject/>
      </Subjects>
  ...
  ('escidoc:privileged-viewer-policy-1', 'escidoc:role-privileged-viewer', TMP_CLOB);
END;
/
