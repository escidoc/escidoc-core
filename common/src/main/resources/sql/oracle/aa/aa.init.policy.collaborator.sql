...
BEGIN
 ...
 SRC_CHUNK := '<Policy PolicyId="Collaborator-policy" RuleCombiningAlgId="urn:oasis:names:tc:xacml:1.0:rule-combining-algorithm:ordered-permit-overrides">
  <Target>
    <Subjects>
      <AnySubject/>
    </Subjects>
  ...
  ('escidoc:collaborator-policy-1', 'escidoc:role-collaborator', TMP_CLOB);
END;
/
