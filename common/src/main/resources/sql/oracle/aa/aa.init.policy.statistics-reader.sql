...
BEGIN
 ...
 SRC_CHUNK := '<Policy PolicyId="Statistics-reader-policy" RuleCombiningAlgId="urn:oasis:names:tc:xacml:1.0:rule-combining-algorithm:ordered-permit-overrides">
  <Target>
    <Subjects>
      <AnySubject/>
    </Subjects>
  ...
  ('escidoc:statistics-reader-policy-1', 'escidoc:role-statistics-reader', TMP_CLOB);
END;
/
