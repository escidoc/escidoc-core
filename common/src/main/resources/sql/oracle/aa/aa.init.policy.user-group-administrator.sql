...
BEGIN
 ...
 SRC_CHUNK := '<Policy PolicyId="User-Group-Administrator-policy" RuleCombiningAlgId="urn:oasis:names:tc:xacml:1.0:rule-combining-algorithm:ordered-permit-overrides">
  <Target>
    <Subjects>
      <AnySubject/>
    </Subjects>
  ...
  <Rule RuleId="User-Group-Administrator-policy-rule-2" Effect="Permit">
    ...
    <Condition FunctionId="urn:oasis:names:tc:xacml:1.0:function:string-equal">
        ...
        SRC_CHUNK := '<Rule RuleId="User-Group-Administrator-policy-rule-3" Effect="Permit">
    <Target>
      <Subjects>
        <AnySubject/>
      </Subjects>
  ...
  ('escidoc:policy-user-group-administrator', 'escidoc:role-user-group-administrator', TMP_CLOB);
END;
/
