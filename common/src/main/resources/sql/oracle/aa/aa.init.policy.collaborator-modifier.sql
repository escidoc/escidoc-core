...
BEGIN
 ...
 SRC_CHUNK := '<Policy PolicyId="Collaborator-Modifier-policy" RuleCombiningAlgId="urn:oasis:names:tc:xacml:1.0:rule-combining-algorithm:ordered-permit-overrides">
  <Target>
    <Subjects>
      <AnySubject/>
    </Subjects>
  ...
  ('escidoc:collaborator-modifier-policy-1', 'escidoc:role-collaborator-modifier', TMP_CLOB);
END;
/
