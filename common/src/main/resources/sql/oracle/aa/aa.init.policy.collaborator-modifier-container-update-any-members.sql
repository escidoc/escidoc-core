...
BEGIN
 ...
 SRC_CHUNK := '<Policy PolicyId="Collaborator-Modifier-Container-Update-any-Members-policy" RuleCombiningAlgId="urn:oasis:names:tc:xacml:1.0:rule-combining-algorithm:ordered-permit-overrides">
  <Target>
    <Subjects>
      <AnySubject/>
    </Subjects>
  ...
  ('escidoc:collaborator-modifier-container-update-any-members-policy-1', 'escidoc:role-collaborator-modifier-container-update-any-members', TMP_CLOB);
END;
/
