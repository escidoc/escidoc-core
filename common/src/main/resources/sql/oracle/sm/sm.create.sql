...
INSERT INTO sm.aggregation_tables (id, aggregation_definition_id, name, list_index) 
    VALUES 
    ('escidoc:aggdef1table1', 'escidoc:aggdef1', 'aggdef1_request_statistics', 1);

INSERT INTO sm.aggregation_tables (id, aggregation_definition_id, name, list_index) 
    VALUES 
    ('escidoc:aggdef1table2', 'escidoc:aggdef1', 'aggdef1_object_statistics', 2);

INSERT INTO sm.aggregation_table_indexes (id, aggregation_table_id, name, list_index) 
    VALUES 
    ('escidoc:aggdef1table1idx1', 'escidoc:aggdef1table1', 'aggdef1_time1_idx', 1);
...
INSERT INTO sm.aggregation_table_indexes (id, aggregation_table_id, name, list_index) 
    VALUES 
    ('escidoc:aggdef1table1idx2', 'escidoc:aggdef1table1', 'aggdef1_time2_idx', 2);
...
INSERT INTO sm.aggregation_table_indexes (id, aggregation_table_id, name, list_index) 
    VALUES 
    ('escidoc:aggdef1table2idx1', 'escidoc:aggdef1table2', 'aggdef1_time3_idx', 1);
...
CREATE INDEX aggdef1_time2_idx
...
INSERT INTO sm.aggregation_tables (id, aggregation_definition_id, name, list_index) 
    VALUES 
    ('escidoc:aggdef2table1', 'escidoc:aggdef2', 'aggdef2_error_statistics', 1);

INSERT INTO sm.aggregation_table_indexes (id, aggregation_table_id, name, list_index) 
    VALUES 
    ('escidoc:aggdef2table1idx1', 'escidoc:aggdef2table1', 'aggdef2_time1_idx', 1);
...
INSERT INTO sm.aggregation_table_indexes (id, aggregation_table_id, name, list_index) 
    VALUES 
    ('escidoc:aggdef2table1idx2', 'escidoc:aggdef2table1', 'aggdef2_time2_idx', 2);
