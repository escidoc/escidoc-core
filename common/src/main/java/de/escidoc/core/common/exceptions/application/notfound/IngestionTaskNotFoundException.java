...
/**
 * The IngestionTaskNotFoundException is used to indicate that the ingestion
 * task requested in the context of the service-call is null or does not exist
