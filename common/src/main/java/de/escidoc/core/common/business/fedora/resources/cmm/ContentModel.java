...
public class ContentModel extends GenericVersionableResourcePid implements VersionableResource {
     ...
     *             If an object with the specified ID can not be found. If there is such an object but this object is no
     *             Content Model a ContentModelNotFoundException is thrown.
     */
