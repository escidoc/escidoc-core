...
/**
 * The InvalidScopeException is used to indicate that the scope of the grant
 * is not valid for the role. returned httpStatusCode is 412. Status
...
public class InvalidScopeException extends ValidationException {
     ...
     *            Throwable
     */
    public InvalidScopeException(final Throwable error) {
     ...
     * @common
     */
    public InvalidScopeException(final String message, final Throwable error) {
