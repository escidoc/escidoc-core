...
public class Datastream {
     ...
     * {@link DatastreamProfilesTO} object.<br/>
     * <br/>
    ...
    final DatastreamProfilesTO datastreamProfiles, final String parentId) {

        final Map<String, Datastream> result =
            new HashMap<String, Datastream>(datastreamProfiles.getDatastreamProfile().size() + 1);
