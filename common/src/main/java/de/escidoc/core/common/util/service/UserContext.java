...
/**
 * Using the SecurityAssociation class to get information about the user in the
...
public final class UserContext extends Object {
    ...
    private static final String USER_CONTEXT_IS_NOT_INITIALIZED =
        "UserContext is not initialized";
    ...
    /**
     * Sets the user context. The user context is put into a spring security
     * {@link Authentication} object, which is put into an spring security
     * {@link SecurityContext} object and finally stored via the spring security
     * {@link SecurityContextHolder}.<br>
     * A previous UserContext is deleted by this method.<br>
     * This method must not be used to set an eSciDoc special user, e.g.
     * authorization user. This is only possible by initializing the
     * UserContextPrincipal via the setTechnicalName method.<br>
     * This method initializes an unauthenticated {@link Authentication} object
     * in the security context.
     * 
     * @param handle
     *            The handle identifying the user.<br>
     *            This parameter is optional. If it is not provided, an empty
     *            {@link String} is stored as the eSciDoc user handle
    ...
    public static void setUserContext(final String handle)
        ...
        final UsernamePasswordAuthenticationToken authentication =
            new UsernamePasswordAuthenticationToken(new EscidocUserDetails(),
                hd);
    ...
    /**
     * Sets the user context. The user context is stored in the provided
     * {@link SecurityContext} object. This object is stored via the spring
     * security {@link SecurityContextHolder}</code>.<br>
     * This constructor is used to forward the security context to another EJB.
     * The provided security context is checked for being created by the base
     * services to prevent setting it by external services.<br>
     * A previous UserContext is deleted by this method.
     * 
     * @param context
     *            The principal storing information about the user. This
     *            principal must be signed by a known key. Otherwise, an
     *            exception is thrown.
     * @throws MissingMethodParameterException
    ...
    /**
     * Executes the following accesses of the user identified by the current
     * {@link Authentication} with the privileges of the internal user. If the
     * current access is running with the privileges of the internal user, the
     * {@link Authentication} is kept unchanged.
     * 
     * @return Returns <code>true</code> if the {@link Authentication} has
    ...
    public static boolean runAsInternalUser() throws WebserverSystemException {
        ...
        if (!(authentication instanceof EscidocRunAsInternalUserToken)) {
            getSecurityContext().setAuthentication(
                new EscidocRunAsInternalUserToken(authentication));
            return true;
        }
        return false;
    }
    ...
    /**
     * Reverts executing the following accesses with the privileges of the
     * internal user. If the current access is not executed with the internal
     * user's privileges, the {@link Authentication} is kept unchanged.
     * 
     * @return Returns <code>true</code> if the {@link Authentication} has
     *         been changed, <code>false</code> else.
     * @throws WebserverSystemException
    ...
    public static boolean runAsExternalUser() throws WebserverSystemException {
        ...
        if (authentication instanceof EscidocRunAsInternalUserToken) {
            getSecurityContext().setAuthentication(
                ((EscidocRunAsInternalUserToken) authentication)
                    .getOrginalAuthentication());
            return true;
        }
        else {
            return false;
    ...
    /**
     * Sets the id of the user. The id is put into the principal of an spring
     * security {@link Authentication} object, which is put into an spring
     * security {@link SecurityContext} object and finally stored via the spring
     * security {@link SecurityContextHolder}.<br>
     * Before calling this method, the user context must be set by using the
     * setContext method. Otherwise, an exception is thrown here.<br>
     * This method resets the signature of the principal and it has to be
     * resigned.<br>
     * 
     * @param id
     *            The id of the user. This may be <code>null</code> or an
    ...
    /**
     * Sets the real name of the user as stored in the UserAccount. The user's
     * real name is put into the principal of an spring security
     * {@link Authentication} object, which is put into an spring security
     * {@link SecurityContext} object and finally stored via the spring security
     * {@link SecurityContextHolder}.<br>
     * Before calling this method, the user context must be set by using the
    ...
    /**
     * Sets the REST access flag of the user context. This flag is stored in the
     * {@link SecurityContext} object, which is stored via the spring security
     * {@link SecurityContextHolder}.<br>
     * Before calling this method, the user context must be set by using the
    ...
    /**
     * Gets the authentication token stored within the user context.<br>
     * Before calling this method, the user context must be set by using the
     * setContext method. Otherwise, an exception is thrown here.
     * 
    ...
    /**
     * Gets the principal stored within the user context.<br>
     * Before calling this method, the user context must be set by using the
     * setContext method. Otherwise, an exception is thrown here.
     * 
     * @return Returns the {@link UserContextPrincipal} object holding the
    ...
    /**
     * Sets the principal stored within the user context.<br>
     * Before calling this method, the user context must be set by using the
     * setContext method. Otherwise, an exception is thrown here.<br>
     * Note: This method establishes a new {@link Authentication} in the
    ...
    /**
     * Gets the user id from the user context. The user id is fetched from the
     * principals of the authentication token fetched from the spring security
     * {@link SecurityContextHolder}.<br>
     * Before calling this method, the user context must be set by using the
     * setContext method. Otherwise, an exception is thrown here.
     * 
    ...
    /**
     * Gets the real name of the user (as stored in the UserAccount) from the
     * user context. The real name is fetched from the principals of the
     * authentication token fetched from the spring security
     * {@link SecurityContextHolder}.<br>
     * Before calling this method, the user context must be set by using the
     * setContext method. Otherwise, an exception is thrown here.
     * 
     * @return Returns the real name of the user or <code>null</code> if this
    ...
    /**
     * Gets the user handle (the credential) from the user context. The handle
     * is fetched from the credentials of the authentication token context is
     * fetched from the spring security {@link SecurityContextHolder}.<br>
     * Before calling this method, the user context must be set by using the
     * setContext method. Otherwise, an exception is thrown here.
     * 
    ...
    /**
     * Checks if the stored user context is the context of an external user.<br>
     * Before calling this method, the user context must be set by using the
     * setContext method. Otherwise, an exception is thrown here.
     * 
     * @return Returns <code>true</code> if the context has been initialized
     *         and the technical user name is the name of the external super
     *         user.
     * @throws WebserverSystemException
     *             Thrown in case of an internal error.
     * @aa
    ...
    /**
     * Checks if the stored user context is the context of the internal user.<br>
     * Before calling this method, the user context must be set by using the
     * setContext method. Otherwise, an exception is thrown here.
     * 
     * @return Returns <code>true</code> if the context has been initialized
     ...
     * 
     * @return Returns <code>true</code> if the context has been initialized
     *         and the handle equals to an empty {@link String}, as this
    ...
    /**
     * Checks if the stored user context is the context of a REST access.<br>
     * Before calling this method, the user context must be set by using the
     * setContext method. Otherwise, an exception is thrown here.
     * 
     ...
     * 
     * @param restrictedPermissionCode
    ...
    /**
     * Checks if the retrieve of a resource object is restricted to released
     * versions.<br>
     * This method may be used by business logic to decide if released versions
     * or all versions are provided for the current user.
     * 
     * @return Returns <code>true</code> if the current retrieve access is
    ...
    /**
     * Gets the {@link EscidocRequestDetail} that is stored in the
     * {@link Authentication} object of the {@link SecurityContext}.
     * 
