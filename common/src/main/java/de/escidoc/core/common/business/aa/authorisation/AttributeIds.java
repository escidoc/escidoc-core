...
public final class AttributeIds {
     ...
     * has to be provided within the authorization request to the PDP.
     */
    ...
    /**
     * Prefix identifying internal eSciDoc attributes.<br>
     ...
     * Escidoc URNs.
     */
    public static final String URN_ITEM_COMPONENT_ATTR =
        ITEM_ATTR_PREFIX + XmlUtility.NAME_COMPONENT;

    public static final String URN_ITEM_PUBLIC_STATUS_ATTR =
        ITEM_ATTR_PREFIX + XmlUtility.NAME_PUBLIC_STATUS;

    public static final String URN_ITEM_VERSION_MODIFIED_BY_ATTR =
        ITEM_ATTR_PREFIX + "version-" + XmlUtility.NAME_MODIFIED_BY;

    public static final String URN_ITEM_VERSION_STATUS_ATTR =
        ITEM_ATTR_PREFIX + "version-" + XmlUtility.NAME_STATUS;

    public static final String URN_ITEM_LOCK_OWNER_ATTR =
        ITEM_ATTR_PREFIX + XmlUtility.NAME_LOCK_OWNER;

    public static final String URN_ITEM_MODIFIED_BY_ATTR =
        ITEM_ATTR_PREFIX + XmlUtility.NAME_MODIFIED_BY;
    ...
    public static final String URN_ITEM_CONTEXT_NEW_ATTR =
        URN_ITEM_CONTEXT_ATTR + MARKER;

    public static final String URN_ITEM_CREATED_BY_ATTR =
        ITEM_ATTR_PREFIX + XmlUtility.NAME_CREATED_BY;
    ...
    public static final String URN_ORGANIZATIONAL_UNIT_ID =
        RESOURCE_ATTR_PREFIX + "organizational-unit-id";
    ...
    public static final String URN_STATISTIC_SCOPE_ID =
        RESOURCE_ATTR_PREFIX + "scope-id";

    public static final String URN_SUBJECT_EMAIL_ATTR =
    ...
    public static final String URN_SUBJECT_LOGIN_NAME_ATTR =
        SUBJECT_ATTR_PREFIX + XmlUtility.NAME_LOGIN_NAME;

    public static final String URN_SUBJECT_NAME_ATTR =
        SUBJECT_ATTR_PREFIX + XmlUtility.NAME_NAME;

    public static final String URN_SUBJECT_ORGANIZATIONAL_UNIT_ATTR =
        SUBJECT_ATTR_PREFIX + XmlUtility.NAME_ORGANIZATIONAL_UNIT;

    public static final String URN_REPORT_DEFINITION_SCOPE_ATTR =
        REPORT_DEFINITION_ATTR_PREFIX + XmlUtility.NAME_SCOPE;

    public static final String URN_REPORT_REPORT_DEFINITION_ATTR =
        REPORT_ATTR_PREFIX + XmlUtility.NAME_REPORT_DEFINITION;

    public static final String URN_ROLE_CREATED_BY_ATTR =
        ROLE_ATTR_PREFIX + XmlUtility.NAME_CREATED_BY;

    public static final String URN_ROLE_NAME_ATTR =
        ROLE_ATTR_PREFIX + XmlUtility.NAME_NAME;

    public static final String URN_CONTENT_MODEL_ID =
        RESOURCE_ATTR_PREFIX + "content-model-id";
    ...
    public static final String URN_CONTEXT_ID =
        RESOURCE_ATTR_PREFIX + "context-id";

    public static final String URN_CONTEXT_CREATED_BY_ATTR =
        CONTEXT_ATTR_PREFIX + XmlUtility.NAME_CREATED_BY;

    public static final String URN_CONTEXT_ORGANIZATIONAL_UNIT_ATTR =
        CONTEXT_ATTR_PREFIX + XmlUtility.NAME_ORGANIZATIONAL_UNIT;

    public static final String URN_CONTEXT_PUBLIC_STATUS_ATTR =
        CONTEXT_ATTR_PREFIX + XmlUtility.NAME_PUBLIC_STATUS;

    public static final String URN_ITEM_ID = RESOURCE_ATTR_PREFIX + "item-id";

    public static final String URN_COMPONENT_ID =
        RESOURCE_ATTR_PREFIX + "component-id";

    public static final String URN_METADATA_SCHEMA_GENRE =
        RESOURCE_ATTR_PREFIX + "md-schema:genre";

    public static final String URN_OBJECT_TYPE =
        RESOURCE_ATTR_PREFIX + "object-type";

    public static final String URN_OBJECT_TYPE_NEW = URN_OBJECT_TYPE + MARKER;

    public static final String URN_CONTAINER_CONTENT_MODEL_ATTR =
        CONTAINER_ATTR_PREFIX + XmlUtility.NAME_CONTENT_MODEL;

    public static final String URN_CONTAINER_CONTEXT_ATTR =
        CONTAINER_ATTR_PREFIX + XmlUtility.NAME_CONTEXT;

    public static final String URN_CONTAINER_CREATED_BY_ATTR =
        CONTAINER_ATTR_PREFIX + XmlUtility.NAME_CREATED_BY;

    public static final String URN_CONTAINER_ID =
        RESOURCE_ATTR_PREFIX + "container-id";
    ...
    public static final String URN_CONTAINER_LOCK_OWNER_ATTR =
        CONTAINER_ATTR_PREFIX + XmlUtility.NAME_LOCK_OWNER;

    public static final String URN_CONTAINER_MEMBER_ATTR =
        CONTAINER_ATTR_PREFIX + XmlUtility.NAME_MEMBER;

    public static final String URN_CONTAINER_PUBLIC_STATUS_ATTR =
        CONTAINER_ATTR_PREFIX + XmlUtility.NAME_PUBLIC_STATUS;
    ...
    public static final String URN_USER_ACCOUNT_EMAIL_ATTR =
        USER_ACCOUNT_ATTR_PREFIX + XmlUtility.NAME_EMAIL;

    public static final String URN_USER_ACCOUNT_HANDLE_ATTR =
        USER_ACCOUNT_ATTR_PREFIX + "handle";

    public static final String URN_USER_ACCOUNT_LOGIN_NAME_ATTR =
        USER_ACCOUNT_ATTR_PREFIX + XmlUtility.NAME_LOGIN_NAME;

    public static final String URN_USER_ACCOUNT_NAME_ATTR =
        USER_ACCOUNT_ATTR_PREFIX + XmlUtility.NAME_NAME;
    ...
    public static final String URN_SUBRESOURCE_ATTR =
        RESOURCE_ATTR_PREFIX + "subresource-id";
    ...
    public static final String URN_ACTION_ID =
        XACML_ATTR_PREFIX + "action:action-id";

    public static final String URN_RESOURCE_ID =
        XACML_ATTR_PREFIX + "resource:resource-id";

    public static final String URN_SUBJECT_ID =
        XACML_ATTR_PREFIX + "subject:subject-id";
