...
/**
 * The ContentModelNotFoundException is used to indicate that the content model requested in the context of the
...
public class ContentModelNotFoundException extends ResourceNotFoundException {
    ...
    private static final String HTTP_STATUS_MESSAGE = "Content-model was not found.";
     ...
     */
    public ContentModelNotFoundException(final Throwable error) {
     ...
     */
    public ContentModelNotFoundException(final String message) {
     ...
     * @param error   Throwable
     */
    public ContentModelNotFoundException(final String message, final Throwable error) {
