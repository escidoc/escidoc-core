...
/**
 * The StructuralMapEntryNotFoundException is used to indicate that the entry in
 * the structural map requested in the context of the service-call is null or
