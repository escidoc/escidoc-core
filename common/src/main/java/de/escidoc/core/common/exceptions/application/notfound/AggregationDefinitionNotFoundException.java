...
/**
 * The AggregationDefinitionNotFoundException is used to indicate that the
 * Aggregation-Definition requested in the context of the service-call is null
 * or does not exist in the System. returned httpStatusCode is 404. Status code
