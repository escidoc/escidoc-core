...
/**
 * The TimeFrameViolationException is used to indicate that TimeFrame is not
 * valid because TimeFrameStart is later than TimeFrameEnd or a format for
 * TimeFrameStart/TimeFrameEnd is wrong. returned httpStatusCode is 409. Status
...
public class TimeFrameViolationException extends RuleViolationException {
    ...
    public static final String HTTP_STATUS_MESSAGE = "Time frame is not valid.";
