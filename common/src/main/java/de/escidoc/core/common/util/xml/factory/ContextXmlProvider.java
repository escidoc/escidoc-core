...
public final class ContextXmlProvider extends InfrastructureXmlProvider {
    ...
    private static final String CONTEXT_MEMBER_LIST_RESOURCE_NAME =
        "member-list";

    private static final String CONTEXT_MEMBER_REF_LIST_RESOURCE_NAME =
        "member-ref-list";
    ...
    private static final String ADMIN_DESCRIPTOR_RESOURCE_NAME =
        "admin-descriptor";

    private static final String ADMIN_DESCRIPTORS_RESOURCE_NAME =
        "admin-descriptors";
     ...
     */
    public String getContextXml(final Map<String, Object> values)
        throws WebserverSystemException {
     ...
     */
    public String getAdminDescriptorXml(final Map<String, Object> values)
        throws WebserverSystemException {
     ...
     *             Thrown if rendering failed.
     */
    public String getAdminDescriptorsXml(final Map<String, Object> values)
        throws WebserverSystemException {
     ...
     *             If anything fails.
     */
    public String getContextListXml(final Map<String, Object> values)
        throws WebserverSystemException {
     ...
     *             If anything fails.
     */
    public String getMemberListXml(final Map<String, Object> values)
        throws WebserverSystemException {
     ...
     *             If anything fails.
     */
    public String getMemberRefListXml(final Map<String, Object> values)
        throws WebserverSystemException {
        return getXml(CONTEXT_MEMBER_REF_LIST_RESOURCE_NAME, RESOURCES_PATH,
            values);
    }
