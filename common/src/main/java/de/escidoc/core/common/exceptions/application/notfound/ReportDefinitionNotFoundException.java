...
/**
 * The ReportDefinitionNotFoundException is used to indicate that the
 * Report-Definition requested in the context of the service-call is null or
 ...
 * @common
 */
public class ReportDefinitionNotFoundException
