...
/**
 * The UserGroupNotFoundException is used to indicate that the user group requested in the context of the service-call
 * is null or does not exist in the system. Returned HTTP status code is 404. Status code (404) indicating that the
...
public class UserGroupNotFoundException extends ResourceNotFoundException {
    ...
    private static final String HTTP_STATUS_MESSAGE = "User group was not found.";
     ...
     */
    public UserGroupNotFoundException(final Throwable error) {
     ...
     * @param error   Throwable
     */
    public UserGroupNotFoundException(final String message, final Throwable error) {
