...
/**
 * The PidSystemException is used to indicate that an internal system exception
 * in the communication with the configured PID System (PIDManager) occurred.
