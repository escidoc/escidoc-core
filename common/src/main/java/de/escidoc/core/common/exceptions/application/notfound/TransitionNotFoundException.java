...
/**
 * The TransitionNotFoundException is used to indicate that the workflow instance requested in the context of the
...
public class TransitionNotFoundException extends ResourceNotFoundException {
     ...
     */
    public TransitionNotFoundException(final Throwable error) {
     ...
     */
    public TransitionNotFoundException(final String message) {
     ...
     * @param error   Throwable
     */
    public TransitionNotFoundException(final String message, final Throwable error) {
