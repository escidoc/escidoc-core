...
/**
 * The RelationRuleViolationException is used to indicate that it is not allowed to add the given type of relation
 * between the provided objects. returned httpStatusCode is 409. Status code (409) indicating that the request could not
...
public class RelationRuleViolationException extends RuleViolationException {
    ...
    private static final String HTTP_STATUS_MESSAGE = "Relation rule was violated.";
     ...
     */
    public RelationRuleViolationException(final Throwable error) {
     ...
     */
    public RelationRuleViolationException(final String message) {
     ...
     * @param error   Throwable
     */
    public RelationRuleViolationException(final String message, final Throwable error) {
