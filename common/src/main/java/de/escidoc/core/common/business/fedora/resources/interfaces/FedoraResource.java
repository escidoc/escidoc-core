...
public interface FedoraResource {
    ...
    void setRelsExt(Datastream ds) throws StreamNotFoundException,
        LockingException, FedoraSystemException, TripleStoreSystemException,
     ...
     *             In case of internal errors.
     */
    void setRelsExt(final byte[] ds) throws StreamNotFoundException,
     ...
     *             In case of internal errors.
     */
    void setRelsExt(final String ds) throws StreamNotFoundException,
        LockingException, FedoraSystemException, TripleStoreSystemException,
     ...
     */
    String getLastFedoraModificationDate() throws TripleStoreSystemException,
        FedoraSystemException, WebserverSystemException;

    /**
     * Gets the information about the datastreams of a fedora object.
     * 
     * @return the {@link fedora.server.types.gen.Datastream}s of the fedora
     *         object.
     * @throws FedoraSystemException
