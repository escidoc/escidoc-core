...
/**
 * The IngestionSourceNotFoundException is used to indicate that the ingestion
 * source requested in the context of the service-call is null or does not exist
