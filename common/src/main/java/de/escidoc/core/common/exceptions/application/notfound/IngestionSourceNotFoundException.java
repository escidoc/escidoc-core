...
/**
 * The IngestionSourceNotFoundException is used to indicate that the ingestion source requested in the context of the
 ...
 */
public class IngestionSourceNotFoundException extends ResourceNotFoundException {
    ...
    private static final String HTTP_STATUS_MESSAGE = "IngestionSource was not found.";
     ...
     */
    public IngestionSourceNotFoundException(final Throwable error) {
     ...
     */
    public IngestionSourceNotFoundException(final String message) {
     ...
     * @param error   Throwable
     */
    public IngestionSourceNotFoundException(final String message, final Throwable error) {
