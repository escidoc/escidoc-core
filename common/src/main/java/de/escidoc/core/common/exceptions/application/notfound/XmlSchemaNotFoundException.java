...
/**
 * The XmlSchemaNotFoundException is used to indicate that the XML-schema requested in the context of the service-call
...
public class XmlSchemaNotFoundException extends ResourceNotFoundException {
     ...
     */
    public XmlSchemaNotFoundException(final Throwable error) {
     ...
     */
    public XmlSchemaNotFoundException(final String message) {
     ...
     * @param error   Throwable
     */
    public XmlSchemaNotFoundException(final String message, final Throwable error) {
