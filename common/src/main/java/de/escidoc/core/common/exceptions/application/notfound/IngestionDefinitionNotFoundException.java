...
/**
 * The IngestionDefinitionNotFoundException is used to indicate that the
 * ingestion definition requested in the context of the service-call is null or
 ...
 * @common
 */
public class IngestionDefinitionNotFoundException
    ...
    private static final String HTTP_STATUS_MESSAGE =
        "IngestionDefinition was not found.";
