...
/**
 * The RevisionNotFoundException is used to indicate that the revision requested in the context of the service-call is
...
public class RevisionNotFoundException extends ResourceNotFoundException {
     ...
     */
    public RevisionNotFoundException(final Throwable error) {
     ...
     * @param error   Throwable
     */
    public RevisionNotFoundException(final String message, final Throwable error) {
