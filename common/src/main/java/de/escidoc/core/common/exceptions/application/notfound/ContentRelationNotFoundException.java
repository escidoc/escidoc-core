...
/**
 * The ContentRelationNotFoundException is used to indicate that the content relation requested in the context of the
...
public class ContentRelationNotFoundException extends ResourceNotFoundException {
     ...
     */
    private static final long serialVersionUID = 6393537579402018066L;

    public static final int HTTP_STATUS_CODE = ESCIDOC_HTTP_SC_NOT_FOUND;

    public static final String HTTP_STATUS_MESSAGE = "Content relation was not found.";
     ...
     */
    public ContentRelationNotFoundException(final Throwable error) {
     ...
     */
    public ContentRelationNotFoundException(final String message) {
     ...
     * @param error   Throwable
     */
    public ContentRelationNotFoundException(final String message, final Throwable error) {
