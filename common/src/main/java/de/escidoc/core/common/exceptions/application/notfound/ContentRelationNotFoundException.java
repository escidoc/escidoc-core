...
/**
 * The ContentRelationNotFoundException is used to indicate that the content
 * relation requested in the context of the service-call is null or does not
...
public class ContentRelationNotFoundException extends ResourceNotFoundException {
    ...
    private static final String HTTP_STATUS_MESSAGE =
        "Content relation was not found.";
