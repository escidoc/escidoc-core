...
/**
 * The AdminDescriptorViolationException is used to indicate that the action is not allowed because the admin-descriptor
...
public class AdminDescriptorViolationException extends RuleViolationException {
     ...
     */
    private static final long serialVersionUID = -5147887391768440019L;

    private static final int HTTP_STATUS_CODE = ESCIDOC_HTTP_SC_VIOLATED;

    private static final String HTTP_STATUS_MESSAGE = "AdminDescriptor rule was violated.";
     ...
     */
    public AdminDescriptorViolationException(final Throwable error) {
     ...
     */
    public AdminDescriptorViolationException(final String message) {
     ...
     * @param error   Throwable
     */
    public AdminDescriptorViolationException(final String message, final Throwable error) {
