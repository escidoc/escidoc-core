...
/**
 * The AdminDescriptorViolationException is used to indicate that the action is
 * not allowed because the admin-descriptor is violated. returned httpStatusCode
 * is 409. Status code (409) indicating that the request could not be completed
...
public class AdminDescriptorViolationException extends RuleViolationException {
    ...
    private static final String HTTP_STATUS_MESSAGE =
        "AdminDescriptor rule was violated.";
