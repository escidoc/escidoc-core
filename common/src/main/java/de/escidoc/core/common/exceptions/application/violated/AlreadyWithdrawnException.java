...
/**
 * The AlreadyWithdrawnException is used to indicate that the object cannot get
 * withdrawn because it already is withdrawn. returned httpStatusCode is 409.
