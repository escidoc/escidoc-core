...
public interface UserAccountHandlerInterface {
     ...
     * 
     * An User Account with the login name provided within the XML data does not
     * exist.<br/>
     * 
     ...
     * <li>The XML data is validated against the XML-Schema of an User Account
     * ("user-account.xsd").</li>
     * <li>It is checked if the chosen login name is unique.</li>
     * <li>It is checked that one of the provided Organizational Units of the
     * user is marked as the primary one.</li>
     ...
     * 
     * @param xmlData
     *            The XML representation of the User Account to be created
     *            corresponding to XML-schema "user-account.xsd".
     * @return The XML representation of the created User Account corresponding
     *         to XML-schema "user-account.xsd", including the generated user
     *         id, the created-by, creation-date, modified-by, and
     *         last-modification-date. In case of REST, the XML representation
     *         contains the list of virtual subresources, too.
     ...
     *             Thrown if an organizational unit referenced within the
     *             provided xml data does not exist.
    ...
    /**
     * Retrieve the XML representation of an User Account representing an
     * eSciDoc User.<br/>
     * 
     * <b>Prerequisites:</b><br/>
     * 
     ...
     * <ul>
     * <li>The User Account is accessed using the provided reference.</li>
     * <li>The XML data for that User Account is created.</li>
     * <li>The XML data is returned.</li>
     * </ul>
     * 
     * @param userId
     *            An unique identifier of the User Account. This can either be
     *            the internal id, the login name, the email, or the
     *            eSciDocUserHandle which is generated when the user logs in to
     *            Escidoc.
     * @return The XML representation of the User Account corresponding to
     *         XML-schema "user-account.xsd".
     * @throws UserAccountNotFoundException
     *             Thrown if no User Account with the provided id exists.
     * @throws MissingMethodParameterException
     ...
     * <li>The XML data is validated against the XML-Schema of an UserAccount.</li>
     * <li>The provided last-modification-date must match the
     * last-modification-date currently saved in the system.</li>
     * <li>It is checked if the chosen login name is unique.</li>
     * <li>It is checked that one of the provided organizational-units of the
     * user is marked as the primary one.</li>
     * <li>The UserAccount is updated from the provided data including updated
     * modified-by and last-modification-date.</li>
     * <li>The updated UserAccount is stored.</li>
     * <li>The XML data for the updated UserAccount is created.</li>
     * <li>The XML data is returned.</li>
     * </ul>
     * 
     * @param userId
     *            The User Account ID.
     * @param xmlData
     *            The XML representation of the User Account to be updated
     *            corresponding to XML-schema "user-account.xsd".
     * @return The XML representation of the updated User Account corresponding
     *         to XML-schema "user-account.xsd".
     * @throws UserAccountNotFoundException
     ...
     *             Thrown if the provided xml data is not schema conform
     * @throws MissingMethodParameterException
     *             Thrown if either no userId or no xml data is provided, i.e.
     *             it is <code>null.</code>
     * @throws MissingAttributeValueException
     *             Thrown if a mandatory attribute is not provided within the
     *             xml data.
     ...
     *             Thrown if the authorization fails.
     * @throws OrganizationalUnitNotFoundException
     *             Thrown if an organizational unit referenced in the provided
     ...
     * <li>The User Account is accessed using the provided reference.</li>
     * <li>Optimistic Locking criteria is checked.</li>
     * <li>The password of the User Account is updated.</li>
     ...
     *            The User Account ID.
     * @param taskParam
     *            The XML representation of task parameters including the last
     *            modification date and the new password. (see above)
     * @throws InvalidStatusException
     *             Thrown if the addressed User Account is not active.
     * @throws UserAccountNotFoundException
     *             Thrown if no User Account with the provided id exists.
     * @throws XmlCorruptedException
     *             Thrown in case of invalid xml data (corrupt data, schema
     ...
     *            The XML representation of the set of preferences.
     * 
     * @return The XML representation of the updated set of preferences.
     * 
     * @throws UserAccountNotFoundException
     *             If an User Account with the specified userId does not exist.
     * @throws XmlCorruptedException
     *             If the XML representation is invalid.
     * @throws XmlSchemaValidationException
     *             Thrown if the provided xml data is not schema conform
     * @throws SystemException
     *             If an error occurs.
     ...
     * <li>The User Account is accessed using the provided reference.</li>
     * <li>Optimistic Locking criteria is checked.</li>
     * <li>The User Account is set to active.</li>
     * <li>No data is returned.</li>
     * </ul>
     * <b>Parameter for request:</b> (example)<br/>
     * 
     ...
     * 
     * @param userId
     *            The User Account ID to be acivated.
     * @param taskParam
     *            The XML representation of task parameters including the last
     *            modification date. (see above)
     * @throws AlreadyActiveException
     *             Thrown if the addressed User Account is active.
     * @throws UserAccountNotFoundException
     *             Thrown if no User Account with the provided id exists.
     * @throws XmlCorruptedException
     *             Thrown if the provided XML representation of task parameters
     *             are invalid.
     * @throws MissingMethodParameterException
     *             Thrown if no user id or no task parameters are provided.
     * @throws MissingAttributeValueException
     *             Thrown if the provided task parameter does not contain the
     ...
     * <li>The User Account is accessed using the provided reference.</li>
     * <li>Optimistic Locking criteria is checked.</li>
     * <li>The User Account is set to deactive.</li>
     * <li>No data is returned.</li>
     * </ul>
     * <b>Parameter for request:</b> (example)<br/>
     * 
     ...
     * 
     * @param userId
     *            The User Account ID to be deacivated.
     * @param taskParam
     *            The XML representation of task parameters including the last
     *            modification date. (see above)
     * @throws AlreadyDeactiveException
     *             Thrown if the addressed User Account is deactive.
     * @throws UserAccountNotFoundException
     *             Thrown if no User Account with the provided id exists.
     * @throws XmlCorruptedException
     *             Thrown in case of invalid xml data (corrupt data, schema
     ...
     * 
     * This methods returns a list of additional resources which aren't directly
     * stored in the User Account but retrieved or created on request by the
     ...
     * <li>The XML data for the list of resources is created.</li>
     * <li>The XML data is returned.</li>
     * </ul>
     * 
     * @param userId
     *            The User Account ID.
     * @return The XML representation of the resources of that User Account
     ...
     * <ul>
     * <li>The User Account is accessed using the provided reference.</li>
     * <li>The grants corresponding to the User Account are accessed.</li>
     * <li>The currently valid grants are filtered.</li>
     * <li>The XML representation of a list of Grants containing these Grant
     * objects is created.</li>
     * <li>The XML data is returned.</li>
     * </ul>
     * 
     * @param userId
     ...
     * If no filter is specified, all Grants are returned.<br/>
     * <b>Tasks:</b><br/>
     * <ul>
     * <li>Check weather all filter names are valid.</li>
     * <li>The Grants are accessed using the provided filters.</li>
     * <li>The XML representation of the list of all Grants corresponding to
     * XML-schema grants.xsd, element grant-list is returned as output.</li>
     * </ul>
     * <br/>
     ...
     * <ul>
     * <li>The User Account is accessed using the provided reference.</li>
     * <li>The XML data is validated against the XML-Schema of a Grant
     * ("grant.xsd").</li>
     * <li>It is checked, that the referenced Role exists.</li>
     * <li>It is checked, that the referenced object (if any) exists and is of
     * one of the supported resource types.</li>
     * <li>It is checked, that no Grant for the Role specified in the XML data
     * (and for the specified object, in case of a limited Role) exists for the
     * User Account.</li>
     * <li>The title of the referenced object is fetched. If this fails, as a
     * fallback, a default title is constructed using the resource type and the
     * id, e.g. "Context escidoc:12345".</li>
     * <li>A Grant is created and associated with the User Account. Grant id,
     * created-by, creation-date, and the last-modification-date are added to
     * the new Grant.</li>
     * <li>The new grant is stored.</li>
     * <li>The XML representation of the new Grant is created.</li>
     * <li>The XML data is returned.</li>
     * </ul>
     * 
     * @param userId
     *            The User Account ID.
     * @param grantXML
     *            The XML representation of the Grant to be created
     *            corresponding to XML-schema "grant.xsd".
     * @return The XML representation of the created Grant corresponding to
     *         XML-schema "grant.xsd".
     * @throws AlreadyExistsException
     *             Thrown if the defined grant already exists for the User
     *             Account.
     * @throws UserAccountNotFoundException
     *             Thrown if no User Account with the provided id exists.
     ...
     *             Thrown if the provided xml data is not schema conform
     * @throws MissingMethodParameterException
     *             Thrown if no userId or no Grant XML representation is
     *             provided.
     * @throws AuthenticationException
     *             Thrown if the authentication fails due to an invalid provided
     *             eSciDocUserHandle.
     ...
     * <ul>
     * <li>The User Account is accessed using the provided reference.</li>
     * <li>The Grant is identified using the provided Grant ID.</li>
     * <li>The Grant is identified using the provided Grant ID.</li>
     * <li>The XML data for the Grant is created from the stored data.</li>
     * <li>The XML data is returned.</li>
     * </ul>
     * 
     * @param userId
     *            The User Account ID.
     * @param grantId
     *            The Grant ID that shall be retrieved.
     * @return The XML representation of the Grant corresponding to XML-schema
     *         "grant.xsd".
     * @throws UserAccountNotFoundException
     *             Thrown if no User Account with the provided id exists.
     ...
     * <li>Optimistic Locking criteria is checked.</li>
     * <li>The Grant is identified using the provided Grant ID.</li>
     * <li>The Grant is set to "revoked". Revoked-by, revocation-date. and
     * revocation-remark are added to the Grant. The last-modification-date is
     * updated.</li>
     * <li>The updated Grant is stored.</li>
     * <li>No data is returned.</li>
     * </ul>
     * <b>Parameter for request:</b> (example)<br/>
     * 
     ...
     * 
     * @param userId
     *            The User Account ID for that a grant shall be revoked.
     * @param grantId
     *            The Grant ID that shall be revoked.
     * @param taskParam
     *            The remark for the revocation of the Grant in an
     ...
     * @throws XmlCorruptedException
     *             Thrown if the provided XML representation of the task
     *             parameters is invalid.
     * @throws MissingAttributeValueException
     *             Thrown if the last modification date is not provided in the
     *             task parameters.
     * @throws MissingMethodParameterException
     ...
     * <ul>
     * <li>The User Account is accessed using the provided reference.</li>
     * <li>The Grants are identified using the provided ids in the
     * filter-parameter.</li>
     * <li>Revoke all Grants by providing no filter-parameter.</li>
     * <li>The Grants are set to "revoked". Revoked-by, revocation-date. and
     * revocation-remark are added to the Grants. The last-modification-date is
     * updated.</li>
     * <li>The updated Grants are stored.</li>
     * <li>No data is returned.</li>
     * </ul>
     * <b>Parameter for request:</b> (example)<br/>
     * 
     ...
     *            The User Account ID for that a grant shall be revoked.
     * @param taskParam
     *            The filter for grants to revoke and the remark for the
     *            revocation of the Grant in an XML-Structure: (see above)
     * @throws UserAccountNotFoundException
     *             Thrown if no User Account with the provided ID exists.
     * @throws GrantNotFoundException
     *             Thrown if the specified Grant of the User Account cannot be found.
     ...
     * 
     * @param filter
     *            The filter criteria as CQL query.
     * @return Returns the XML representation of a list of User Accounts.
     * @throws MissingMethodParameterException
     *             Thrown if no XML representation of filter parameters is
     *             provided.
     ...
     *             Thrown if the authorization fails.
     * @throws UserAccountNotFoundException
     *             Thrown if no user account can be identified by the provided
     *             handle.
     * @throws SystemException
     *             Thrown in case of an internal system error.
     *             
    ...
    /**
     * Retrieves {@link UserPreference} object associated to the User Account
    ...
    /**
     * Create a User Preference for the User Account.<br>
     * This Preference contains a name and a value.<br/>
     * 
     * <b>Prerequisites:</b><br/>
     * 
     * The provided XML data in the body is only accepted if the size is less
     ...
     *            The User Account ID.
     * @param preferenceXML
     *            The XML representation of the User Preference to be created
     ...
     * The User Preference contains a name and a value.<br/>
     * 
     * <b>Prerequisites:</b><br/>
     * 
     * The provided XML data in the body is only accepted if the size is less
     ...
     * <li>The XML data is validated against the XML-Schema of a User Preference
     * ("preferences.xsd").</li>
     * <li>The User Preference is accessed and updated.</li>
     * <li>The User Preference is stored.</li>
     * <li>The XML representation of the changed User Preference is created.</li>
     * <li>The XML data is returned.</li>
     * </ul>
     * 
     * @param userId
    ...
    /**
     * Remove a User Preference from the User Account.<br>
     * The User Preference is identified by its name within the User Account.<br/>
     * 
     * <b>Prerequisites:</b><br/>
     * 
     * The User Account must exist<br/> The User Preference for the User Account
     ...
     * <ul>
     * <li>The User Account is accessed using the provided reference.</li>
     * <li>The User Preference is accessed and removed.</li>
     * </ul>
     * 
     * @param userId
     *            The User Account ID.
    ...
    /**
     * Create an User Attribute for the User Account.<br>
     * This User Attribute contains a name and a value.<br/>
     * 
     * <b>Prerequisites:</b><br/>
     * 
     * The provided XML data in the body is only accepted if the size is less
     ...
     *            The User Account ID.
     * @param attributeXml
     *            The XML representation of the User Attribute to be created
     ...
     * identified by the provided User Account ID.
     * 
     * @param userId
     *            The User Account ID.
     ...
     *            The User Account ID.
     * @param attributeId
     *            The User Attribute ID to be updated.
     * @param attributeXML
     *            The XML representation of the User Attribute to be updated
     *            corresponding to XML-schema "user-attributes.xsd".
     ...
     * The User Attribute is identified by it's ID within the User Account.<br/>
     * 
     * <b>Prerequisites:</b><br/>
     * 
     ...
     * <ul>
     * <li>The User Account is accessed using the provided reference.</li>
     * <li>The User Attribute is accessed and removed.</li>
     * </ul>
     * 
     * @param userId
     *            The User Account ID.
     ...
     *             Thrown if no User Account with the provided ID exists.
     * @throws UserAttributeNotFoundException
     *             Thrown if the User Attribute does not exist.
     * @throws ReadonlyElementViolationException
     *             Thrown if the User Attribute is set to read only.
     * @throws MissingMethodParameterException
