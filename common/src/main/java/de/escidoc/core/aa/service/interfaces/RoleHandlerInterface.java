...
public interface RoleHandlerInterface {
     ...
     * <b>Tasks:</b><br/>
     * <ul>
     * <li>The role is accessed using the provided reference.</li>
     * <li>The XML data is validated against the XML-Schema of a role.</li>
     * <li>It is checked whether no other role with the same name exists and if
     * the role name is allowed, i.e. it is not "Default-User".</li>
     * <li>The role is created using the provided data.</li>
     * <li>Created-by, creation-date, modified-by, and last-modification-date
     * are set.</li>
     * <li>The role is stored.</li>
     * <li>The policy/policy set of the role is stored as provided. No checks
     * on policy/policy set are done.</li>
     * <li>The XML representation of the created role corresponding to
     * XML-schema is returned as output.</li>
     * </ul>
     * 
     * @param xmlData
     *            The XML representation of the role to be created corresponding
     *            to XML-schema "role.xsd".
     * @return The XML representation of the created role corresponding to
     *         XML-schema "role.xsd", including the generated role id, the
     *         created-by, creation-date, modified-by, and
     ...
     *             Thrown if no role with the provided id exists.
     * @throws RoleInUseViolationException
     *             Thrown if the role is referenced by a role grant.
     * @throws MissingMethodParameterException
     ...
     *             
     */
    void delete(String roleId) throws AuthenticationException,
     ...
     * <b>Tasks:</b><br/>
     * <ul>
     * <li>The role is accessed using the provided reference. This identifier
     * may be either the Role ID or the Role Name.</li>
     * <li>The XML representation of the role corresponding to XML-schema is
     * returned as output.</li>
     * </ul>
     * 
     * @param identifier
     *            An unique identifier of the role to be retrieved, either the
     *            Role ID or the Role Name.
     * @return The XML representation of the retrieved role corresponding to
     *         XML-schema "role.xsd".
     * @throws RoleNotFoundException
     *             Thrown if no role with the provided identifier exists.
     * @throws MissingMethodParameterException
     ...
     *             
     */
    String retrieve(String identifier) throws RoleNotFoundException,
        MissingMethodParameterException, AuthenticationException,
        AuthorizationException, SystemException;
     ...
     * <li>It is checked whether no other role with the same name exists and if
     * the role name is allowed, i.e. it is not "Default-User".</li>
     * <li>The role is updated using the provided data.</li>
     * <li>Modified-by and last-modification-date are updated.</li>
     * <li>The updated role is stored.</li>
     * <li>The policy/policy set of the role is replaced by the provided
     * policy/policy set. No checks on policy/policy set are done.</li>
     * <li>The XML representation of the role corresponding to XML-schema is
     * returned as output.</li>
     * </ul>
     * 
     * @param roleId
     *            The Role ID to be updated.
     * @param xmlData
     *            The XML representation of the role to be updated corresponding
     *            to XML-schema "role.xsd".
     * @return Returns the XML representation of the updated role.
     * @throws RoleNotFoundException
     *             Thrown if no role with the provided id exists.
     * @throws XmlCorruptedException
     *             Thrown if the provided xml data is not valid.
     * @throws XmlSchemaValidationException
     *             Thrown if the provided xml data is not schema conform.
     * @throws MissingAttributeValueException
     *             Thrown if a mandatory attribute has not been set in the
     *             provided xml data.
     * @throws UniqueConstraintViolationException
    ...
    String update(String roleId, String xmlData)
     ...
     * in AA but created on request by the eSciDoc-Framework.<br/>
     * 
     * <b>Prerequisites:</b><br/>
     * 
     * The role must exist<br/>
     ...
     * <li>The XML representation of the list of resources corresponding to
     * XML-schema is returned as output.</li>
     * </ul>
     * 
     * @param roleId
     *            The Role ID.
     * @return The XML representation of the resources of that role
     *         corresponding to XML-schema "role.xsd".
     * @throws AuthenticationException
     *             Thrown if the authentication fails due to an invalid provided
     *             eSciDocUserHandle.
     * @throws AuthorizationException
     ...
     */
    String retrieveResources(String roleId) throws AuthenticationException,
        AuthorizationException, MissingMethodParameterException,
        RoleNotFoundException, SystemException;
     ...
     * </ul>
     * 
     * @param filter map of key - value pairs containing the filter definition.
     ...
     *             Thrown in case of an internal error.
     */
    String retrieveRoles(Map<String, String[]> filter)
