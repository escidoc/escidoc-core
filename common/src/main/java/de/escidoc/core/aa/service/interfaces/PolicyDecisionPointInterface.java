...
public interface PolicyDecisionPointInterface {
     ...
     * resources (i.e. system objects).<br/>
     * Information about user, action and resource is contained in the provided
     * XML data string which represents the content of a
     * <code>com.sun.xacml.ctx.RequestCtx</code> objects.
     * <p/>
     * 
     * For each <code>RequestCtx</code>, the following steps are executed:
     * <ul>
     * <li>An authorization request is generated from the provided XML data and
     * evaluated.</li>
    ...
    /**
     * Evaluates for which objects a (specified) role has been granted to the
     * specified user.<br>
     * 
     * @param resourceName
     *            The name identifying the resource. The name of the root
     *            element of the resource's XML representation is expected here.<br>
     *            This parameter is mandatory.
     * @param userId
     *            The User Account ID.<br>
     *            This parameter is mandatory.
     * @param role
     *            The name of the role that shall be evaluated.<br>
     *            This parameter is optional. If it is <code>null</code>, all
     *            limited roles that have been granted to the user are
     *            evaluated.
     * @param objectIds
     *            A <code>List</code> of ids of the objects for that grants
     *            shall be evaluated. If this parameter has not been provided or
     *            if an empty List has been provided, an empty list is returned.
     *            If a list has been provided, only ids contained in the
     *            provided list may be returned.
     * @return Returns a <code>List</code> of ids of objects for that the user
     *         has the specified role (or a role).<br>
     *         If one of the roles that have to be evaluated is an unlimited
     *         role, the provided list of object ids is returned.
     * @throws ResourceNotFoundException
     ...
     *             Thrown if the authorization fails.
     * @throws MissingMethodParameterException
     *             Thrown in case of a missing mandatory parameter.
     * @throws SystemException
     *             Thrown in case of an internal error.
     * 
     */
    List<String> evaluateRoles(
        String resourceName, String userId, String role,
        List<String> objectIds) throws ResourceNotFoundException,
        MissingMethodParameterException, AuthenticationException,
        AuthorizationException, SystemException;

    /**
     * Constructs the where clause selecting the objects for that a (specified)
     * role has been granted to the specified user.<br>
     * 
     * @param resourceName
     *            The name identifying the resource. The name of the root
     *            element of the resource's XML representation is expected here.<br>
     ...
     *            The name of the role that shall be evaluated.<br>
     *            This parameter is optional. If it is <code>null</code>, all
     *            roles that have been granted to the user are used for
     *            construction the query part.
     * @return Returns the where clause that restricts a search result. This may
     *         be empty meaning all object match the user/role criteria. And
     *         this may be null meaning no object matches the user/role
     *         criteria.
     * @throws MissingMethodParameterException
     *             Thrown in case of a missing mandatory parameter.
     * @throws SystemException
     *             Thrown in case of an internal error.
     */
    StringBuffer getRoleUserWhereClause(
        String resourceName, String userId, String role)
        throws MissingMethodParameterException, SystemException;

    /**
     * Method used for testing. This provided access to the attribute finder of
     * the internally used XACML PDP.
     * 
     * @param attributeType
     ...
     *            The subject category URI.
     * @param context
     *            The evaluation context.
     * @param designatorType
     *            The designator type.
     * @return Returns the attribute value(s) or the status.
     * @throws SystemException
     *             Thrown in case of an internal error,
     */
    String[] findAttribute(
        URI attributeType, URI attributeId, URI issuer,
        URI subjectCategory, String context,
        int designatorType) throws SystemException;
