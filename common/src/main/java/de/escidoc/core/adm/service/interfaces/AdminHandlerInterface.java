...
public interface AdminHandlerInterface {
    ...
    /**
     * Delete a list of objects given by their object ids from Fedora. In case
     * of Items this method will also delete all depending Components of the
     * given Items. The deletion runs asynchronously and returns some useful
     * information to the user, e.g. the total number of objects to delete.
     * 
     * @param taskParam
     *            list of object ids to delete<br/>
     *            boolean value to signal if the search index and the Resource
     *            cache have to be kept in sync. If this value is set to false
     *            then the re-indexing and re-caching should be run manually
     *            afterwards.
     * 
     ...
     */
    String deleteObjects(final String taskParam) throws InvalidXmlException,
     ...
     *             Thrown if the authorization failed.
     */
    String getPurgeStatus() throws SystemException, AuthenticationException,
     ...
     *             Thrown if the authorization failed.
     */
    String getReindexStatus() throws SystemException, AuthenticationException,
        AuthorizationException;
     ...
     * 
     * @throws InvalidXmlException
     *             Thrown if the given XML is invalid.
     * @throws SystemException
     *             Thrown in case of an internal error.
     * @throws AuthenticationException
     *             Thrown if the authentication failed due to an invalid
     ...
     * returns some useful information to the user, e.g. the total number of
     * objects found.
     * 
     * @param clearIndex
     ...
     *             Thrown if the authorization failed.
     */
    String reindex(final String clearIndex, final String indexNamePrefix)
     ...
     */
    String getIndexConfiguration() throws SystemException, AuthenticationException,
        AuthorizationException;

    /**
     * Provides an XML structure containing public configuration properties of
     * the eSciDoc Infrastructure and the earliest creation date of eSciDoc
     * repository objects.
     * 
     ...
     *             Thrown if the authorization failed.
     */
    String getRepositoryInfo() throws SystemException, AuthenticationException,
        AuthorizationException;
     ...
     */
    @Deprecated
    String loadExamples(final String type) throws InvalidSearchQueryException,
        SystemException, AuthenticationException, AuthorizationException;
}
