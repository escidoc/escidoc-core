...
public interface ReportDefinitionHandlerInterface {
    ...
    /**
     * Create new Report Definition with 
     * given xmlData.<br/>       
     *
     ...
     * <b>Tasks:</b><br/>
     * <ul>
     * <li>The Report Definition is created. </li>
     * <li>The XML data is returned.</li>
     * </ul>
     * 
     * @param xmlData
     *            The XML representation of the Report Definition
     *            to be created corresponding to XML-schema
     *             "report-definition.xsd".
     * @return    The XML representation of the created Report Definition 
     *            corresponding to XML-schema "report-definition.xsd".
     * 
     ...
     * <li>The Report Definition is deleted.</li>   
     * <li>No data is returned.</li>
     * </ul>
     * 
     * @param reportDefinitionId
     *            The Report Definition ID to be deleted.
     * @throws AuthenticationException
     *             Thrown in case of failed authentication.
     * @throws AuthorizationException
     *             Thrown in case of failed authorization.
     ...
     * 
     */
    void delete(String reportDefinitionId) throws AuthenticationException,
     ...
     * 
     * @param reportDefinitionId
     *            The Report Definition ID to be retrieved.
     * @return    The XML representation of the retrieved Report Definition 
     *            corresponding to XML-schema "report-definition.xsd".
     * @throws AuthenticationException
     *             Thrown in case of failed authentication.
     * @throws AuthorizationException
     ...
     * 
     */
    String retrieve(String reportDefinitionId) throws AuthenticationException,
        AuthorizationException, ReportDefinitionNotFoundException,
        MissingMethodParameterException, SystemException;
     ...
     *
     * @return The XML representation of the Report Definitions 
     *         corresponding to XML-schema "srw-types.xsd".
     *         List only contains these Report Definitions the 
     ...
     * <b>Tasks:</b><br/>
     * <ul>
     * <li>the Report Definition is updated. </li>
     * <li>The XML data is returned.</li>
     * </ul>
     * 
     * @param reportDefinitionId
     ...
     *            to be created corresponding to XML-schema
     *             "report-definition.xsd".
     * @return    The XML representation of the updated Report Definition 
     *            corresponding to XML-schema "report-definition.xsd".
     * 
     * @throws AuthenticationException
     *             Thrown in case of failed authentication.
