...
public interface ContextHandlerInterface {
     ...
     * 
     * @return The XML representation of the list of the retrieved contexts
     *         corresponding to the SRW schema.
     * @throws MissingMethodParameterException
     *             Thrown if filter parameter contains not expected data.
     * @throws SystemException
     *             Thrown if a framework internal error occurs.
     ...
     * <b>Tasks:</b><br/>
     * <ul>
     * <li>The XML data is validated</li>
     * <li>The "name" of the Context must be unique: check if this is true.</li>
     * <li>public-status of the Context is set to "created".</li>
     * <li>The XML representation of the Context corresponding to XML-schema is
     * returned as output.</li>
     * </ul>
     * 
     * @param xmlData
     *            The XML representation of the Context to be created
     *            corresponding to XML-schema "context.xsd".
     * @return The XML representation of the created Context corresponding to
     *         XML-schema "context.xsd".
    ...
    String create(final String xmlData) throws AuthenticationException,
        ...
        MissingMethodParameterException, ReadonlyAttributeViolationException,
     ...
     * 
     * The Context has to be in public-status "created", otherwise the removing
     * of the Context will fail.
     * 
     * <b>Tasks:</b><br/>
     * <ul>
     * <li>The Context is accessed using the provided reference.</li>
     * <li>The content will be removed from IR.</li>
     * <li>No data is returned.</li>
     * </ul>
     * 
     * @param id
     *            The id of the resource Context to be deleted.
     * @throws AuthenticationException
     *             Thrown if authentication fails.
     * @throws AuthorizationException
     *             Thrown if authorization fails.
     * @throws ContextNotEmptyException
     *             If the Context contains depending resources.
    ...
    void delete(String id) throws AuthenticationException,
        AuthorizationException, ContextNotEmptyException,
        ContextNotFoundException, InvalidStatusException,
     ...
     * @return The XML representation of the retrieved Context corresponding to
     *         XML-schema "context.xsd".
     * 
     * @throws AuthenticationException
     *             Thrown if authentication fails.
     ...
     * <ul>
     * <li>The Context is accessed using the provided reference.</li>
     * <li>The XML representation of the Context properties corresponding to
     * XML-schema is returned as output.</li>
     * </ul>
     * 
     * @param id
     *            The id of the Context to be retrieved.
     * @return The XML representation of the retrieved Context properties
     *         corresponding to XML-schema "context.xsd".
     * 
     * @throws ContextNotFoundException
     *             Thrown if a Context with the provided id cannot be found.
     ...
     * </ul>
     * 
     * <b>Note:</b> The public-status of an Context can't bet changed by this
     * method. Please use the methods dedicated for this purpose.<br/>
     * 
     * @param id
     *            The id of the Context to be updated.
     * @param xmlData
     *            The XML representation of the Context to be updated
     *            corresponding to XML-schema "context.xsd".
     * @return The XML representation of the updated Context corresponding to
     *         XML-schema "context.xsd".
     * @throws AuthenticationException
     *             Thrown if authentication fails.
     * @throws AuthorizationException
     ...
     *             Thrown if method parameter is missing.
     * @throws InvalidContentException
     *             Thrown if content of XML representation is invalid.
     * @throws InvalidStatusException
     *             Thrown if Context status is not allowed to update resource.
     * @throws InvalidXmlException
     ...
     * @throws MissingElementValueException
     *             Thrown if element value is missing.
     * @throws SystemException
     *             If case of internal error.
     */
    @Validate(param = 1, resolver = "getContextSchemaLocation")
    String update(String id, String xmlData) throws AuthenticationException,
        AuthorizationException, ContextNotFoundException,
        InvalidContentException, InvalidStatusException, InvalidXmlException,
     ...
     * <ul>
     * <li>The Context is accessed using the provided reference.</li>
     * <li>The XML representation of the admin descriptor is returned as output.
     * </li>
     * </ul>
     * 
     * @param id
    ...
    String retrieveAdminDescriptor(final String id, final String name)
        throws AdminDescriptorNotFoundException, AuthenticationException,
        AuthorizationException, ContextNotFoundException,
        MissingMethodParameterException, SystemException;
     ...
     * <ul>
     * <li>The Context is accessed using the provided reference.</li>
     * <li>The XML representation of all admin-descriptors of this Context is
     * returned as output.</li>
     * </ul>
     * 
     * @param id
     ...
     * <li>The Context is accessed using the provided reference.</li>
     * <li>Optimistic Locking criteria is checked.</li>
     * <li>The XML representation of the admin descriptor is returned.</li>
     * </ul>
     * 
     * @param id
     *            The id of the context.
     * @param xmlData
     *            The XML representation of the admin descriptor to be updated.
     ...
     * 
     * This method returns a list of additional resources which aren't stored in
     * IR but created on request.<br/>
     * 
     * <b>Prerequisites:</b><br/>
     * 
     * The Context must exist<br/>
     ...
     * <li>The XML representation of the organizational unit corresponding to
     * XML-schema is returned as output.</li>
     * </ul>
     * 
     * @param id
     ...
     *         Context corresponding to XML-schema "resources.xsd".
     * @throws AuthenticationException
     *             Thrown if authentication fails.
     * @throws AuthorizationException
     *             Thrown if authorization fails.
     ...
     * <li>The Context is accessed using the provided reference.</li>
     * <li>Optimistic Locking criteria is checked.</li>
     * <li>The public-status is changed to "open".</li>
     * <li>No data is returned.</li>
     * </ul>
     * 
     * <pre>
     ...
     * 
     * @param id
     *            The id of the resource Context to be opened.
     * @param taskParam
     *            The timestamp of the last modification of the Container. (see
     *            above)
     ...
     *             Thrown if Context is looked.
     * @throws StreamNotFoundException
     *             Thrown if required stream could not be found.
     * @throws SystemException
     *             If case of internal error.
     */
    String open(final String id, final String taskParam)
        throws AuthenticationException, AuthorizationException,
        ContextNotFoundException, InvalidStatusException, InvalidXmlException,
        MissingMethodParameterException, OptimisticLockingException,
        SystemException, LockingException, StreamNotFoundException;

    /**
     * Close a context<br/>
     * Set Context status to close.<br/>
     * 
     ...
     * <li>The Context is accessed using the provided reference.</li>
     * <li>Optimistic Locking criteria is checked.</li>
     * <li>The public-status is changed to "closed".</li>
     * <li>No data is returned.</li>
     * </ul>
     * 
     * <pre>
     ...
     * 
     * @param id
     *            The id of the resource Context to be closed.
     * @param taskParam
     *            The timestamp of the last modification of the Container. (see
     *            above)
     * @return XML corresponding to (result.xsd) with last-modification-date.
