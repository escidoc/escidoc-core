...
public interface ContainerHandlerInterface {
     ...
     * <li>If a "struct-map" section is set, it's checked weather resources to
     * all provided member ids exist.</li>
     * <li>If a "relations" section is set, it's checked weather resources to
     * all provided relations targets exist and weather used relations are part
     * of the related ontologies.</li>
     * <li>The public-status of the container is set to "pending".</li>
     * <li>The Version 1 of the container is created. All members referenced in
     * the struct-map are added to the container.</li>
     * <li>The container is added to the provided context.</li>
     * <li>The XML input data is updated and some new data is added.</li>
     * <li>The XML representation of the container corresponding to XML-schema
     ...
     * 
     * @param xmlData
     *            The XML representation of the container to be created
     *            corresponding to XML-schema "container.xsd".
     * @return The XML representation of the created container corresponding to
     *         XML-schema "container.xsd".
     * 
     * @throws ContextNotFoundException
     *             Thrown if the context specified in the provided data cannot
     *             be found.
     * @throws ContentModelNotFoundException
     *             Thrown if the content model specified in the provided data
     *             cannot be found.
     ...
     *             Thrown if a content relation predicate specified in the
     *             provided data does not belong to the provided ontology.
    ...
    String create(final String xmlData) throws ContextNotFoundException,
        ...
        MissingMdRecordException, XmlCorruptedException,
     ...
     * </ul>
     * 
     * <b>Note:</b> There are additional restrictions for deleting a container
     * due to its Content-Type, e.g. if the container is a Collection and
     * already contains one or more Objects the deletion of the container will
     * fail until all contained Objects are moved to another Collection. These
     * rules will be defined by the specified Content-Model.<br/>
     * 
     * @param id
     ...
     * 
     * This method retrieves the object which contains a list of its members but
     * the method will not retrieve all members in addition.<br/>
     * 
     * <b>Prerequisites:</b><br/>
     * 
     * The container must exist<br/>
     ...
     * @param id
     *            The id of the container.
     * @return The XML representation of the retrieved container corresponding
     *         to XML-schema "container.xsd".
     * @throws AuthenticationException
     *             Thrown if authentication fails.
     * @throws AuthorizationException
     *             Thrown if authorization fails.
     ...
     *             Thrown if a framework internal error occurs.
     */
    String retrieve(final String id) throws AuthenticationException,
        AuthorizationException, MissingMethodParameterException,
        ContainerNotFoundException, SystemException;

    /**
     * Updates the container resource with the provided id using the provided
     * data.<br/>
     * 
     * <b>Prerequisites:</b><br/>
     * 
     ...
     * elements.<br/>
     * 
     * The section "properties" has to be provided. It has to contain at least
     * one element "content-model-specific". Elements of this section and their
     * values can be changed, deleted or added. Elements "name" and
     * "description" and their values can not be changed direct in this section.
     * They can be updated via update of the corresponing elements from
     * "escidoc" md-record. All other elements will be discarded and set by the
     * framework.<br/>
     * 
     * The section "md-records" has to be provieded and has to contain an
     * element "md-record" with an attribute "name" set to "escidoc".<br/>
     * 
     * 
     * A relations section contains a list of "relation" elements with existing
     * relations data of the provided container, which should remain in a new
     * version and a new relations data. The framework will remove all existing
     * relations of the provided container, which are not on the list. It is
     * checked, if provided relation targets and provided relation predicates
     * exist. The attribute "xlink:href" of the "relation" element is set to a
     * REST-url and respectively the attribute "objid" is set to id of the
     * target. A target id may not contain a version number.<br/>
     * 
     * The section "struct-map" is read-only section. It will be discarded and
     * set by the framework.<br/>
     * 
     * 
     * <b>Tasks:</b><br/>
     * <ul>
     ...
     * <li>If the status of the version is "released" a new version is created
     * and gets the status "pending" otherwise a new version is created with the
     * same status as before.</li>
     * <li>If the container is modified a new version of the container is
     * created.</li>
     * <li>The XML input data is updated and some new data is added.</li>
     * <li>The XML representation of the container corresponding to XML-schema
     * is returned as output.</li>
     * </ul>
     * <b>Note:</b> The status of a container can't bet changed by this method
     * nor can't it be moved to a different context. Please use the methods
     * dedicated for this purpose.<br/>
     * 
     * @param id
     *            The id of the container.
     * @param xmlData
     *            The XML representation of the container to be updated
     *            corresponding to XML-schema "container.xsd".
     * @return The XML representation of the updated container corresponding to
     *         XML-schema "container.xsd".
     * @throws ContainerNotFoundException
     *             Thrown if a container with the provided id does not exist in
     *             the framework.
     ...
     *             If the provided container id does not identify the latest
     *             version.
     * @throws SystemException
     *             Thrown if a framework internal error occurs.
     * @throws ReferencedResourceNotFoundException
     ...
     * SRW schema is returned as output</li>
     * </ul>
     * <br/>
     * See chapter "Filters" for detailed information about filter definitions.
     * 
     ...
     *            The filter criteria to select the containers given as a map of
     *            key - value pairs
     * @return The XML representation of the list of member corresponding to the
     *         SRW schema.
     * 
     * @throws MissingMethodParameterException
     *             If the parameter filter is not given.
     ...
     * <li>The members are accessed using the provided filters.</li>
     * <li>The XML representations of the list of all members corresponding to
     * the SRW schema is returned as output</li>
     * </ul>
     * <br/>
     * See chapter "Filters" for detailed information about filter definitions.
     * 
     ...
     * </ul>
     * The members to be added to the container are listed in the "param"
     * section of the input data using their IDs.
     * 
     ...
     *            The id of the container.
     * @param taskParam
     *            The list of Members to add to the container. (See example
     *            above.)
     ...
     *             or the resource is neither Item nor Container.
     * @throws MissingMethodParameterException
     *             Thrown if one of expected input parameter is missing.
     * @throws SystemException
     *             Thrown if a framework internal error occurs.
     * @throws InvalidContextException
     *             Thrown if a context of any member differs from a context of
    ...
    String addMembers(final String id, final String taskParam)
        throws ContainerNotFoundException, LockingException,
        InvalidContentException, MissingMethodParameterException,
        SystemException, InvalidContextException, AuthenticationException,
     ...
     * <li>A XML containing the new latest version timestamp is returned.</li>
     * </ul>
     * The tocs to be added to the container are listed in the "param" section
     * of the input data using their IDs.
     * 
     * <b>Parameter for request:</b> (example)<br/>
     * 
     * <pre>
     ...
     *             the one who locked it.
     * @throws InvalidContentException
     *             Thrown if for any ids there is no a resource in the
     *             framework.
     * @throws MissingMethodParameterException
     *             Thrown if one of expected input parameter is missing.
     * @throws SystemException
     ...
     * <li>A XML containing the new latest version timestamp is returned.</li>
     * </ul>
     * The members to be removed from the container are listed in the "param"
     * section of the input data using their IDs.
     * 
     * <b>Parameter for request:</b> (example)<br/>
     * 
     ...
     *             Thrown if the removed member should be an Item but could not
     *             be found
     * @throws ContainerNotFoundException
     *             Thrown if the removed member should be an Container but could
     *             not be found
     ...
     * 
     * Method is deprecated because of inconsistent naming. Use createMdRecord
     * instead of.
     * 
     * <b>Prerequisites:</b><br/>
     * 
     ...
     * <li>A new version is created.</li>
     * <li>In case of public-status "released", the status of the new version is
     * set to "pending".</li>
     * <li>Timestamp for the container of the latest modification in the system
     * is updated to the current time.</li>
    ...
    /**
     * Retrieve a metadata record with the provided name of a container with the
     * provided id.<br/>
     * 
     * <b>Prerequisites:</b><br/>
     * 
    ...
    String retrieveDcRecordContent(final String id)
        throws ContainerNotFoundException, AuthenticationException,
        AuthorizationException, MissingMethodParameterException,
        SystemException;
     ...
     * <li>Timestamp of the latest modification in the system is updated to the
     * current time.</li>
     ...
     * @param id
     *            The id of the container.
     * @return The XML representation of the retrieved metadata records
     *         corresponding to XML-schema "metadatarecords.xsd".
     * @throws ContainerNotFoundException
     *             Thrown if a container with the provided id cannot be found.
     * @throws MissingMethodParameterException
     ...
     * <ul>
     * <li>The container is accessed using the provided reference.</li>
     * <li>Retrieve the properties of the container. This includes the Content
     * Model specific properties, too</li>
     ...
     * @param id
     *            The id of the container.
     * @return The XML representation of the properties subresource
     *         corresponding to XML-schema "properties.xsd".
     * @throws ContainerNotFoundException
     *             Thrown if a container with the provided id cannot be found.
     * @throws MissingMethodParameterException
     *             Thrown if the container id is not provided.
    ...
    /**
     * Retrieve the list of related resources of a container with the provided
     * id.<br/>
     ...
     * @param id
     *            The id of the container.
     * @return The XML representation of the list of virtual resources of the
     *         container.
     * @throws ContainerNotFoundException
     *             Thrown if a container with the provided id cannot be found.
     * @throws MissingMethodParameterException
    ...
    //
    /**
     * Retrieve the list of Relations of the container, where the container is
     * the relations source.<br/>
     * 
     * <b>Prerequisites:</b><br/>
     * 
     * The container must exist<br/>
     ...
     * @param id
     *            The id of the container.
     * @return The XML representation of the list of relations of the container
     ...
     * @param id
     *            The id of the container.
     * @return The XML representation of the version history of the container.
     *         (see example above)
     * @throws ContainerNotFoundException
     *             Thrown if a container with the provided id cannot be found.
     * @throws MissingMethodParameterException
     ...
     * 
     * @return The XML representation of the parents of that Container
     ...
     * @param taskParam
     *            The timestamp of the last modification of the Container and a
     *            comment. The timestamp is necessary for optimistic locking
     *            purpose.
     * @return last-modification-date within XML (result.xsd)
     * 
     * @throws ContainerNotFoundException
     ...
     * user) or an Administrator unlocks the Container.<br/>
     * 
     * <b>Prerequisites:</b><br/>
     * 
     * The container must exist<br/>
     ...
     * <li>It is checked whether the input adhere to the allowed values defined
     * in the Admin Descriptor of the provided Context.</li>
     * <li>The container is added to the provided Context.</li>
     ...
     *            The id of the container.
     * @param taskParam
     *            The timestamp of the last modification of the container and
     *            the new Context Id.
     * @return The XML representation of the the container corresponding to
     *         XML-schema "container.xsd".
     * 
     * @throws ContainerNotFoundException
     *             Thrown if a container with the provided id cannot be found.
    ...
    /**
     * Creates a new item and add it to the member list of the container with
     * the provided id.<br/>
     * 
     * <b>Prerequisites:</b><br/>
     * 
     ...
     * @return The XML representation of the created item corresponding to
     *         XML-schema "item.xsd".
     * @throws ContainerNotFoundException
     ...
     *             Thrown if the content is invalid.
     * @throws InvalidContextException
     *             Thrown if a context specified in the provided data differs
     *             from a context of the container with the provided id.
     * @throws InvalidStatusException
     *             Thrown if the container in the current status not allows to
     *             create a new Item.
     * @throws ReferencedResourceNotFoundException
     *             Thrown if a content relation target specified in the provided
     *             data does not exist in the framework.
     * @throws RelationPredicateNotFoundException
     *             Thrown if a content relation predicate specified in the
     *             provided data does not belong to the provided ontology.
     * @throws AuthenticationException
    ...
    /**
     * Creates a new container and add it to the member list of the container
     * with the provided id.<br/>
     * 
     * <b>Prerequisites:</b><br/>
     * 
     * The provided XML data in the body is only accepted if the size is less
     ...
     * <li>A new version is created.</li>
     * <li>The XML representation of the new container corresponding to
     ...
     * <li>The container is accessed using the provided reference.</li>
     * <li>Optimistic Locking criteria is checked.</li>
     * <li>The new relations, which have the container as a source are created
     ...
     * ontology exist in the system. New relations will be created.</li>
     * <li>A XML containing the new latest version timestamp is returned.</li>
     * </ul>
     * <b>Parameter for request:</b> (example)<br/>
     * 
     ...
     * 
     * @param id
     *            The id of the container, which will be a source of new
     *            relations.
     * @param param
     *            xml structure with a last modification date of the source
     *            container and a list of sections containing respectively a
     *            target id and a content relation predicate. A target id may
     *            not contain a version number: (see description above)
     * @return last-modification-date within XML (result.xsd)
     * 
     * @throws SystemException
     *             Thrown if a framework internal error occurs.
     ...
     *             Thrown if a content relation specified in a provided data
     *             already exists
     * @throws InvalidStatusException
     *             Thrown if a container in the current status is not allowed to
     *             to add new content relations to.
     * @throws InvalidXmlException
     *             Thrown if the schema validation of the provided data fails or
     *             provided data is corrupted.
     * @throws MissingElementValueException
     ...
     * <li>The container is accessed using the provided reference.</li>
     * <li>Optimistic Locking criteria is checked.</li>
     * <li>The relations to be deleted, which have the container as a source are
     * deleted according to a provided data</li>
     * <li>Latest version date is updated.</li>
     * <li>A new version is created.</li>
     * <li>The method checks if a source container contains all relations with
     ...
     * 
     * @param id
     *            The id of the container, which will be a source of deleted
     *            relations.
     * @param param
     *            xml structure with a last modification date of the source
     *            container and a list of sections containing respectively a
     ...
     * @throws InvalidStatusException
     *             Thrown if a container in the current status is not allowed to
     *             to remove new content relations from.
     * @throws MissingElementValueException
     *             If a mandatory element value is missing.
     * @throws InvalidXmlException
     *             Thrown if the schema validation of the provided data fails or
     ...
     *             Thrown if a container with the provided id does not have a
     *             content relation specified in the provided xml data
     * @throws LockingException
     *             Thrown if the container is locked and the current user is not
     *             the one who locked it.
     * @throws ReadonlyVersionException
     ...
     * 
     * This PID represents the object reference and schould used to identify the
     * newest accessible Container. <br/>
     * 
     ...
     * 
     * Another alternative is to register an PID which is managed outside of the
     ...
     *            The container ID.
     * @param taskParam
     *            The timestamp of the last modification of the container and at
