...
public interface ContentRelationHandlerInterface {
     ...
     * <li>The XML representation of the Content Relation corresponding to
     * XML-schema is returned as output.</li>
     * </ul>
     * 
     * @param xmlData
     *            The XML representation of the Content Relation to be created
     *            corresponding to XML-schema "content-relation.xsd".
     * @return The XML representation of the created Content Relation
     *         corresponding to XML-schema "content-relation.xsd".
     * 
     ...
     *             Thrown if a value of an attribute is missing.
     * @throws MissingMethodParameterException
     *             Thrown if method parameter is empty
     * @throws InvalidXmlException
     *             Thrown if a provided XML is not valid.
     * @throws InvalidContentException
     *             Thrown if a provided XML contains an invalid data.
     * @throws ReferencedResourceNotFoundException
     *             Thrown if one of the referenced resources is not exist.
     * @throws RelationPredicateNotFoundException
     *             Thrown if a provided relation type is not on the predicate
     *             list.
     ...
     * 
     * @param id
     *            The id of the resource Content Relation to be deleted.
     * @throws AuthenticationException
     *             Thrown if authentication fails.
     * @throws AuthorizationException
     *             Thrown if authorization fails.
     ...
     */
    void delete(final String id) throws AuthenticationException,
     ...
     * 
     * @param id
     *            The id of the Content Relation to be retrieved.
     * @return The XML representation of the retrieved Content Relation
     *         corresponding to XML-schema "content-relation.xsd".
     * 
     * @throws AuthenticationException
     *             Thrown if authentication fails.
     ...
     * <ul>
     * <li>The Content Relation is accessed using the provided reference.</li>
     * <li>The XML representation of the Content Relation properties
     ...
     *            The id of the Content Relation to be retrieved.
     * @return The XML representation of the retrieved Content Relation
     *         properties corresponding to XML-schema "Content Relation.xsd".
     * 
     * @throws AuthenticationException
     *             Thrown if authentication fails.
     * @throws AuthorizationException
     ...
     * 
     * The Content Relation must exist<br/>
     * The the public-status is not "released".<br/>
     ...
     * <li>The XML data is validated.</li>
     * <li>A md-records section contains the md-records of the provided
     * content-relation, which should remain after update and new md-records.
     * The framework will remove all existing md-records of the provided
     * content-relation, which are not on this section.</li>
     * <li>If changed, the metadata records are updated.</li>
     * <li>If changed, the description of the content-relation is updated.</li>
     ...
     * 
     * The content-relation will be locked by a user and no other user will be
     * able to change this item until the Lock-User (or the Admin) will unlock
     * this item.<br/>
     * 
     * <b>Prerequisites:</b><br/>
     * 
     ...
     * <b>Tasks:</b><br/>
     * <ul>
     * <li>The content-relation is accessed using the provided Id.</li>
     * <li>Optimistic Locking criteria is checked.</li>
     * <li>The lock-status of the content-relation is changed to "locked".</li>
     * <li>The lock-date and lock-owner are added to the content-relation.</li>
     * <li>No data is returned.</li>
     * </ul>
     * 
     * @param id
     *            The id of the content-relation to be revised.
     * @param taskParam
     *            The time stamp of the last modification of the
     *            content-relation. Necessary for optimistic locking purpose.
     *            (see example above)
     ...
     *             Thrown if authorization fails.
     * @throws ContentRelationNotFoundException
     *             Thrown if a content-relation with the specified id cannot be
     *             found.
     * @throws LockingException
     *             Thrown if the content-relation is locked and the current user
     *             is not the one who locked it.
     * @throws InvalidStatusException
     ...
     * @throws InvalidContentException
     *             Thrown if the content of taskParam is invalid.
     */
    ...
    /**
     * Unlock a content-relation.<br/>
     * The content-relation will be unlocked.<br>
     * /
     * 
     * <b>Prerequisites:</b><br/>
     * 
     ...
     * 
     * Only the user who has locked the content-relation (and the Admin) are
     * allowed to unlock the content-relation.<br/>
     * 
     * <b>Tasks:</b><br/>
     * <ul>
     * <li>The content-relation is accessed using the provided Id.</li>
     * <li>Optimistic Locking criteria is checked.</li>
     * <li>The lock-status of the content-relation is changed to "unlocked".</li>
     * <li>The lock-date and lock-owner are removed from the content-relation.</li>
     * <li>No data is returned.</li>
     * </ul>
     * 
     * @param id
     ...
     * <li>The content-relation is accessed using the provided Id.</li>
     * <li>Optimistic Locking criteria is checked.</li>
     * <li>The public-status is changed to "submitted".</li>
     * <li>No data is returned.</li>
     * </ul>
     * 
     * @param id
     ...
     * <li>The content-relation is accessed using the provided Id.</li>
     * <li>Optimistic Locking criteria is checked.</li>
     * <li>The public-status is changed to "in-revision".</li>
     * <li>No data is returned.</li>
     * </ul>
     * 
     * @param id
     ...
     * <li>The content-relation is accessed using the provided Id.</li>
     * <li>Optimistic Locking criteria is checked.</li>
     * <li>The public-status is changed to "released".</li>
     * <li>No data is returned.</li>
     * </ul>
     * 
     * @param id
    ...
    /**
     * Retrieves escidoc XML representation of ContentRelations md-record with a
     * provided name.
     * 
     * @param id
     *            objid of ContentRelation resource
