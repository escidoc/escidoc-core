...
public interface SemanticStoreHandlerInterface {
    ...
    /**
     * Retrieve a result of provided triple store query in a provided output
     * format.<br/>       
     *
     * <b>Prerequisites:</b><br/>
     *
     * The provided XML data in the body is only accepted if 
     * the size is less than ESCIDOC_MAX_XML_SIZE.<br/>
     *
     * Excecute a SPO query on the triple store. 
     * SPO is a simple RDF query  language, where queries consist of 
     * <ul>
     * <li>a <b>s</b>ubject</li>
     * <li>a <b>p</b>redicate</li>
     * <li>an an <b>o</b>bject</li>
     * </ul>
     * (see http://www.fedora.info/download/2.2.1/userdocs/server/webservices/risearch/index.html)<br/>
     ...
     * to register additional predicates.<br/>
     *
     * The result of a query is filtered in order to deliver triples
     * with registered predicates only. (in further releases).<br/>
     *
     * <b>Tasks:</b><br/>
     * <ul>
     * <li>The XML data is returned.</li>
     * </ul>
     * <br/>Valid output format identifiers are:<br/>
     * <ul>
     * <li>N-Triples (http://www.w3.org/2001/sw/RDFCore/ntriples/)</li>
     * <li>Notation 3 (http://www.w3.org/DesignIssues/Notation3.html)</li>
     * <li>RDF/XML (http://www.w3.org/TR/rdf-syntax-grammar/)</li>
     * <li>Turtle (http://www.dajobe.org/2004/01/turtle/)</li>
     * </ul>
     * <br/><b>Example 1:</b><br/>
     * 
     * <pre>&lt;param></pre>
     ...
     * subject and <i>isMemberOf</i> from the registered ontologie 
     * http://www.escidoc.de/ontologies/mpdl-ontologies/content-relations.xml
     * as predicte. Wrap the predicate in encoded tags (&amp;lt;/&amp;gt;) and separate
     * the relative URIref via # from namespace.<br/>
     *
     * The vocabular of the current supported ontologie namespace is defined in
     * http://www.escidoc.de/ontologies/mpdl-ontologies/content-relations.xml.<br/>
     * 
     * The following list is a subset example of the defined vocabular. It is not 
     * avoidable to catch the whole set of vocabulary from the namespace definition.
     * <ul>
     * <li>isRevisionOf</li>
     * <li>isPartOf</li>
     * <li>hasPart</li>
     * <li>isConstituentOf</li>
     * <li>hasConstituent</li>
     * <li>isMemberOf</li>
     * <li>hasMember</li>
     * <li>isSubsetOf</li>
     * <li>hasSubset</li>
     * <li>isMemberOfCollection</li>
     * <li>hasCollectionMember</li>
     * <li>isDerivationOf</li>
     * <li>hasDerivation</li>
     * <li>isDependentOf</li>
     * <li>hasDependent</li>
     * <li>isDescriptionOf</li>
     * <li>hasDescription</li>
     * <li>isMetadataFor</li>
     * <li>hasMetadata</li>
     * <li>isAnnotationOf</li>
     * <li>hasAnnotation</li>
     * <li>hasEquivalent</li>
     * </ul>
     * Use this vocabulary as SPO predicate with full namespace and # as separator e.x.:<br/>
     * http://www.escidoc.de/ontologies/mpdl-ontologies/content-relations#isMemberOf<br/>
     * 
     * @param taskParam
