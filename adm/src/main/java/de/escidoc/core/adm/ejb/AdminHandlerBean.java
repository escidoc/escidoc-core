...
public class AdminHandlerBean implements SessionBean {
    ...
    public String deleteObjects(final String taskParam, final String authHandle,
    ...
    public String getPurgeStatus(final SecurityContext securityContext)
    ...
    public String getPurgeStatus(final String authHandle, final Boolean restAccess)
            throws SystemException,
            AuthenticationException,
            AuthorizationException {
        try {
    ...
    public String getReindexStatus(final SecurityContext securityContext)
            throws SystemException,
            AuthenticationException,
            AuthorizationException {
        try {
    ...
    public String getReindexStatus(final String authHandle, final Boolean restAccess)
            throws SystemException,
            AuthenticationException,
            AuthorizationException {
        try {
    ...
    public void decreaseReindexStatus(final String objectTypeXml, final String authHandle,
                                      final Boolean restAccess)
            throws InvalidXmlException,
            SystemException,
            AuthenticationException,
    ...
    public String getIndexConfiguration(final SecurityContext securityContext)
            throws SystemException,
            AuthenticationException,
            AuthorizationException {
        try {
    ...
    public String getIndexConfiguration(final String authHandle, final Boolean restAccess)
            throws SystemException,
            AuthenticationException,
            AuthorizationException {
        try {
    ...
    public String getRepositoryInfo(final SecurityContext securityContext)
            throws SystemException,
            AuthenticationException,
            AuthorizationException {
        try {
    ...
    public String getRepositoryInfo(final String authHandle, final Boolean restAccess)
            throws SystemException,
            AuthenticationException,
            AuthorizationException {
        try {
    ...
    public String loadExamples(final String type, final String authHandle,
                                         final Boolean restAccess)
            throws InvalidSearchQueryException,
            SystemException,
            AuthenticationException,
