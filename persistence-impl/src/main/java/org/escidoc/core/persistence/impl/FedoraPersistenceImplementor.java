...
public class FedoraPersistenceImplementor implements PersistenceImplementor {
	...
	FedoraPersistenceImplementor(final String path) {
		super();
		try {
			...
			this.directory = FedoraPersistenceImplementor.getDirectory(path);
			this.contextDirectory = FedoraPersistenceImplementor.getDirectory(path + "/context");
			this.itemDirectory = FedoraPersistenceImplementor.getDirectory(path + "/item");
