...
public class ReadonlyAttributeViolationException extends ReadonlyViolationException {
     ...
     */
    private static final long serialVersionUID = -7303197141584516836L;

    private static final int HTTP_STATUS_CODE = ESCIDOC_HTTP_SC_VIOLATED;

    private static final String HTTP_STATUS_MESSAGE = "Readonly attribute is setr.";
     ...
     */
    public ReadonlyAttributeViolationException(final Throwable error) {
     ...
     */
    public ReadonlyAttributeViolationException(final String message) {
     ...
     * @param error   Throwable
     */
    public ReadonlyAttributeViolationException(final String message, final Throwable error) {
