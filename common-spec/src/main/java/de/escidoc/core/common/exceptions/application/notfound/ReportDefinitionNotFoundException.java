...
/**
 * The ReportDefinitionNotFoundException is used to indicate that the Report-Definition requested in the context of the
...
public class ReportDefinitionNotFoundException extends ResourceNotFoundException {
     ...
     */
    private static final long serialVersionUID = -5740394228447342319L;

    private static final int HTTP_STATUS_CODE = ESCIDOC_HTTP_SC_NOT_FOUND;

    private static final String HTTP_STATUS_MESSAGE = "Report Definition was not found.";
     ...
     */
    public ReportDefinitionNotFoundException(final Throwable error) {
     ...
     */
    public ReportDefinitionNotFoundException(final String message) {
     ...
     * @param error   Throwable
     */
    public ReportDefinitionNotFoundException(final String message, final Throwable error) {
