...
/**
 * The IngestionDefinitionNotFoundException is used to indicate that the ingestion definition requested in the context
 * of the service-call is null or does not exist in the System. returned httpStatusCode is 404. Status code (404)
...
public class IngestionDefinitionNotFoundException extends ResourceNotFoundException {
     ...
     */
    public IngestionDefinitionNotFoundException(final Throwable error) {
     ...
     */
    public IngestionDefinitionNotFoundException(final String message) {
     ...
     * @param error   Throwable
     */
    public IngestionDefinitionNotFoundException(final String message, final Throwable error) {
