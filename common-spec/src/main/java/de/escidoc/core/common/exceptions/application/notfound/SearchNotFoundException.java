...
/**
 * The SearchNotFoundException is used to indicate that the user defined search requested in the context of the
...
public class SearchNotFoundException extends ResourceNotFoundException {
     ...
     */
    private static final long serialVersionUID = 2609169485295161056L;

    private static final int HTTP_STATUS_CODE = ESCIDOC_HTTP_SC_NOT_FOUND;

    private static final String HTTP_STATUS_MESSAGE = "Search was not found.";
     ...
     */
    public SearchNotFoundException(final Throwable error) {
     ...
     * @param error   Throwable
     */
    public SearchNotFoundException(final String message, final Throwable error) {
