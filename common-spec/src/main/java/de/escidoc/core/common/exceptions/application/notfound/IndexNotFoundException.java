...
/**
 * The IndexNotFoundException is used to indicate that the index requested in the context of the service-call is null or
...
public class IndexNotFoundException extends ResourceNotFoundException {
     ...
     */
    public IndexNotFoundException(final Throwable error) {
     ...
     * @param error   Throwable
     */
    public IndexNotFoundException(final String message, final Throwable error) {
