...
/**
 * The PidNotFoundException is used to indicate that the pid requested in the context of the service-call is null or
...
public class PidNotFoundException extends ResourceNotFoundException {
     ...
     */
    public PidNotFoundException(final Throwable error) {
     ...
     * @param error   Throwable
     */
    public PidNotFoundException(final String message, final Throwable error) {
